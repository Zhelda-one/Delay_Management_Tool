...
/*    if (!(result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object]))
    ...
    result.numAxcIndex = l2l1_getU8(offset + 83);
/*    if (!(result.numAxcIndex === [object Object] || result.numAxcIndex === [object Object]))
        throw new Error(`Value ${result.numAxcIndex} is out of range for enum 'numAxcIndex_t'`); */
    Object.defineProperty(result, "__enum_numAxcIndex", {
        enumerable: false,
        writable: false,
        value: "l1_common_numAxcIndex_t",
    });
    ...
    result.axcIndex = decodeStaticFixedSizedArray_uint8_4(offset + 96);
...
function DlDataencodePdschSendReq_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.numAxcIndex, buf, off + 83);
    ...
    encodeStaticFixedSizedArray_uint8_4(msg.axcIndex, buf, off + 96);
}
...
packetEnumMap = {
    ...
    l1_common_numAxcIndex_t: {
        2: "numAxcIndex::NUM_AXC_2",
        4: "numAxcIndex::NUM_AXC_4",
    },
