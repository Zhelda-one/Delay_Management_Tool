...
/*    if (!(result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object]))
...
/*    if (!(result.precoderGranularity === [object Object] || result.precoderGranularity === [object Object]))
    ...
    result.dciPayload = decodeStaticFixedSizedArray_uint8_18(offset + 36);
...
function DlDataencodeDciInfo(msg, buf, off) {
    ...
    encodeStaticFixedSizedArray_uint8_18(msg.dciPayload, buf, off + 36);
}
...
/*    if (!(result.numOfPdschSymbols === [object Object] || result.numOfPdschSymbols === [object Object] || result.numOfPdschSymbols === [object Object] || result.numOfPdschSymbols === [object Object] || result.numOfPdschSymbols === [object Object] || result.numOfPdschSymbols === [object Object]))
...
function SyncMdecodestartSyncEReq_t(offset) {
    ...
    result.ssmQl = l2l1_getU8(offset + 0);
...
function SyncMencodestartSyncEReq_t(msg, buf, off) {
    l2l1_putU8(msg.ssmQl, buf, off + 0);
...
function l2l1_decode_msg(l2l1) {
    ...
    case 0x0116: // DlData::PatternConfigReq_t
        ...
        break;
    case 0x011e: // DlData::PdcchSendReq_t
        result = DlDatadecodePdcchSendReq_t(0);
        break;
    case 0x011f: // DlData::PdschSendReq_t
        result = DlDatadecodePdschSendReq_t(0);
        break;
    case 0x0120: // DlData::CsiRsSendReq_t
    ...
    case 0x0122: // DlData::SlotTypeReq_t
        ...
        break;
    case 0x0124: // DlData::SsBlockSendReq_t
...
packetPropToStrMap["l2l1.message"] = {
    ...
    0x011e: "DlData::PdcchSendReq",
    0x011f: "DlData::PdschSendReq",
    0x0120: "DlData::CsiRsSendReq",
    0x0121: "DlData::AddressResp",
    0x0122: "DlData::SlotTypeReq",
    0x0124: "DlData::SsBlockSendReq",
