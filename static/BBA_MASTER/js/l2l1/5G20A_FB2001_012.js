...
function L1CpridecodeSetLinkParamReq_t(offset) {
    let result = {};
...
/*    if (!(result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object]))
    ...
    result.parameterMask = l2l1_getU16(offset + 2);
    result.scramblingSeed = l2l1_getU32(offset + 4);
    result.cpriProtocolVersion = l2l1_getU8(offset + 8);

    return result;
}
function L1CpriencodeSetLinkParamReq_t(msg, buf, off) {
    l2l1_putU8(msg.cpriLink, buf, off + 0);
    l2l1_putU16(msg.parameterMask, buf, off + 2);
    l2l1_putU32(msg.scramblingSeed, buf, off + 4);
    l2l1_putU8(msg.cpriProtocolVersion, buf, off + 8);
}
function L1CpridecodeSetLinkParamResp_t(offset) {
    let result = {};
...
function L1CpriencodeSetLinkParamResp_t(msg, buf, off) {
    l2l1_putU8(msg.cpriLink, buf, off + 0);
    l2l1_putU8(msg.state, buf, off + 1);
}
...
/*    if (!(result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object]))
    ...
    result.Nul = l2l1_getU8(offset + 12);
    result.index = l2l1_getU8(offset + 13);
    result.modulo = l2l1_getU8(offset + 14);
    result.activeBytes = l2l1_getU8(offset + 15);
    result.bufferLen = l2l1_getU8(offset + 16);
...
function L1CpriencodeConfigureVsbReq_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.Nul, buf, off + 12);
    l2l1_putU8(msg.index, buf, off + 13);
    l2l1_putU8(msg.modulo, buf, off + 14);
    l2l1_putU8(msg.activeBytes, buf, off + 15);
    l2l1_putU8(msg.bufferLen, buf, off + 16);
}
...
function l2l1_decode_msg(l2l1) {
    ...
    case 0x0a41: // L1Cpri::DelayConfigReq_t
        ...
        break;
    case 0x0a46: // L1Cpri::SetLinkParamReq_t
        result = L1CpridecodeSetLinkParamReq_t(0);
        break;
    case 0x0a47: // L1Cpri::SetLinkParamResp_t
        result = L1CpridecodeSetLinkParamResp_t(0);
        break;
...
function l2l1_encode_msg(l2l1) {
    ...
    case 0x0a46: // L1Cpri::SetLinkParamReq_t
        ...
        L1CpriencodeSetLinkParamReq_t(l2l1, buf, 0);
        break;
    case 0x0a47: // L1Cpri::SetLinkParamResp_t
        buf.static = new Uint8Array(2);
        L1CpriencodeSetLinkParamResp_t(l2l1, buf, 0);
        break;
    case 0x0a48: // L1Cpri::ConfigureVsbReq_t
...
packetPropToStrMap["l2l1.message"] = {
    ...
    0x0a46: "L1Cpri::SetLinkParamReq",
    0x0a47: "L1Cpri::SetLinkParamResp",
