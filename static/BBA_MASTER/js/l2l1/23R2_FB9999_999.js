...
/*    if (!(result.rachStatus === [object Object] || result.rachStatus === [object Object] || result.rachStatus === [object Object] || result.rachStatus === [object Object] || result.rachStatus === [object Object]))
    ...
    result.shortTermTaMetricOfAnt = decodeStaticFixedSizedArray_int16_4(offset + 96);
...
function DlDataencodePdschGrant(msg, buf, off) {
    ...
    encodeStaticFixedSizedArray_int16_4(msg.shortTermTaMetricOfAnt, buf, off + 96);
}
...
/*    if (!(result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object]))
    ...
    result.timeOffsetOfAnt = decodeStaticFixedSizedArray_int16_4(offset + 32);
...
function DlDataencodeCsiRsResource_t(msg, buf, off) {
    ...
    encodeStaticFixedSizedArray_int16_4(msg.timeOffsetOfAnt, buf, off + 32);
}
...
function decodeDynamicPackedArray_PdschGrant_16(offset) {
    ...
    for (let i = 0; i < length; i++)
        result.push(DlDatadecodePdschGrant(offset + 1 + arrOffset + i * 104));
    return result;
}
