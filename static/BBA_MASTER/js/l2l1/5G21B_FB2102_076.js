...
function L1LogdecodeAntennaSnapshotResp_t(offset) {
    ...
    result.status = l2l1_getU8(offset + 0);
/*    if (!(result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object]))
...
/*    if (!(result.csiPart1CrcCheck === [object Object] || result.csiPart1CrcCheck === [object Object]))
    ...
    result.uciCsiPart2Bits = decodeStaticFixedSizedArray_uint8_7(offset + 80);
    result.csiPart2CrcCheck = l2l1_getU8(offset + 88);
/*    if (!(result.csiPart2CrcCheck === [object Object] || result.csiPart2CrcCheck === [object Object]))
    ...
    result.dtxCsiPart1 = l2l1_getU8(offset + 89);
    result.dtxMetricCsiPart1 = l2l1_getU16(offset + 90);
    result.dtxThresholdCsiPart1 = l2l1_getU16(offset + 92);
    result.dtxCsiPart2 = l2l1_getU8(offset + 94);
    result.dtxMetricCsiPart2 = l2l1_getU16(offset + 96);
    result.dtxThresholdCsiPart2 = l2l1_getU16(offset + 98);
    result.rssiOfAnt = decodeStaticFixedSizedArray_float32_4(offset + 100);
    result.rxPowerOfAnt = decodeStaticFixedSizedArray_float32_4(offset + 116);
    result.sinrOfAnt = decodeStaticFixedSizedArray_float32_4(offset + 132);
    result.shortTermTaMetricOfAnt = decodeStaticFixedSizedArray_int16_4(offset + 148);
    result.shortTermTaPeakAmpOfAnt = decodeStaticFixedSizedArray_float32_4(offset + 156);
    result.shortTermCfoMetricOfAnt = decodeStaticFixedSizedArray_shortTermCfoMetric_t_4(offset + 172);
...
function UlDataencodeUePuschReceiveRespPs_t(msg, buf, off) {
    ...
    encodeStaticFixedSizedArray_uint8_7(msg.uciCsiPart2Bits, buf, off + 80);
    l2l1_putU8(msg.csiPart2CrcCheck, buf, off + 88);
    l2l1_putU8(msg.dtxCsiPart1, buf, off + 89);
    l2l1_putU16(msg.dtxMetricCsiPart1, buf, off + 90);
    l2l1_putU16(msg.dtxThresholdCsiPart1, buf, off + 92);
    l2l1_putU8(msg.dtxCsiPart2, buf, off + 94);
    l2l1_putU16(msg.dtxMetricCsiPart2, buf, off + 96);
    l2l1_putU16(msg.dtxThresholdCsiPart2, buf, off + 98);
    encodeStaticFixedSizedArray_float32_4(msg.rssiOfAnt, buf, off + 100);
    encodeStaticFixedSizedArray_float32_4(msg.rxPowerOfAnt, buf, off + 116);
    encodeStaticFixedSizedArray_float32_4(msg.sinrOfAnt, buf, off + 132);
    encodeStaticFixedSizedArray_int16_4(msg.shortTermTaMetricOfAnt, buf, off + 148);
    encodeStaticFixedSizedArray_float32_4(msg.shortTermTaPeakAmpOfAnt, buf, off + 156);
    encodeStaticFixedSizedArray_shortTermCfoMetric_t_4(msg.shortTermCfoMetricOfAnt, buf, off + 172);
}
...
function l2l1_decode_msg(l2l1) {
    ...
    case 0xe301: // L1Cpri::ConfigureAxcInfoReq_t
        ...
        break;
    case 0xe310: // L1Cpri::DelayConfigReq_t
    ...
    case 0xE10C: // DlData::FastAntennaSnapshotResp_t
        ...
        break;
    case 0xE10D: // DlData::PdcchSendReq_t
