...
/*    if (!(result.mantissaSize === [object Object] || result.mantissaSize === [object Object]))
    ...
    result.actDlEcpriExtType12 = l2l1_getU8(offset + 545);
    result.l1SubpoolId = l2l1_getU16(offset + 546);
    result.firstCellSlotId = l2l1_getU16(offset + 548);
    result.cellSlotLength = l2l1_getU16(offset + 550);
...
function DlCellencodeSetupReq_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.actDlEcpriExtType12, buf, off + 545);
    l2l1_putU16(msg.l1SubpoolId, buf, off + 546);
    l2l1_putU16(msg.firstCellSlotId, buf, off + 548);
    l2l1_putU16(msg.cellSlotLength, buf, off + 550);
}
function DlCelldecodephaseCompensationLutIndex_t(offset) {
    let result = {};
...
/*    if (!(result.digitalOutputRate === [object Object] || result.digitalOutputRate === [object Object] || result.digitalOutputRate === [object Object]))
    ...
    result.cellExtension = l2l1_getU8(offset + 54);
/*    if (!(result.cellExtension === [object Object] || result.cellExtension === [object Object]))
    ...
    result.actEcpriPhase2 = l2l1_getU8(offset + 55);
    result.cpriDialectIndication = l2l1_getU8(offset + 56);
/*    if (!(result.cpriDialectIndication === [object Object] || result.cpriDialectIndication === [object Object]))
        throw new Error(`Value ${result.cpriDialectIndication} is out of range for enum 'cpriDialectIndication_t'`); */
    Object.defineProperty(result, "__enum_cpriDialectIndication", {
        enumerable: false,
    ...
    result.axcPosition = decodeStaticVariableSizedArray_uint32_8(offset + 60);
    result.prachConfigurationIndex = l2l1_getU8(offset + 96);
    result.prachPrbOffset = l2l1_getU16(offset + 98);
    result.adjustPrachThresholdOffsetDb = l2l1_getU16(offset + 100);
    result.ulDlDataSlotRatio = l2l1_getU8(offset + 102);
/*    if (!(result.ulDlDataSlotRatio === [object Object] || result.ulDlDataSlotRatio === [object Object] || result.ulDlDataSlotRatio === [object Object] || result.ulDlDataSlotRatio === [object Object] || result.ulDlDataSlotRatio === [object Object] || result.ulDlDataSlotRatio === [object Object]))
    ...
    result.l1SubpoolId = l2l1_getU16(offset + 104);
    result.firstCellSlotId = l2l1_getU16(offset + 106);
    result.cellSlotLength = l2l1_getU16(offset + 108);
    result.ulEcpriFdBeamforming = l2l1_getU8(offset + 110);
    result.actUlEcpriExtType12 = l2l1_getU8(offset + 111);
    result.ulSubcellPoolId = l2l1_getU8(offset + 112);
    result.gainCorrection = l2l1_getI16(offset + 114);
    result.gainCorrectionForPrach = l2l1_getI16(offset + 116);
    result.ulScPerCarrierPart = decodeDynamicVariableSizedArray_uint16_2(offset + 120);
    result.actUlEcpriPhase4 = l2l1_getU8(offset + 128);
    result.prachDtxThresholdSelection = l2l1_getU8(offset + 129);
/*    if (!(result.prachDtxThresholdSelection === [object Object] || result.prachDtxThresholdSelection === [object Object]))
    ...
    result.actORANstep1 = l2l1_getU8(offset + 130);
    result.numberOfColTRX = l2l1_getU8(offset + 131);
/*    if (!(result.numberOfColTRX === [object Object] || result.numberOfColTRX === [object Object]))
    ...
    result.numberOfRowTRX = l2l1_getU8(offset + 132);
/*    if (!(result.numberOfRowTRX === [object Object] || result.numberOfRowTRX === [object Object] || result.numberOfRowTRX === [object Object]))
    ...
    result.ORANprachNumerology = l2l1_getU8(offset + 133);
    result.ulIqCompression = l2l1_getU8(offset + 134);
    result.ulActDownSampling = l2l1_getU8(offset + 135);
    result.mantissaSize = l2l1_getU8(offset + 136);
/*    if (!(result.mantissaSize === [object Object] || result.mantissaSize === [object Object]))
        throw new Error(`Value ${result.mantissaSize} is out of range for enum 'mantissaSize_t'`); */
    Object.defineProperty(result, "__enum_mantissaSize", {
        enumerable: false,
    ...
    result.staticLongPucch = l2l1_getU8(offset + 137);
    result.localCellResId = l2l1_getU32(offset + 140);
    result.pSRSact = l2l1_getU8(offset + 144);
    result.pSRSnumCeAxCId = l2l1_getU8(offset + 145);
/*    if (!(result.pSRSnumCeAxCId === [object Object] || result.pSRSnumCeAxCId === [object Object] || result.pSRSnumCeAxCId === [object Object]))
    ...
    result.realPartOfPrecombinerRows = decodeDynamicVariableSizedArray_int16_32(offset + 148);
    result.imagPartOfPrecombinerRows = decodeDynamicVariableSizedArray_int16_32(offset + 156);
    result.realPartOfPrecombinerColumns = decodeDynamicVariableSizedArray_int16_32(offset + 164);
    result.imagPartOfPrecombinerColumns = decodeDynamicVariableSizedArray_int16_32(offset + 172);
    result.beamWeight = decodeDynamicVariableSizedArray_beamWeight_t_400(offset + 180);
...
function UlCellencodeSetupReq_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.cellExtension, buf, off + 54);
    l2l1_putU8(msg.actEcpriPhase2, buf, off + 55);
    l2l1_putU8(msg.cpriDialectIndication, buf, off + 56);
    encodeStaticVariableSizedArray_uint32_8(msg.axcPosition, buf, off + 60);
    l2l1_putU8(msg.prachConfigurationIndex, buf, off + 96);
    l2l1_putU16(msg.prachPrbOffset, buf, off + 98);
    l2l1_putU16(msg.adjustPrachThresholdOffsetDb, buf, off + 100);
    l2l1_putU8(msg.ulDlDataSlotRatio, buf, off + 102);
    l2l1_putU16(msg.l1SubpoolId, buf, off + 104);
    l2l1_putU16(msg.firstCellSlotId, buf, off + 106);
    l2l1_putU16(msg.cellSlotLength, buf, off + 108);
    l2l1_putU8(msg.ulEcpriFdBeamforming, buf, off + 110);
    l2l1_putU8(msg.actUlEcpriExtType12, buf, off + 111);
    l2l1_putU8(msg.ulSubcellPoolId, buf, off + 112);
    l2l1_putI16(msg.gainCorrection, buf, off + 114);
    l2l1_putI16(msg.gainCorrectionForPrach, buf, off + 116);
    encodeDynamicVariableSizedArray_uint16_2(msg.ulScPerCarrierPart, buf, off + 120);
    l2l1_putU8(msg.actUlEcpriPhase4, buf, off + 128);
    l2l1_putU8(msg.prachDtxThresholdSelection, buf, off + 129);
    l2l1_putU8(msg.actORANstep1, buf, off + 130);
    l2l1_putU8(msg.numberOfColTRX, buf, off + 131);
    l2l1_putU8(msg.numberOfRowTRX, buf, off + 132);
    l2l1_putU8(msg.ORANprachNumerology, buf, off + 133);
    l2l1_putU8(msg.ulIqCompression, buf, off + 134);
    l2l1_putU8(msg.ulActDownSampling, buf, off + 135);
    l2l1_putU8(msg.mantissaSize, buf, off + 136);
    l2l1_putU8(msg.staticLongPucch, buf, off + 137);
    l2l1_putU32(msg.localCellResId, buf, off + 140);
    l2l1_putU8(msg.pSRSact, buf, off + 144);
    l2l1_putU8(msg.pSRSnumCeAxCId, buf, off + 145);
    encodeDynamicVariableSizedArray_int16_32(msg.realPartOfPrecombinerRows, buf, off + 148);
    encodeDynamicVariableSizedArray_int16_32(msg.imagPartOfPrecombinerRows, buf, off + 156);
    encodeDynamicVariableSizedArray_int16_32(msg.realPartOfPrecombinerColumns, buf, off + 164);
    encodeDynamicVariableSizedArray_int16_32(msg.imagPartOfPrecombinerColumns, buf, off + 172);
    encodeDynamicVariableSizedArray_beamWeight_t_400(msg.beamWeight, buf, off + 180);
}
function UlCelldecodebeamWeight_t(offset) {
    let result = {};
...
/*    if (!(result.transmissionComb === [object Object] || result.transmissionComb === [object Object]))
    ...
    result.patternId = decodeStaticFixedSizedArray_uint16_2(offset + 12);
...
/*    if (!(result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object]))
    ...
    result.ceAxCIndex = decodeStaticFixedSizedArray_uint8_4(offset + 32);
...
function UlDataencodesrsReceiveReqUes_t(msg, buf, off) {
    ...
    encodeStaticFixedSizedArray_uint16_2(msg.patternId, buf, off + 12);
    ...
    encodeStaticFixedSizedArray_uint8_4(msg.ceAxCIndex, buf, off + 32);
}
...
function UlDatadecodesrsBmCombShiftPairs_t(offset) {
    ...
    result.bmCyclicShift = decodeDynamicVariableSizedArray_uint8_4(offset + 4);

    return result;
}
function UlDataencodesrsBmCombShiftPairs_t(msg, buf, off) {
    l2l1_putU8(msg.transmissionCombId, buf, off + 0);
    encodeDynamicVariableSizedArray_uint8_4(msg.bmCyclicShift, buf, off + 4);
}
...
/*    if (!(result.transmissionComb === [object Object] || result.transmissionComb === [object Object]))
    ...
    result.bmSubbands = decodeDynamicVariableSizedArray_srsBmSubbands_t_38(offset + 8);
...
function UlDataencodesrsBmStruct_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_srsBmSubbands_t_38(msg.bmSubbands, buf, off + 8);
}
function UlDatadecodesrsReceiveReqSubcell_t(offset) {
    ...
    result.srsBmStruct = UlDatadecodesrsBmStruct_t(offset + 20);
...
function UlDataencodesrsReceiveReqSubcell_t(msg, buf, off) {
    ...
    UlDataencodesrsBmStruct_t(msg.srsBmStruct, buf, off + 20);
}
...
/*    if (!(result.dtx === [object Object] || result.dtx === [object Object]))
    ...
    result.rxPowerOfAnt = decodeStaticFixedSizedArray_float32_4(offset + 36);
    result.sinrOfAnt = decodeStaticFixedSizedArray_float32_4(offset + 52);
    result.shortTermTaMetricOfAnt = decodeStaticFixedSizedArray_int16_4(offset + 68);
    result.shortTermTaPeakAmpOfAnt = decodeStaticFixedSizedArray_float32_4(offset + 76);
...
function UlDataencodesrsReceiveRespPsUes_t(msg, buf, off) {
    ...
    encodeStaticFixedSizedArray_float32_4(msg.rxPowerOfAnt, buf, off + 36);
    encodeStaticFixedSizedArray_float32_4(msg.sinrOfAnt, buf, off + 52);
    encodeStaticFixedSizedArray_int16_4(msg.shortTermTaMetricOfAnt, buf, off + 68);
    encodeStaticFixedSizedArray_float32_4(msg.shortTermTaPeakAmpOfAnt, buf, off + 76);
}
...
function UlDatadecodedata_t(offset) {
    ...
    result.scalingHorizontal = l2l1_getI8(offset + 2);
    result.scalingVertical = l2l1_getI8(offset + 3);
    result.covarianceMatrixHorizontal = decodeDynamicVariableSizedArray_covarianceMatrixSrs_t_36(offset + 4);
    result.covarianceMatrixVertical = decodeDynamicVariableSizedArray_covarianceMatrixSrs_t_10(offset + 12);
...
function UlDataencodedata_t(msg, buf, off) {
    ...
    l2l1_putI8(msg.scalingHorizontal, buf, off + 2);
    l2l1_putI8(msg.scalingVertical, buf, off + 3);
    encodeDynamicVariableSizedArray_covarianceMatrixSrs_t_36(msg.covarianceMatrixHorizontal, buf, off + 4);
    encodeDynamicVariableSizedArray_covarianceMatrixSrs_t_10(msg.covarianceMatrixVertical, buf, off + 12);
}
...
function l2l1_decode_msg(l2l1) {
    ...
    case 0xE115: // DlData::FastAntennaSnapshotReq_t
        ...
        break;
    case 0xE116: // DlData::PdschSendReq_t
...
function encodeDynamicVariableSizedArray_beamWeight_t_400(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_beamWeight_t_400(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_srsBmSubbands_t_38(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_srsBmSubbands_t_38(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
packetPropToStrMap["l2l1.message"] = {
    ...
    0xE236: "UlData::SrsReceiveReq",
    0xE237: "UlData::SrsReceiveRespPs",
    0xE238: "UlData::SrsReceiveRespBmPs",
};
