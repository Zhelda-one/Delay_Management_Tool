...
function L1ECpridecodeceAxCconfig_t(offset) {
    let result = {};
...
function L1ECpriencodeceAxCconfig_t(msg, buf, off) {
...
/*    if (!(result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object]))
    ...
    result.ceAxCinfo = decodeStaticVariableSizedArray_ceAxCconfig_t_24(offset + 4);

    return result;
}
function L1ECpriencodeConfigureTransportReq_t(msg, buf, off) {
    l2l1_putU8(msg.eCpriLink, buf, off + 0);
    encodeStaticVariableSizedArray_ceAxCconfig_t_24(msg.ceAxCinfo, buf, off + 4);
}
function L1ECpridecodeceAxCconfig_t(offset) {
    let result = {};
...
/*    if (!(result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object]))
    ...
    result.ceAxCinfo = decodeStaticVariableSizedArray_API2ceAxCconfig_t_24(offset + 8);
...
function L1ECpriencodeAPI2ConfigureTransportReq_t(msg, buf, off) {
    ...
    encodeStaticVariableSizedArray_API2ceAxCconfig_t_24(msg.ceAxCinfo, buf, off + 8);
}
function L1ECpridecodeAPI2ceAxCconfig_t(offset) {
    let result = {};
...
function l2l1_decode_msg(l2l1) {
    ...
    case 0xe301: // L1Cpri::ConfigureAxcInfoReq_t
        ...
        break;
    case 0xe303: // L1Cpri::DelayConfigReq_t
    ...
    case 0xe302: // L1ECpri::DelayConfigReq_t
        ...
        break;
    case 0xe304: // L1ECpri::ConfigureTransportReq_t
...
function l2l1_encode_msg(l2l1) {
    ...
    case 0xe302: // L1ECpri::DelayConfigReq_t
        ...
        break;
    case 0xe304: // L1ECpri::ConfigureTransportReq_t
        buf.static = new Uint8Array(392);
        L1ECpriencodeConfigureTransportReq_t(l2l1, buf, 0);
        break;
    case 0xe305: // L1ECpri::API2ConfigureTransportReq_t
        buf.static = new Uint8Array(396);
...
function encodeStaticVariableSizedArray_ceAxCconfig_t_24(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off);
    for (let i = 0; i < arr.length && i < 24; i++)
        L1ECpriencodeceAxCconfig_t(arr[i], buf, off + i * 16);
}
function decodeStaticVariableSizedArray_ceAxCconfig_t_24(offset) {
    const result = [];
    const length = l2l1_getU32(offset);
    for (let i = 0; i < length && i < 24; i++)
        result.push(L1ECpridecodeceAxCconfig_t(offset + 4 + i * 16));
    return result;
}
...
function encodeStaticVariableSizedArray_API2ceAxCconfig_t_24(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off);
    for (let i = 0; i < arr.length && i < 24; i++)
        L1ECpriencodeAPI2ceAxCconfig_t(arr[i], buf, off + i * 16);
}
function decodeStaticVariableSizedArray_API2ceAxCconfig_t_24(offset) {
    const result = [];
    const length = l2l1_getU32(offset);
    for (let i = 0; i < length && i < 24; i++)
...
packetPropToStrMap["l2l1.message"] = {
    ...
    0xe304: "L1ECpri::ConfigureTransportReq",
