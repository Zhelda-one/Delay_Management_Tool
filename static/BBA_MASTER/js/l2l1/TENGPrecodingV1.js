...
/*    if (!(result.numCeAxCId === [object Object] || result.numCeAxCId === [object Object] || result.numCeAxCId === [object Object] || result.numCeAxCId === [object Object]))
...
/*    if (!(result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object]))
...
function DlDatadecodePrecodingTable(offset) {
    let result = {};

    result.matrix = decodeStaticFixedSizedArray_int16_4(offset + 0);

    return result;
}
function DlDataencodePrecodingTable(msg, buf, off) {
    encodeStaticFixedSizedArray_int16_4(msg.matrix, buf, off + 0);
}
function DlDatadecodeBeamWeightPerAntennaElement(offset) {
    let result = {};

    result.re = l2l1_getU16(offset + 0);
    result.im = l2l1_getU16(offset + 2);

    return result;
}
function DlDataencodeBeamWeightPerAntennaElement(msg, buf, off) {
    l2l1_putU16(msg.re, buf, off + 0);
    l2l1_putU16(msg.im, buf, off + 2);
}
function DlDatadecodeBeamWeight(offset) {
    let result = {};

    result.patternId = l2l1_getU16(offset + 0);
    result.beamWeightsPerAntennaElement = decodeStaticVariableSizedArray_BeamWeightPerAntennaElement_64(offset + 4);

    return result;
}
function DlDataencodeBeamWeight(msg, buf, off) {
    l2l1_putU16(msg.patternId, buf, off + 0);
    encodeStaticVariableSizedArray_BeamWeightPerAntennaElement_64(msg.beamWeightsPerAntennaElement, buf, off + 4);
}
...
/*    if (!(result.numStreamIndex === [object Object] || result.numStreamIndex === [object Object] || result.numStreamIndex === [object Object] || result.numStreamIndex === [object Object]))
...
/*    if (!(result.openLoopScheme === [object Object] || result.openLoopScheme === [object Object] || result.openLoopScheme === [object Object] || result.openLoopScheme === [object Object]))
    ...
    result.patternId = decodeStaticVariableSizedArray_uint16_137(offset + 80);
    result.patternIdStream1 = decodeStaticVariableSizedArray_uint16_137(offset + 360);
    result.patternIdStream2 = decodeStaticVariableSizedArray_uint16_137(offset + 640);
    result.patternIdStream3 = decodeStaticVariableSizedArray_uint16_137(offset + 920);
    result.numberOfPrbPerSubband = l2l1_getU16(offset + 1200);
    result.numLteCrsMappingRes = l2l1_getU16(offset + 1202);
    result.lteCrsOption = l2l1_getU8(offset + 1204);
    result.isCsirsRateMatching = l2l1_getU8(offset + 1205);
    result.numCsirsMappingRes = l2l1_getU16(offset + 1206);
    result.pdschScramblingSeqInit = l2l1_getU16(offset + 1208);
    result.isLowPaprOptimizedPrecoding = l2l1_getU8(offset + 1210);
    result.closedLoop3gppCodebook = l2l1_getU8(offset + 1211);
/*    if (!(result.closedLoop3gppCodebook === [object Object] || result.closedLoop3gppCodebook === [object Object] || result.closedLoop3gppCodebook === [object Object] || result.closedLoop3gppCodebook === [object Object] || result.closedLoop3gppCodebook === [object Object]))
    ...
    result.bestBeamPowerOffset = l2l1_getU8(offset + 1212);
    result.rachStatus = l2l1_getU8(offset + 1213);
/*    if (!(result.rachStatus === [object Object] || result.rachStatus === [object Object] || result.rachStatus === [object Object] || result.rachStatus === [object Object] || result.rachStatus === [object Object]))
        throw new Error(`Value ${result.rachStatus} is out of range for enum 'rachStatus_t'`); */
    Object.defineProperty(result, "__enum_rachStatus", {
        enumerable: false,
...
function DlDataencodePdschGrant(msg, buf, off) {
    ...
    encodeStaticVariableSizedArray_uint16_137(msg.patternId, buf, off + 80);
    encodeStaticVariableSizedArray_uint16_137(msg.patternIdStream1, buf, off + 360);
    encodeStaticVariableSizedArray_uint16_137(msg.patternIdStream2, buf, off + 640);
    encodeStaticVariableSizedArray_uint16_137(msg.patternIdStream3, buf, off + 920);
    l2l1_putU16(msg.numberOfPrbPerSubband, buf, off + 1200);
    l2l1_putU16(msg.numLteCrsMappingRes, buf, off + 1202);
    l2l1_putU8(msg.lteCrsOption, buf, off + 1204);
    l2l1_putU8(msg.isCsirsRateMatching, buf, off + 1205);
    l2l1_putU16(msg.numCsirsMappingRes, buf, off + 1206);
    l2l1_putU16(msg.pdschScramblingSeqInit, buf, off + 1208);
    l2l1_putU8(msg.isLowPaprOptimizedPrecoding, buf, off + 1210);
    l2l1_putU8(msg.closedLoop3gppCodebook, buf, off + 1211);
    l2l1_putU8(msg.bestBeamPowerOffset, buf, off + 1212);
    l2l1_putU8(msg.rachStatus, buf, off + 1213);
}
function DlDatadecodePdschSendReq_t(offset) {
    ...
    result.sfn = l2l1_getU16(offset + 2);
    result.slot = l2l1_getU8(offset + 4);
    result.precodingMatrix = decodeStaticVariableSizedArray_PrecodingTable_68(offset + 8);
    result.beamWeights = decodeStaticVariableSizedArray_BeamWeight_144(offset + 556);
    result.grants = decodeDynamicPackedArray_PdschGrant_16(offset + 38576);
    result.msgCountCtrl = l2l1_getU8(offset + 38578);
...
function DlDataencodePdschSendReq_t(msg, buf, off) {
    ...
    l2l1_putU16(msg.sfn, buf, off + 2);
    l2l1_putU8(msg.slot, buf, off + 4);
    encodeStaticVariableSizedArray_PrecodingTable_68(msg.precodingMatrix, buf, off + 8);
    encodeStaticVariableSizedArray_BeamWeight_144(msg.beamWeights, buf, off + 556);
    encodeDynamicPackedArray_PdschGrant_16(msg.grants, buf, off + 38576);
    l2l1_putU8(msg.msgCountCtrl, buf, off + 38578);
}
...
/*    if (!(result.prachDtxThresholdSelection === [object Object] || result.prachDtxThresholdSelection === [object Object]))
    ...
    result.actOranFDD = l2l1_getU8(offset + 167);
    result.ORANprachNumerology = l2l1_getU8(offset + 168);
    result.ulIqCompression = l2l1_getU8(offset + 169);
    result.ulActDownSampling = l2l1_getU8(offset + 170);
    result.mantissaSize = l2l1_getU8(offset + 171);
/*    if (!(result.mantissaSize === [object Object] || result.mantissaSize === [object Object]))
        throw new Error(`Value ${result.mantissaSize} is out of range for enum 'mantissaSize_t'`); */
    Object.defineProperty(result, "__enum_mantissaSize", {
        enumerable: false,
    ...
    result.staticLongPucch = l2l1_getU8(offset + 172);
    result.localCellResId = l2l1_getU32(offset + 176);
    result.pSRSact = l2l1_getU8(offset + 180);
    result.pSRSBwvAct = l2l1_getU8(offset + 181);
    result.pSRSBwvConfig = UlCelldecodepSRSBwvConfig_t(offset + 182);
    result.pSRSconfig = UlCelldecodepSRSconfig_t(offset + 188);
    result.actHighSpeedCell = l2l1_getU8(offset + 232);
    result.actUlMuMimo = l2l1_getU8(offset + 233);
    result.ulMaxUplaneSectionsPerSym = l2l1_getU8(offset + 234);
    result.actUlPrbMuting = l2l1_getU8(offset + 235);
    result.ulSubCellCaps = l2l1_getU32(offset + 236);
...
function UlCellencodeSetupReq_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.actOranFDD, buf, off + 167);
    l2l1_putU8(msg.ORANprachNumerology, buf, off + 168);
    l2l1_putU8(msg.ulIqCompression, buf, off + 169);
    l2l1_putU8(msg.ulActDownSampling, buf, off + 170);
    l2l1_putU8(msg.mantissaSize, buf, off + 171);
    l2l1_putU8(msg.staticLongPucch, buf, off + 172);
    l2l1_putU32(msg.localCellResId, buf, off + 176);
    l2l1_putU8(msg.pSRSact, buf, off + 180);
    l2l1_putU8(msg.pSRSBwvAct, buf, off + 181);
    UlCellencodepSRSBwvConfig_t(msg.pSRSBwvConfig, buf, off + 182);
    UlCellencodepSRSconfig_t(msg.pSRSconfig, buf, off + 188);
    l2l1_putU8(msg.actHighSpeedCell, buf, off + 232);
    l2l1_putU8(msg.actUlMuMimo, buf, off + 233);
    l2l1_putU8(msg.ulMaxUplaneSectionsPerSym, buf, off + 234);
    l2l1_putU8(msg.actUlPrbMuting, buf, off + 235);
    l2l1_putU32(msg.ulSubCellCaps, buf, off + 236);
}
function UlCelldecodeulBeams_t(offset) {
    let result = {};
...
/*    if (!(result.mantissaSize === [object Object] || result.mantissaSize === [object Object]))
    ...
    result.pSRSact = l2l1_getU8(offset + 180);
    result.pSRSBwvAct = l2l1_getU8(offset + 181);
    result.pSRSBwvConfig = decodepSRSBwvConfig_t(offset + 182);
    result.pSRSconfig = decodepSRSconfig_t(offset + 188);
    result.actHighSpeedCell = l2l1_getU8(offset + 232);
    result.actUlMuMimo = l2l1_getU8(offset + 233);
    result.ulMaxUplaneSectionsPerSym = l2l1_getU8(offset + 234);
    result.actUlPrbMuting = l2l1_getU8(offset + 235);
...
function encodeSetupReq_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.pSRSact, buf, off + 180);
    l2l1_putU8(msg.pSRSBwvAct, buf, off + 181);
    encodepSRSBwvConfig_t(msg.pSRSBwvConfig, buf, off + 182);
    encodepSRSconfig_t(msg.pSRSconfig, buf, off + 188);
    l2l1_putU8(msg.actHighSpeedCell, buf, off + 232);
    l2l1_putU8(msg.actUlMuMimo, buf, off + 233);
    l2l1_putU8(msg.ulMaxUplaneSectionsPerSym, buf, off + 234);
    l2l1_putU8(msg.actUlPrbMuting, buf, off + 235);
...
/*    if (!(result.csiPart2CrcCheck === [object Object] || result.csiPart2CrcCheck === [object Object]))
    ...
    result.rssiOfAnt = decodeStaticFixedSizedArray_float32_4(offset + 104);
    result.rxPowerOfAnt = decodeStaticFixedSizedArray_float32_4(offset + 120);
    result.sinrOfAnt = decodeStaticFixedSizedArray_float32_4(offset + 136);
    result.shortTermTaMetricOfAnt = decodeStaticFixedSizedArray_int16_4(offset + 152);
    result.shortTermTaPeakAmpOfAnt = decodeStaticFixedSizedArray_float32_4(offset + 160);
    result.shortTermCfoMetricOfAnt = decodeStaticFixedSizedArray_shortTermCfoMetric_t_4(offset + 176);
...
function UlDataencodeUePuschReceiveRespPs_t(msg, buf, off) {
    ...
    encodeStaticFixedSizedArray_float32_4(msg.rssiOfAnt, buf, off + 104);
    encodeStaticFixedSizedArray_float32_4(msg.rxPowerOfAnt, buf, off + 120);
    encodeStaticFixedSizedArray_float32_4(msg.sinrOfAnt, buf, off + 136);
    encodeStaticFixedSizedArray_int16_4(msg.shortTermTaMetricOfAnt, buf, off + 152);
    encodeStaticFixedSizedArray_float32_4(msg.shortTermTaPeakAmpOfAnt, buf, off + 160);
    encodeStaticFixedSizedArray_shortTermCfoMetric_t_4(msg.shortTermCfoMetricOfAnt, buf, off + 176);
}
function UlDatadecodepuschReceiveRespPsSubcell_t(offset) {
    ...
    result.noisePerPrb = decodeDynamicVariableSizedArray_uint32_273(offset + 24);
    result.grants = decodeDynamicVariableSizedArray_UePuschReceiveRespPs_t_16(offset + 32);
...
function UlDataencodepuschReceiveRespPsSubcell_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_uint32_273(msg.noisePerPrb, buf, off + 24);
    encodeDynamicVariableSizedArray_UePuschReceiveRespPs_t_16(msg.grants, buf, off + 32);
}
function UlDatadecodeUePuschReceiveRespPs_t(offset) {
    let result = {};
...
/*    if (!(result.puschTransformPrecoderFlag === [object Object] || result.puschTransformPrecoderFlag === [object Object]))
    ...
    result.cRnti = l2l1_getU16(offset + 134);
    result.longTermCfoMetricOfAnt = decodeStaticFixedSizedArray_longTermCfoMetric_t_4(offset + 136);
    result.eCpriFcpSectionConfig = UlDatadecodeeCpriFcpSectionConfig_t(offset + 168);
    result.prachPeakMetric = l2l1_getF32(offset + 184);
    result.ext = decodeStaticVariableSizedArray_uint32_2(offset + 188);
    result.pairedUe = l2l1_getU16(offset + 200);
...
function UlDataencodepuschReceiveReqGrant_t(msg, buf, off) {
    ...
    l2l1_putU16(msg.cRnti, buf, off + 134);
    encodeStaticFixedSizedArray_longTermCfoMetric_t_4(msg.longTermCfoMetricOfAnt, buf, off + 136);
    UlDataencodeeCpriFcpSectionConfig_t(msg.eCpriFcpSectionConfig, buf, off + 168);
    l2l1_putF32(msg.prachPeakMetric, buf, off + 184);
    encodeStaticVariableSizedArray_uint32_2(msg.ext, buf, off + 188);
    l2l1_putU16(msg.pairedUe, buf, off + 200);
}
...
/*    if (!(result.modulationType === [object Object] || result.modulationType === [object Object]))
    ...
    result.eCpriPucchFcpAllocConf = UlDatadecodeeCpriPucchFcpAllocConf_t(offset + 92);
...
function UlDataencodepucchReceiveReqPucchResource_t(msg, buf, off) {
    ...
    UlDataencodeeCpriPucchFcpAllocConf_t(msg.eCpriPucchFcpAllocConf, buf, off + 92);
}
function UlDatadecodepucchReceiveReqSubcell_t(offset) {
    ...
    result.pucchAreaBoundaries = UlDatadecodepucchAreaBoundaries_t(offset + 48);
    result.pucchResources = decodeDynamicVariableSizedArray_pucchReceiveReqPucchResource_t_252(offset + 112);
...
function UlDataencodepucchReceiveReqSubcell_t(msg, buf, off) {
    ...
    UlDataencodepucchAreaBoundaries_t(msg.pucchAreaBoundaries, buf, off + 48);
    encodeDynamicVariableSizedArray_pucchReceiveReqPucchResource_t_252(msg.pucchResources, buf, off + 112);
}
function UlDatadecodepucchReceiveReqPucchResource_t(offset) {
    let result = {};
...
function UlDatadecodeextendedParameters_t(offset) {
    ...
    result.shortTermCfoMetricOfAnt = decodeStaticFixedSizedArray_shortTermCfoMetric_t_4(offset + 0);

    return result;
}
function UlDataencodeextendedParameters_t(msg, buf, off) {
    encodeStaticFixedSizedArray_shortTermCfoMetric_t_4(msg.shortTermCfoMetricOfAnt, buf, off + 0);
}
...
/*    if (!(result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object]))
    ...
    result.eCpriSrsFcpAllocConf = UlDatadecodeeCpriSrsFcpAllocConf_t(offset + 36);
...
function UlDataencodesrsReceiveReqUes_t(msg, buf, off) {
    ...
    UlDataencodeeCpriSrsFcpAllocConf_t(msg.eCpriSrsFcpAllocConf, buf, off + 36);
}
...
function UlDatadecodeSrsReceiveRespBmPs_t(offset) {
    ...
    result.srsRespBmPsSubbands = decodeDynamicVariableSizedArray_srsRespBmPsSubbands_t_1(offset + 8);
    result.bwvSrsUe = l2l1_getU32(offset + 16);
    result.bwvSrsPort = l2l1_getU32(offset + 20);
    result.bwvSrsNumElemArr = l2l1_getU32(offset + 24);
    result.bwvSrsCeOutput = decodeStaticFixedSizedArray_int16_17408(offset + 28);
    result.bmvSrsScalingBuf = decodeStaticFixedSizedArray_int32_32(offset + 34844);
...
function UlDataencodeSrsReceiveRespBmPs_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_srsRespBmPsSubbands_t_1(msg.srsRespBmPsSubbands, buf, off + 8);
    l2l1_putU32(msg.bwvSrsUe, buf, off + 16);
    l2l1_putU32(msg.bwvSrsPort, buf, off + 20);
    l2l1_putU32(msg.bwvSrsNumElemArr, buf, off + 24);
    encodeStaticFixedSizedArray_int16_17408(msg.bwvSrsCeOutput, buf, off + 28);
    encodeStaticFixedSizedArray_int32_32(msg.bmvSrsScalingBuf, buf, off + 34844);
}
function UlDatadecodesrsRespBmPsSubbands_t(offset) {
    let result = {};
...
function UlDatadecodesrsRespChannelMatricesPsSubbands_t(offset) {
    let result = {};

    result.subbandId = l2l1_getU8(offset + 0);
    result.transmissionCombId = l2l1_getU8(offset + 1);
    result.bmCyclicShift = l2l1_getU8(offset + 2);
    result.rnti = l2l1_getU16(offset + 4);
    result.channelMatrixReal = decodeStaticFixedSizedArray_int16_256(offset + 8);
    result.channelMatrixImag = decodeStaticFixedSizedArray_int16_256(offset + 520);

    return result;
}
function UlDataencodesrsRespChannelMatricesPsSubbands_t(msg, buf, off) {
    l2l1_putU8(msg.subbandId, buf, off + 0);
    l2l1_putU8(msg.transmissionCombId, buf, off + 1);
    l2l1_putU8(msg.bmCyclicShift, buf, off + 2);
    l2l1_putU16(msg.rnti, buf, off + 4);
    encodeStaticFixedSizedArray_int16_256(msg.channelMatrixReal, buf, off + 8);
    encodeStaticFixedSizedArray_int16_256(msg.channelMatrixImag, buf, off + 520);
}
function UlDatadecodeSrsReceiveRespChannelMatricesPs_t(offset) {
    let result = {};
    ...
    result.subcellId = l2l1_getU8(offset + 3);
    result.symbolPosition = l2l1_getU8(offset + 4);
    result.subbands = decodeDynamicVariableSizedArray_srsRespChannelMatricesPsSubbands_t_1(offset + 8);

    return result;
}
function UlDataencodeSrsReceiveRespChannelMatricesPs_t(msg, buf, off) {
    l2l1_putU16(msg.sfn, buf, off + 0);
    l2l1_putU8(msg.slot, buf, off + 2);
    l2l1_putU8(msg.subcellId, buf, off + 3);
    l2l1_putU8(msg.symbolPosition, buf, off + 4);
    encodeDynamicVariableSizedArray_srsRespChannelMatricesPsSubbands_t_1(msg.subbands, buf, off + 8);
}
function UlDatadecodesrsRespChannelMatricesPsSubbands_t(offset) {
    let result = {};
...
/*    if (!(result.trafficMode === [object Object] || result.trafficMode === [object Object] || result.trafficMode === [object Object]))
    ...
    result.duPortInfo = decodeStaticVariableSizedArray_uint8_14(offset + 8);
    result.ruPortInfo = decodeStaticVariableSizedArray_uint8_15(offset + 24);
    result.localMacAddr = decodeStaticVariableSizedArray_uint8_20(offset + 44);
    result.remoteMacAddr = decodeStaticVariableSizedArray_uint8_20(offset + 68);
    result.ruCapability = l2l1_getU8(offset + 92);
    result.trafficMacSecProtection = l2l1_getU8(offset + 93);
...
function L1MacSecencodeconnectionSetupReq_t(msg, buf, off) {
    ...
    encodeStaticVariableSizedArray_uint8_14(msg.duPortInfo, buf, off + 8);
    encodeStaticVariableSizedArray_uint8_15(msg.ruPortInfo, buf, off + 24);
    encodeStaticVariableSizedArray_uint8_20(msg.localMacAddr, buf, off + 44);
    encodeStaticVariableSizedArray_uint8_20(msg.remoteMacAddr, buf, off + 68);
    l2l1_putU8(msg.ruCapability, buf, off + 92);
    l2l1_putU8(msg.trafficMacSecProtection, buf, off + 93);
}
...
function L1MacSecdecodeconnectionStatusInd_t(offset) {
    ...
    result.transactionId = l2l1_getU32(offset + 0);
    result.duPortInfo = decodeStaticVariableSizedArray_uint8_14(offset + 4);
    result.ruPortInfo = decodeStaticVariableSizedArray_uint8_15(offset + 24);
    result.localMacAddr = decodeStaticVariableSizedArray_uint8_20(offset + 44);
    result.remoteMacAddr = decodeStaticVariableSizedArray_uint8_20(offset + 68);
    result.status = l2l1_getU8(offset + 92);
/*    if (!(result.status === [object Object] || result.status === [object Object] || result.status === [object Object]))
...
function L1MacSecencodeconnectionStatusInd_t(msg, buf, off) {
    l2l1_putU32(msg.transactionId, buf, off + 0);
    encodeStaticVariableSizedArray_uint8_14(msg.duPortInfo, buf, off + 4);
    encodeStaticVariableSizedArray_uint8_15(msg.ruPortInfo, buf, off + 24);
    encodeStaticVariableSizedArray_uint8_20(msg.localMacAddr, buf, off + 44);
    encodeStaticVariableSizedArray_uint8_20(msg.remoteMacAddr, buf, off + 68);
    l2l1_putU8(msg.status, buf, off + 92);
}
function l2l1_decode_msg(l2l1) {
    ...
    case 0xE251: // UlData::PuschReceiveReq_t
        ...
        break;
    case 0xE252: // UlData::SrsReceiveRespChannelMatricesPs_t
        result = UlDatadecodeSrsReceiveRespChannelMatricesPs_t(0);
        break;
...
function l2l1_encode_msg(l2l1) {
    ...
    case 0xE115: // DlData::FastAntennaSnapshotReq_t
        ...
        break;
    case 0xE118: // DlData::PdschSendReq_t
        buf.static = new Uint8Array(38580);
    ...
    case 0xE252: // UlData::SrsReceiveRespChannelMatricesPs_t
        buf.static = new Uint8Array(16);
        UlDataencodeSrsReceiveRespChannelMatricesPs_t(l2l1, buf, 0);
        break;
    case 0xE255: // UlData::SrsReceiveReq_t
        buf.static = new Uint8Array(24);
        ...
        break;
    case 0xE256: // UlData::SrsReceiveRespBmPs_t
        buf.static = new Uint8Array(34972);
...
function encodeStaticFixedSizedArray_int16_17408(arr, buf, off) {
    for (let i = 0; i < 17408; i++)
        l2l1_putI16(arr[i], buf, off + i * 2);
}
function decodeStaticFixedSizedArray_int16_17408(offset) {
    const result = [];
    for (let i = 0; i < 17408; i++)
        result.push(l2l1_getI16(offset + i * 2));
    return result;
}
function encodeStaticFixedSizedArray_int16_256(arr, buf, off) {
    for (let i = 0; i < 256; i++)
        l2l1_putI16(arr[i], buf, off + i * 2);
}
function decodeStaticFixedSizedArray_int16_256(offset) {
    const result = [];
    for (let i = 0; i < 256; i++)
        result.push(l2l1_getI16(offset + i * 2));
    return result;
...
function encodeStaticFixedSizedArray_int32_32(arr, buf, off) {
    for (let i = 0; i < 32; i++)
        l2l1_putI32(arr[i], buf, off + i * 4);
}
function decodeStaticFixedSizedArray_int32_32(offset) {
    const result = [];
    for (let i = 0; i < 32; i++)
        result.push(l2l1_getI32(offset + i * 4));
    return result;
}
function encodeStaticFixedSizedArray_FastAntennaSnapshotEventsList_t_8(arr, buf, off) {
    for (let i = 0; i < 8; i++)
...
function encodeStaticVariableSizedArray_uint8_14(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off);
    for (let i = 0; i < arr.length && i < 14; i++)
        l2l1_putU8(arr[i], buf, off + i * 1);
}
function decodeStaticVariableSizedArray_uint8_14(offset) {
    const result = [];
    const length = l2l1_getU32(offset);
...
function encodeStaticVariableSizedArray_uint8_15(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off);
    for (let i = 0; i < arr.length && i < 15; i++)
        l2l1_putU8(arr[i], buf, off + i * 1);
}
function decodeStaticVariableSizedArray_uint8_15(offset) {
    const result = [];
    const length = l2l1_getU32(offset);
    for (let i = 0; i < length && i < 15; i++)
        result.push(l2l1_getU8(offset + 4 + i * 1));
    return result;
}
...
function encodeStaticVariableSizedArray_BeamWeightPerAntennaElement_64(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off);
    for (let i = 0; i < arr.length && i < 64; i++)
        DlDataencodeBeamWeightPerAntennaElement(arr[i], buf, off + i * 4);
}
function decodeStaticVariableSizedArray_BeamWeightPerAntennaElement_64(offset) {
    const result = [];
    const length = l2l1_getU32(offset);
    for (let i = 0; i < length && i < 64; i++)
        result.push(DlDatadecodeBeamWeightPerAntennaElement(offset + 4 + i * 4));
    return result;
}
function encodeStaticVariableSizedArray_uint16_137(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off);
    for (let i = 0; i < arr.length && i < 137; i++)
        l2l1_putU16(arr[i], buf, off + i * 2);
}
function decodeStaticVariableSizedArray_uint16_137(offset) {
    const result = [];
    const length = l2l1_getU32(offset);
    for (let i = 0; i < length && i < 137; i++)
        result.push(l2l1_getU16(offset + 4 + i * 2));
    return result;
}
function encodeStaticVariableSizedArray_PrecodingTable_68(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off);
    for (let i = 0; i < arr.length && i < 68; i++)
        DlDataencodePrecodingTable(arr[i], buf, off + i * 8);
}
function decodeStaticVariableSizedArray_PrecodingTable_68(offset) {
    const result = [];
    const length = l2l1_getU32(offset);
    for (let i = 0; i < length && i < 68; i++)
        result.push(DlDatadecodePrecodingTable(offset + 4 + i * 8));
    return result;
}
function encodeStaticVariableSizedArray_BeamWeight_144(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off);
    for (let i = 0; i < arr.length && i < 144; i++)
        DlDataencodeBeamWeight(arr[i], buf, off + i * 264);
}
function decodeStaticVariableSizedArray_BeamWeight_144(offset) {
    const result = [];
    const length = l2l1_getU32(offset);
    for (let i = 0; i < length && i < 144; i++)
        result.push(DlDatadecodeBeamWeight(offset + 4 + i * 264));
    return result;
}
...
function encodeDynamicVariableSizedArray_srsRespBmPsSubbands_t_1(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_srsRespBmPsSubbands_t_1(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_srsRespChannelMatricesPsSubbands_t_1(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        UlDataencodesrsRespChannelMatricesPsSubbands_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_srsRespChannelMatricesPsSubbands_t_1(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(UlDatadecodesrsRespChannelMatricesPsSubbands_t(offset));
        offset += 1032;
    }
...
function decodeDynamicPackedArray_PdschGrant_16(offset) {
    ...
    for (let i = 0; i < length; i++)
        result.push(DlDatadecodePdschGrant(offset + 1 + arrOffset + i * 1216));
    return result;
}
...
packetPropToStrMap["l2l1.message"] = {
    ...
    0xE252: "UlData::SrsReceiveRespChannelMatricesPs",
