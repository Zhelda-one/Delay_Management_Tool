...
function DlDatadecodePdschPayloadTbSendReq_t(offset) {
    ...
    result.payload = decodeDynamicVariableSizedArray_uint8_63960(offset + 16);
...
function DlDataencodePdschPayloadTbSendReq_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_uint8_63960(msg.payload, buf, off + 16);
}
...
/*    if (!(result.method === [object Object] || result.method === [object Object]))
    ...
    result.srsQualityThreshold = l2l1_getI16(offset + 4);
...
function UlCellencodepSRSBwvConfig_t(msg, buf, off) {
    ...
    l2l1_putI16(msg.srsQualityThreshold, buf, off + 4);
}
...
/*    if (!(result.numberOfRowTRX === [object Object] || result.numberOfRowTRX === [object Object] || result.numberOfRowTRX === [object Object]))
    ...
    result.ulBeams = decodeDynamicVariableSizedArray_ulBeams_t_421(offset + 36);
...
function UlCellencodepSRSconfig_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_ulBeams_t_421(msg.ulBeams, buf, off + 36);
}
...
/*    if (!(result.mantissaSize === [object Object] || result.mantissaSize === [object Object]))
    ...
    result.mantissaSizePuschBeta = l2l1_getU8(offset + 248);
/*    if (!(result.mantissaSizePuschBeta === [object Object] || result.mantissaSizePuschBeta === [object Object]))
    ...
    result.xEc = l2l1_getU8(offset + 249);
    result.betaEc = l2l1_getU8(offset + 250);
    result.numOfLogicalResourceIds = l2l1_getU8(offset + 251);
/*    if (!(result.numOfLogicalResourceIds === [object Object] || result.numOfLogicalResourceIds === [object Object] || result.numOfLogicalResourceIds === [object Object] || result.numOfLogicalResourceIds === [object Object] || result.numOfLogicalResourceIds === [object Object]))
    ...
    result.multiPurposeField = l2l1_getU16(offset + 300);
    result.explicitPadding = l2l1_getU16(offset + 302);
...
function UlCellencodeSetupReq_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.mantissaSizePuschBeta, buf, off + 248);
    l2l1_putU8(msg.xEc, buf, off + 249);
    l2l1_putU8(msg.betaEc, buf, off + 250);
    l2l1_putU8(msg.numOfLogicalResourceIds, buf, off + 251);
    encodeStaticFixedSizedArray_uint32_12(msg.logicalResourceIds, buf, off + 252);
    l2l1_putU16(msg.multiPurposeField, buf, off + 300);
    l2l1_putU16(msg.explicitPadding, buf, off + 302);
}
function UlCelldecodeulBeams_t(offset) {
    let result = {};
...
/*    if (!(result.csiPart2CrcCheck === [object Object] || result.csiPart2CrcCheck === [object Object] || result.csiPart2CrcCheck === [object Object]))
    ...
    result.puschAntMeas = decodeDynamicVariableSizedArray_puschAntMeas_t_8(offset + 104);
...
function UlDataencodeUePuschReceiveRespPs_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_puschAntMeas_t_8(msg.puschAntMeas, buf, off + 104);
}
function UlDatadecodepuschReceiveRespPsSubcell_t(offset) {
    ...
    result.rtwpOfAnt = decodeDynamicVariableSizedArray_float32_8(offset + 8);
    result.noisePerPrb = decodeDynamicVariableSizedArray_uint32_273(offset + 16);
...
function UlDataencodepuschReceiveRespPsSubcell_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_float32_8(msg.rtwpOfAnt, buf, off + 8);
    encodeDynamicVariableSizedArray_uint32_273(msg.noisePerPrb, buf, off + 16);
...
function UlDatadecodesrsReceiveReqSubcell_t(offset) {
    ...
    result.srsBwvStruct = UlDatadecodesrsBwvStruct_t(offset + 48);
...
function UlDataencodesrsReceiveReqSubcell_t(msg, buf, off) {
    ...
    UlDataencodesrsBwvStruct_t(msg.srsBwvStruct, buf, off + 48);
}
...
function UlDatadecodeSrsReceiveRespBmPs_t(offset) {
    ...
    result.srsRespBmPsResources = decodeDynamicVariableSizedArray_srsRespBmPsResources_t_314(offset + 8);
...
function UlDataencodeSrsReceiveRespBmPs_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_srsRespBmPsResources_t_314(msg.srsRespBmPsResources, buf, off + 8);
}
function UlDatadecodesrsRespBmPsResources_t(offset) {
    let result = {};
...
function L1MacSecdecoderuPortInfoInConnSetupReq_t(offset) {
    let result = {};

    result.ruPortInfo = decodeStaticVariableSizedArray_uint8_20(offset + 0);

    return result;
}
function L1MacSecencoderuPortInfoInConnSetupReq_t(msg, buf, off) {
    encodeStaticVariableSizedArray_uint8_20(msg.ruPortInfo, buf, off + 0);
}
function L1MacSecdecoderuMacAddrInConnSetupReq_t(offset) {
    let result = {};

    result.ruMacAddr = decodeStaticVariableSizedArray_uint8_20(offset + 0);

    return result;
}
function L1MacSecencoderuMacAddrInConnSetupReq_t(msg, buf, off) {
    encodeStaticVariableSizedArray_uint8_20(msg.ruMacAddr, buf, off + 0);
}
...
/*    if (!(result.trafficProtection === [object Object] || result.trafficProtection === [object Object] || result.trafficProtection === [object Object]))
    ...
    result.ruPortInfo = decodeDynamicVariableSizedArray_ruPortInfoInConnSetupReq_t_216(offset + 32);
    result.duMacAddr = decodeStaticVariableSizedArray_uint8_20(offset + 40);
    result.cellSiteSwitchMacAddr = decodeStaticVariableSizedArray_uint8_20(offset + 64);
    result.ruMacAddr = decodeDynamicVariableSizedArray_ruMacAddrInConnSetupReq_t_216(offset + 88);
    result.ruCapability = l2l1_getU8(offset + 96);
    result.cak = decodeStaticVariableSizedArray_uint8_32(offset + 100);
    result.ckn = decodeStaticVariableSizedArray_uint8_32(offset + 136);
    result.macSecProfileId = l2l1_getU8(offset + 172);
    result.mkaProfileId = l2l1_getU8(offset + 173);
...
function L1MacSecencodeconnectionSetupReq_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_ruPortInfoInConnSetupReq_t_216(msg.ruPortInfo, buf, off + 32);
    encodeStaticVariableSizedArray_uint8_20(msg.duMacAddr, buf, off + 40);
    encodeStaticVariableSizedArray_uint8_20(msg.cellSiteSwitchMacAddr, buf, off + 64);
    encodeDynamicVariableSizedArray_ruMacAddrInConnSetupReq_t_216(msg.ruMacAddr, buf, off + 88);
    l2l1_putU8(msg.ruCapability, buf, off + 96);
    encodeStaticVariableSizedArray_uint8_32(msg.cak, buf, off + 100);
    encodeStaticVariableSizedArray_uint8_32(msg.ckn, buf, off + 136);
    l2l1_putU8(msg.macSecProfileId, buf, off + 172);
    l2l1_putU8(msg.mkaProfileId, buf, off + 173);
}
function L1MacSecdecoderuPortInfoInConnSetupReq_t(offset) {
    let result = {};
...
function L1MacSecdecoderuPortInfoInConnStatusInd_t(offset) {
    let result = {};
...
function L1MacSecencoderuPortInfoInConnStatusInd_t(msg, buf, off) {
    encodeStaticVariableSizedArray_uint8_20(msg.ruPortInfo, buf, off + 0);
}
function L1MacSecdecoderuMacAddrInConnStatusInd_t(offset) {
    let result = {};
...
function L1MacSecencoderuMacAddrInConnStatusInd_t(msg, buf, off) {
    encodeStaticVariableSizedArray_uint8_20(msg.ruMacAddr, buf, off + 0);
}
function L1MacSecdecodeconnectionStatusInd_t(offset) {
    let result = {};

    result.duPortInfo = decodeStaticVariableSizedArray_uint8_20(offset + 0);
    result.ruPortInfo = decodeDynamicVariableSizedArray_ruPortInfoInConnStatusInd_t_216(offset + 24);
    result.duMacAddr = decodeStaticVariableSizedArray_uint8_20(offset + 32);
    result.ruMacAddr = decodeDynamicVariableSizedArray_ruMacAddrInConnStatusInd_t_216(offset + 56);
    result.cellSiteSwitchMacAddr = decodeStaticVariableSizedArray_uint8_20(offset + 64);
...
function L1MacSecencodeconnectionStatusInd_t(msg, buf, off) {
    encodeStaticVariableSizedArray_uint8_20(msg.duPortInfo, buf, off + 0);
    encodeDynamicVariableSizedArray_ruPortInfoInConnStatusInd_t_216(msg.ruPortInfo, buf, off + 24);
    encodeStaticVariableSizedArray_uint8_20(msg.duMacAddr, buf, off + 32);
    encodeDynamicVariableSizedArray_ruMacAddrInConnStatusInd_t_216(msg.ruMacAddr, buf, off + 56);
    encodeStaticVariableSizedArray_uint8_20(msg.cellSiteSwitchMacAddr, buf, off + 64);
...
function encodeDynamicVariableSizedArray_uint8_63960(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_uint8_63960(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_ulBeams_t_421(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_ulBeams_t_421(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_srsRespBmPsResources_t_314(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_srsRespBmPsResources_t_314(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_ruPortInfoInConnSetupReq_t_216(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        L1MacSecencoderuPortInfoInConnSetupReq_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_ruPortInfoInConnSetupReq_t_216(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(L1MacSecdecoderuPortInfoInConnSetupReq_t(offset));
        offset += 24;
    }

    return result;
}
function encodeDynamicVariableSizedArray_ruMacAddrInConnSetupReq_t_216(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        L1MacSecencoderuMacAddrInConnSetupReq_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_ruMacAddrInConnSetupReq_t_216(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(L1MacSecdecoderuMacAddrInConnSetupReq_t(offset));
        offset += 24;
    }
...
function encodeDynamicVariableSizedArray_ruPortInfoInConnStatusInd_t_216(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        L1MacSecencoderuPortInfoInConnStatusInd_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_ruPortInfoInConnStatusInd_t_216(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(L1MacSecdecoderuPortInfoInConnStatusInd_t(offset));
        offset += 24;
    }

    return result;
}
function encodeDynamicVariableSizedArray_ruMacAddrInConnStatusInd_t_216(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        L1MacSecencoderuMacAddrInConnStatusInd_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_ruMacAddrInConnStatusInd_t_216(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(L1MacSecdecoderuMacAddrInConnStatusInd_t(offset));
        offset += 24;
    }
