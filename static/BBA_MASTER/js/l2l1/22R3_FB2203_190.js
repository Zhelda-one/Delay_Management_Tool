...
/*    if (!(result.numberOfRowTRX === [object Object] || result.numberOfRowTRX === [object Object] || result.numberOfRowTRX === [object Object]))
    ...
    result.ulBeams = decodeDynamicVariableSizedArray_ulBeams_t_400(offset + 36);
...
function UlCellencodepSRSconfig_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_ulBeams_t_400(msg.ulBeams, buf, off + 36);
}
...
/*    if (!(result.prachDtxThresholdSelection === [object Object] || result.prachDtxThresholdSelection === [object Object]))
    ...
    result.ORANprachNumerology = l2l1_getU8(offset + 167);
    result.ulIqCompression = l2l1_getU8(offset + 168);
    result.ulActDownSampling = l2l1_getU8(offset + 169);
    result.mantissaSize = l2l1_getU8(offset + 170);
/*    if (!(result.mantissaSize === [object Object] || result.mantissaSize === [object Object]))
        throw new Error(`Value ${result.mantissaSize} is out of range for enum 'mantissaSize_t'`); */
    Object.defineProperty(result, "__enum_mantissaSize", {
        enumerable: false,
    ...
    result.staticLongPucch = l2l1_getU8(offset + 171);
    result.localCellResId = l2l1_getU32(offset + 172);
    result.pSRSact = l2l1_getU8(offset + 176);
    result.pSRSconfig = UlCelldecodepSRSconfig_t(offset + 180);
...
function UlCellencodeSetupReq_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.ORANprachNumerology, buf, off + 167);
    l2l1_putU8(msg.ulIqCompression, buf, off + 168);
    l2l1_putU8(msg.ulActDownSampling, buf, off + 169);
    l2l1_putU8(msg.mantissaSize, buf, off + 170);
    l2l1_putU8(msg.staticLongPucch, buf, off + 171);
    l2l1_putU32(msg.localCellResId, buf, off + 172);
    l2l1_putU8(msg.pSRSact, buf, off + 176);
    UlCellencodepSRSconfig_t(msg.pSRSconfig, buf, off + 180);
...
/*    if (!(result.mantissaSize === [object Object] || result.mantissaSize === [object Object]))
    ...
    result.localCellResId = l2l1_getU32(offset + 172);
    result.pSRSact = l2l1_getU8(offset + 176);
    result.pSRSconfig = decodepSRSconfig_t(offset + 180);
    result.actHighSpeedCell = l2l1_getU8(offset + 224);
...
function encodeSetupReq_t(msg, buf, off) {
    ...
    l2l1_putU32(msg.localCellResId, buf, off + 172);
    l2l1_putU8(msg.pSRSact, buf, off + 176);
    encodepSRSconfig_t(msg.pSRSconfig, buf, off + 180);
    l2l1_putU8(msg.actHighSpeedCell, buf, off + 224);
}
function decodeulBeams_t(offset) {
    let result = {};
...
function UlDatadecoderimAllocationConfig_t(offset) {
    ...
    result.numOfPrbPerSubBand = l2l1_getU16(offset + 4);
    result.startPrbPerSubBand = decodeStaticFixedSizedArray_uint16_5(offset + 8);
...
function UlDataencoderimAllocationConfig_t(msg, buf, off) {
    ...
    l2l1_putU16(msg.numOfPrbPerSubBand, buf, off + 4);
    encodeStaticFixedSizedArray_uint16_5(msg.startPrbPerSubBand, buf, off + 8);
}
...
function UlDatadecodendmSymbolsConfig_t(offset) {
    let result = {};

    result.numNdmSymbols = l2l1_getU8(offset + 0);
    result.firstNdmSymbol = l2l1_getU8(offset + 1);
    result.patternId = decodeStaticFixedSizedArray_uint16_2(offset + 4);

    return result;
}
function UlDataencodendmSymbolsConfig_t(msg, buf, off) {
    l2l1_putU8(msg.numNdmSymbols, buf, off + 0);
    l2l1_putU8(msg.firstNdmSymbol, buf, off + 1);
    encodeStaticFixedSizedArray_uint16_2(msg.patternId, buf, off + 4);
}
function UlDatadecodeunscheduledRegionInfo_t(offset) {
    ...
    result.numOfPrb = l2l1_getU16(offset + 4);
    result.eCpriSectionId = l2l1_getU16(offset + 6);
...
function UlDataencodeunscheduledRegionInfo_t(msg, buf, off) {
    ...
    l2l1_putU16(msg.numOfPrb, buf, off + 4);
    l2l1_putU16(msg.eCpriSectionId, buf, off + 6);
}
function UlDatadecoderimReceiveReqSubcell_t(offset) {
    ...
    result.eCpriConfig = UlDatadecodeeCpriConfig_t(offset + 20);
    result.ndmSymbolsConfig = UlDatadecodendmSymbolsConfig_t(offset + 32);
    result.unscheduledRegionInfo = decodeDynamicVariableSizedArray_unscheduledRegionInfo_t_70(offset + 40);
...
function UlDataencoderimReceiveReqSubcell_t(msg, buf, off) {
    ...
    UlDataencodeeCpriConfig_t(msg.eCpriConfig, buf, off + 20);
    UlDataencodendmSymbolsConfig_t(msg.ndmSymbolsConfig, buf, off + 32);
    encodeDynamicVariableSizedArray_unscheduledRegionInfo_t_70(msg.unscheduledRegionInfo, buf, off + 40);
}
...
function encodeDynamicVariableSizedArray_ulBeams_t_400(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_ulBeams_t_400(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_unscheduledRegionInfo_t_70(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_unscheduledRegionInfo_t_70(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
