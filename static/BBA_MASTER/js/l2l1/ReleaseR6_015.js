...
function DlDatadecodePatternConfigReq_t(offset) {
    ...
    result.patternIdPol0List = decodeStaticFixedSizedArray_uint16_112(offset + 8);
    result.patternIdPol1List = decodeStaticFixedSizedArray_uint16_112(offset + 232);
    result.numOfXpolBeams = l2l1_getU8(offset + 456);
    result.calibrationBitmap = l2l1_getU16(offset + 458);
...
function DlDataencodePatternConfigReq_t(msg, buf, off) {
    ...
    encodeStaticFixedSizedArray_uint16_112(msg.patternIdPol0List, buf, off + 8);
    encodeStaticFixedSizedArray_uint16_112(msg.patternIdPol1List, buf, off + 232);
...
function UlDatadecodeSyncInd_t(offset) {
    let result = {};
...
function UlDataencodeSyncInd_t(msg, buf, off) {
...
function decodeSyncInd_t(offset) {
    let result = {};
...
function encodeSyncInd_t(msg, buf, off) {
    l2l1_putI32(msg.delay_nSec, buf, off + 0);
    l2l1_putU16(msg.sfn, buf, off + 4);
    l2l1_putU8(msg.subcellId, buf, off + 6);
    l2l1_putU8(msg.slot, buf, off + 7);
...
function l2l1_decode_msg(l2l1) {
    ...
    case 0x0206: // UlData::SyncInd_t
        result = UlDatadecodeSyncInd_t(0);
        break;
...
function l2l1_encode_msg(l2l1) {
    ...
    case 0x0206: // UlData::SyncInd_t
        buf.static = new Uint8Array(8);
        UlDataencodeSyncInd_t(l2l1, buf, 0);
        break;
    case 0x0218: // UlData::PuschReceiveRespHarqU_t
        buf.static = new Uint8Array(12);
