...
function LteLunum_DlData_decodedlUlSection_t(offset) {
    ...
    for (let i = 0; i < sectionExtensionsLength && i < 3; i++)
        result.sectionExtensions.push(LteLunum_DlData_decodesectionExtension_t(offset + 20 + i * 4));
...
function LteLunum_DlData_encodedlUlSection_t(msg, buf, off) {
    ...
    for (let i = 0; i < msg.sectionExtensions.length && i < 3; i++)
        LteLunum_DlData_encodesectionExtension_t(msg.sectionExtensions[i], buf, off + 16 + i * 4);
}

function LteLunum_DlData_decodesectionExtension_t(offset) {
    const result = {};
...
function LteLunum_DlData_encodesectionExtension_t(msg, buf, off) {
    l2l1_putU8(msg.extType, buf, off + 0);
    l2l1_putU8(msg.extParamLen, buf, off + 1);
    l2l1_putU16(msg.extParamOffset, buf, off + 2);
}

function LteLunum_DlCell_decodeDeleteReq_t(offset) {
    const result = {};
...
function LteLunum_DlCell_encodeDeleteReq_t(msg, buf, off) {
    l2l1_putU16(msg.physCellId, buf, off + 0);
}

function LteLunum_DlCell_decodeDeleteResp_t(offset) {
    const result = {};
...
function LteLunum_DlCell_encodeDeleteResp_t(msg, buf, off) {
    l2l1_putU16(msg.physCellId, buf, off + 0);
    l2l1_putU8(msg.status, buf, off + 2);
}

function LteLunum_DlCell_decodeSetupReq_t(offset) {
    const result = {};
...
function LteLunum_DlCell_encodeSetupReq_t(msg, buf, off) {
    l2l1_putU16(msg.physCellId, buf, off + 0);
...
function LteLunum_DlCell_decodeSetupResp_t(offset) {
    const result = {};
...
function LteLunum_DlCell_encodeSetupResp_t(msg, buf, off) {
    l2l1_putU16(msg.physCellId, buf, off + 0);
