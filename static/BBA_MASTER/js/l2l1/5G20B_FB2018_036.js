...
function UlDatadecodepuschReceiveReqSubcell_t(offset) {
    ...
    result.subcellId = l2l1_getU8(offset + 0);
    result.grants = decodeDynamicVariableSizedArray_puschReceiveReqGrant_t_16(offset + 4);

    return result;
}
function UlDataencodepuschReceiveReqSubcell_t(msg, buf, off) {
    l2l1_putU8(msg.subcellId, buf, off + 0);
    encodeDynamicVariableSizedArray_puschReceiveReqGrant_t_16(msg.grants, buf, off + 4);
}
function UlDatadecodepuschReceiveReqGrant_t(offset) {
    let result = {};
...
function UlDatadecodepucchReceiveReqSubcell_t(offset) {
    ...
    result.subcellId = l2l1_getU8(offset + 0);
    result.pucchResources = decodeDynamicVariableSizedArray_pucchReceiveReqPucchResource_t_86(offset + 4);

    return result;
}
function UlDataencodepucchReceiveReqSubcell_t(msg, buf, off) {
    l2l1_putU8(msg.subcellId, buf, off + 0);
    encodeDynamicVariableSizedArray_pucchReceiveReqPucchResource_t_86(msg.pucchResources, buf, off + 4);
}
function UlDatadecodepucchReceiveReqPucchResource_t(offset) {
    let result = {};
...
function UlDatadecodeprachReceiveReqSubcell_t(offset) {
    ...
    result.occasions = decodeDynamicVariableSizedArray_prachReceiveReqOccasion_t_24(offset + 20);
...
function UlDataencodeprachReceiveReqSubcell_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_prachReceiveReqOccasion_t_24(msg.occasions, buf, off + 20);
}
...
/*    if (!(result.transmissionComb === [object Object] || result.transmissionComb === [object Object]))
    ...
    result.sequenceId = l2l1_getU16(offset + 10);
    result.cyclicShift = l2l1_getU8(offset + 12);
    result.numOfSrsPorts = l2l1_getU8(offset + 13);
/*    if (!(result.numOfSrsPorts === [object Object] || result.numOfSrsPorts === [object Object] || result.numOfSrsPorts === [object Object]))
    ...
    result.numCeAxCIndex = l2l1_getU8(offset + 14);
/*    if (!(result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object]))
        throw new Error(`Value ${result.numCeAxCIndex} is out of range for enum 'numCeAxC_t'`); */
    Object.defineProperty(result, "__enum_numCeAxCIndex", {
        enumerable: false,
    ...
    result.ceAxCIndex = decodeStaticFixedSizedArray_uint8_4(offset + 16);
    result.patternId = decodeStaticFixedSizedArray_uint16_2(offset + 20);
    result.powerOffsetSrsToPuschPerAllocatedRe = l2l1_getF32(offset + 24);
    result.puschTransCoherence = l2l1_getU8(offset + 28);
/*    if (!(result.puschTransCoherence === [object Object] || result.puschTransCoherence === [object Object] || result.puschTransCoherence === [object Object]))
        throw new Error(`Value ${result.puschTransCoherence} is out of range for enum 'puschTransCoherence_t'`); */
    Object.defineProperty(result, "__enum_puschTransCoherence", {
        enumerable: false,
...
function UlDataencodesrsSuMimoStruct_t(msg, buf, off) {
    ...
    l2l1_putU16(msg.sequenceId, buf, off + 10);
    l2l1_putU8(msg.cyclicShift, buf, off + 12);
    l2l1_putU8(msg.numOfSrsPorts, buf, off + 13);
    l2l1_putU8(msg.numCeAxCIndex, buf, off + 14);
    encodeStaticFixedSizedArray_uint8_4(msg.ceAxCIndex, buf, off + 16);
    encodeStaticFixedSizedArray_uint16_2(msg.patternId, buf, off + 20);
    l2l1_putF32(msg.powerOffsetSrsToPuschPerAllocatedRe, buf, off + 24);
    l2l1_putU8(msg.puschTransCoherence, buf, off + 28);
}
...
function UlDatadecodesrsReceiveReqSubcell_t(offset) {
    ...
    result.srsBmStruct = UlDatadecodesrsBmStruct_t(offset + 36);
...
function UlDataencodesrsReceiveReqSubcell_t(msg, buf, off) {
    ...
    UlDataencodesrsBmStruct_t(msg.srsBmStruct, buf, off + 36);
}
...
function l2l1_decode_msg(l2l1) {
    ...
    case 0x024B: // UlData::SrsReceiveRespBmPs_t
        ...
        break;
    case 0x0250: // UlData::SrsReceiveReq_t
    ...
    case 0xE200: // UlData::PuschReceiveRespHarqD_t
        ...
        break;
    case 0xE201: // UlData::PuschReceiveReq_t
        result = UlDatadecodePuschReceiveReq_t(0);
        break;
    case 0xE202: // UlData::PucchReceiveReq_t
        result = UlDatadecodePucchReceiveReq_t(0);
        break;
    case 0xE203: // UlData::PucchReceiveRespPs_t
        result = UlDatadecodePucchReceiveRespPs_t(0);
        break;
    case 0xE204: // UlData::PuschReceiveRespPs_t
...
packetPropToStrMap["l2l1.message"] = {
    ...
    0x0250: "UlData::SrsReceiveReq",
    0xE200: "UlData::PuschReceiveRespHarqD",
    0xE201: "UlData::PuschReceiveReq",
    0xE202: "UlData::PucchReceiveReq",
    0xE203: "UlData::PucchReceiveRespPs",
    0xE204: "UlData::PuschReceiveRespPs",
};
