...
function DlDatadecodePdcchSendReq_t(offset) {
    ...
    result.dciInfo = decodeDynamicVariableSizedArray_DciInfo_24(offset + 8);
...
function DlDataencodePdcchSendReq_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_DciInfo_24(msg.dciInfo, buf, off + 8);
}
...
function UlDatadecodepuschReceiveRespPsSubcell_t(offset) {
    ...
    result.grants = decodeDynamicVariableSizedArray_UePuschReceiveRespPs_t_24(offset + 24);
...
function UlDataencodepuschReceiveRespPsSubcell_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_UePuschReceiveRespPs_t_24(msg.grants, buf, off + 24);
}
function UlDatadecodeUePuschReceiveRespPs_t(offset) {
    let result = {};
...
/*    if (!(result.puschTransformPrecoderFlag === [object Object] || result.puschTransformPrecoderFlag === [object Object]))
    ...
    result.numOfDmrsCdmGroupWithoutData = l2l1_getU8(offset + 120);
    result.l2CtxtAnMgt = decodeStaticFixedSizedArray_uint8_8(offset + 124);
    result.eCpriSectionId = l2l1_getU16(offset + 132);
    result.longTermCfoMetricOfAnt = decodeStaticFixedSizedArray_longTermCfoMetric_t_4(offset + 136);
...
function UlDataencodepuschReceiveReqGrant_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.numOfDmrsCdmGroupWithoutData, buf, off + 120);
    encodeStaticFixedSizedArray_uint8_8(msg.l2CtxtAnMgt, buf, off + 124);
    l2l1_putU16(msg.eCpriSectionId, buf, off + 132);
    encodeStaticFixedSizedArray_longTermCfoMetric_t_4(msg.longTermCfoMetricOfAnt, buf, off + 136);
}
function UlDatadecodepuschReceiveReqSubcell_t(offset) {
    ...
    result.msgCountCtrl = l2l1_getU8(offset + 5);
    result.grants = decodeDynamicVariableSizedArray_puschReceiveReqGrant_t_24(offset + 8);
...
function UlDataencodepuschReceiveReqSubcell_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.msgCountCtrl, buf, off + 5);
    encodeDynamicVariableSizedArray_puschReceiveReqGrant_t_24(msg.grants, buf, off + 8);
}
function UlDatadecodepuschReceiveReqGrant_t(offset) {
    let result = {};
...
function UlDatadecodepuschReceiveRespHarqDSubcell_t(offset) {
    ...
    result.subcellId = l2l1_getU8(offset + 0);
    result.grants = decodeDynamicVariableSizedArray_puschReceiveRespHarqDGrants_t_24(offset + 4);

    return result;
}
function UlDataencodepuschReceiveRespHarqDSubcell_t(msg, buf, off) {
    l2l1_putU8(msg.subcellId, buf, off + 0);
    encodeDynamicVariableSizedArray_puschReceiveRespHarqDGrants_t_24(msg.grants, buf, off + 4);
}
...
function UlDatadecodepuschReceiveRespHarqUSubcell_t(offset) {
    ...
    result.subcellId = l2l1_getU8(offset + 0);
    result.grants = decodeDynamicVariableSizedArray_UePuschReceiveRespHarqU_t_24(offset + 4);

    return result;
}
function UlDataencodepuschReceiveRespHarqUSubcell_t(msg, buf, off) {
    l2l1_putU8(msg.subcellId, buf, off + 0);
    encodeDynamicVariableSizedArray_UePuschReceiveRespHarqU_t_24(msg.grants, buf, off + 4);
}
function UlDatadecodeUePuschReceiveRespHarqU_t(offset) {
    let result = {};
...
function UlDatadecodesrsBmCombShiftPairs_t(offset) {
    ...
    result.rnti = decodeDynamicVariableSizedArray_uint16_4(offset + 12);
...
function UlDataencodesrsBmCombShiftPairs_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_uint16_4(msg.rnti, buf, off + 12);
}
...
function l2l1_decode_msg(l2l1) {
    ...
    case 0xE244: // UlData::SrsReceiveRespBmPs_t
        ...
        break;
    case 0xE245: // UlData::PuschReceiveReq_t
...
function encodeDynamicVariableSizedArray_DciInfo_24(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_DciInfo_24(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_UePuschReceiveRespPs_t_24(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_UePuschReceiveRespPs_t_24(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_puschReceiveReqGrant_t_24(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_puschReceiveReqGrant_t_24(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_puschReceiveRespHarqDGrants_t_24(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_puschReceiveRespHarqDGrants_t_24(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_UePuschReceiveRespHarqU_t_24(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_UePuschReceiveRespHarqU_t_24(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
