...
/*    if (!(result.mantissaSize === [object Object] || result.mantissaSize === [object Object]))
    ...
    result.actPrachMultiplexingLevel = l2l1_getU8(offset + 188);
/*    if (!(result.actPrachMultiplexingLevel === [object Object] || result.actPrachMultiplexingLevel === [object Object]))
    ...
    result.actPuschACSIPart2ThrAdj = l2l1_getU8(offset + 189);
    result.pSRSact = l2l1_getU8(offset + 190);
    result.pSRSBwvAct = l2l1_getU8(offset + 191);
...
function UlCellencodeSetupReq_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.actPrachMultiplexingLevel, buf, off + 188);
    l2l1_putU8(msg.actPuschACSIPart2ThrAdj, buf, off + 189);
    l2l1_putU8(msg.pSRSact, buf, off + 190);
    l2l1_putU8(msg.pSRSBwvAct, buf, off + 191);
