...
/*    if (!(result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object]))
...
function UlDatadecodesrsECpriConfigStruct_t(offset) {
    let result = {};
...
function UlDataencodesrsECpriConfigStruct_t(msg, buf, off) {
    l2l1_putU8(msg.numCeAxCIndex, buf, off + 0);
    encodeStaticFixedSizedArray_uint8_4(msg.ceAxCIndex, buf, off + 4);
}
...
/*    if (!(result.numOfSrsPorts === [object Object] || result.numOfSrsPorts === [object Object] || result.numOfSrsPorts === [object Object]))
    ...
    result.patternId = decodeStaticFixedSizedArray_uint16_2(offset + 16);
    result.powerOffsetSrsToPuschPerAllocatedRe = l2l1_getF32(offset + 20);
...
function UlDataencodesrsSuMimoStruct_t(msg, buf, off) {
    ...
    encodeStaticFixedSizedArray_uint16_2(msg.patternId, buf, off + 16);
    l2l1_putF32(msg.powerOffsetSrsToPuschPerAllocatedRe, buf, off + 20);
    l2l1_putU8(msg.puschTransCoherence, buf, off + 24);
}
function UlDatadecodesrsBands_t(offset) {
    let result = {};

    result.eCpriConfigStruct = UlDatadecodesrsECpriConfigStruct_t(offset + 0);
    result.srsSuMimoStruct = UlDatadecodesrsSuMimoStruct_t(offset + 8);

    return result;
}
function UlDataencodesrsBands_t(msg, buf, off) {
    UlDataencodesrsECpriConfigStruct_t(msg.eCpriConfigStruct, buf, off + 0);
...
function UlDatadecodesrsReceiveReqSubcell_t(offset) {
    ...
    result.srsBmStruct = UlDatadecodesrsBmStruct_t(offset + 4);
    result.srsBands = decodeDynamicVariableSizedArray_srsBands_t_8(offset + 20);
...
function UlDataencodesrsReceiveReqSubcell_t(msg, buf, off) {
    ...
    UlDataencodesrsBmStruct_t(msg.srsBmStruct, buf, off + 4);
    encodeDynamicVariableSizedArray_srsBands_t_8(msg.srsBands, buf, off + 20);
}
...
function l2l1_decode_msg(l2l1) {
    ...
    case 0x0131: // DlData::CsiRsSendReq_t
        ...
        break;
    case 0x0132: // DlData::PdcchSendReq_t
    ...
    case 0x024E: // UlData::PucchReceiveRespPs_t
        ...
        break;
    case 0x0241: // UlData::SrsReceiveReq_t
...
function encodeDynamicVariableSizedArray_srsBands_t_8(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        UlDataencodesrsBands_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_srsBands_t_8(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(UlDatadecodesrsBands_t(offset));
        offset += 36;
    }
