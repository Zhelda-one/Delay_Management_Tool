...
/*    if (!(result.pdschPrecodingOption4x4 === [object Object] || result.pdschPrecodingOption4x4 === [object Object] || result.pdschPrecodingOption4x4 === [object Object] || result.pdschPrecodingOption4x4 === [object Object] || result.pdschPrecodingOption4x4 === [object Object] || result.pdschPrecodingOption4x4 === [object Object]))
...
function l2l1_decode_msg(l2l1) {
    ...
    case 0xE101: // DlData::PatternConfigReq_t
        ...
        break;
    case 0xE102: // DlData::PdschSendReq_t
...
function decodeDynamicPackedArray_PdschGrant_16(offset) {
    ...
    for (let i = 0; i < length; i++)
        result.push(DlDatadecodePdschGrant(offset + 1 + arrOffset + i * 88));
    return result;
}
