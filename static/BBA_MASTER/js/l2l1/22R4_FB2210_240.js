...
function UlDatadecodesrsBmCombShiftPairs_t(offset) {
    ...
    result.bmCyclicShift = decodeDynamicVariableSizedArray_srsBmCsInfo_t_4(offset + 4);

    return result;
}
function UlDataencodesrsBmCombShiftPairs_t(msg, buf, off) {
    l2l1_putU8(msg.transmissionCombId, buf, off + 0);
    encodeDynamicVariableSizedArray_srsBmCsInfo_t_4(msg.bmCyclicShift, buf, off + 4);
}
