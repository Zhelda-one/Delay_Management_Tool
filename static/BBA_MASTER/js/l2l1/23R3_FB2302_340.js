...
function UlDatadecodecsiReportStruct_t(offset) {
    ...
    result.numOfWidebandCsiPart2BitsRi0 = l2l1_getU8(offset + 2);
    ...
    result.numOfCsiPart2Subbands = l2l1_getU8(offset + 6);
    result.numOfBitsPerSubbandRi1 = l2l1_getU8(offset + 7);
    result.numOfBitsPerSubbandRi2 = l2l1_getU8(offset + 8);
    result.numOfBitsPerSubbandRi3 = l2l1_getU8(offset + 9);
    result.numOfBitsPerSubbandRi4 = l2l1_getU8(offset + 10);
...
function UlDataencodecsiReportStruct_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.numOfWidebandCsiPart2BitsRi0, buf, off + 2);
    ...
    l2l1_putU8(msg.numOfCsiPart2Subbands, buf, off + 6);
    l2l1_putU8(msg.numOfBitsPerSubbandRi1, buf, off + 7);
    l2l1_putU8(msg.numOfBitsPerSubbandRi2, buf, off + 8);
    l2l1_putU8(msg.numOfBitsPerSubbandRi3, buf, off + 9);
    l2l1_putU8(msg.numOfBitsPerSubbandRi4, buf, off + 10);
}
...
/*    if (!(result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object]))
    ...
    result.csiPart2BetaOffsetUpTo11Bits = l2l1_getU8(offset + 55);
    result.csiPart2BetaOffsetMoreThan11Bits = l2l1_getU8(offset + 56);
    result.numOfUciRes = l2l1_getU16(offset + 58);
    result.csiReportStruct = decodeDynamicVariableSizedArray_csiReportStruct_t_8(offset + 60);
    result.longTermCfoMetric = l1_commondecodelongTermCfoMetric_t(offset + 68);
    result.foeValid = l2l1_getU8(offset + 76);
    result.baseGraph = l2l1_getU8(offset + 77);
/*    if (!(result.baseGraph === [object Object] || result.baseGraph === [object Object]))
        throw new Error(`Value ${result.baseGraph} is out of range for enum 'ldpcBaseGraph_t'`); */
    Object.defineProperty(result, "__enum_baseGraph", {
        enumerable: false,
    ...
    result.numOfCodeBlocks = l2l1_getU8(offset + 78);
    result.codeBlockSize = l2l1_getU16(offset + 80);
    result.numOfFillerBits = l2l1_getU16(offset + 82);
    result.liftSize = l2l1_getU16(offset + 84);
    result.liftSizeSetIndex = l2l1_getU8(offset + 86);
    result.liftSizeColumnIndex = l2l1_getU8(offset + 87);
    result.modulationOrder = l2l1_getU8(offset + 88);
/*    if (!(result.modulationOrder === [object Object] || result.modulationOrder === [object Object] || result.modulationOrder === [object Object] || result.modulationOrder === [object Object] || result.modulationOrder === [object Object]))
        throw new Error(`Value ${result.modulationOrder} is out of range for enum 'modulationOrder_t'`); */
    Object.defineProperty(result, "__enum_modulationOrder", {
        enumerable: false,
    ...
    result.rvIndex = l2l1_getU8(offset + 89);
    result.ncb = l2l1_getU16(offset + 90);
    result.k0divZ = l2l1_getU8(offset + 92);
    result.numOfLayers = l2l1_getU8(offset + 93);
    result.puschTransCoherence = l2l1_getU8(offset + 94);
/*    if (!(result.puschTransCoherence === [object Object] || result.puschTransCoherence === [object Object] || result.puschTransCoherence === [object Object]))
    ...
    result.puschTransformPrecoderFlag = l2l1_getU8(offset + 95);
/*    if (!(result.puschTransformPrecoderFlag === [object Object] || result.puschTransformPrecoderFlag === [object Object]))
    ...
    result.fullPowerPuschPowerScalingRatio = l2l1_getU8(offset + 96);
    result.blerTarget = l2l1_getU8(offset + 97);
/*    if (!(result.blerTarget === [object Object] || result.blerTarget === [object Object]))
    ...
    result.longTermCfoMetricOfAnt = decodeStaticFixedSizedArray_longTermCfoMetric_t_8(offset + 136);
    result.eCpriFcpSectionConfig = UlDatadecodeeCpriFcpSectionConfig_t(offset + 200);
    result.prachPeakMetric = l2l1_getF32(offset + 216);
    result.ext = decodeStaticVariableSizedArray_uint32_2(offset + 220);
    result.pairedUe = l2l1_getU16(offset + 232);
...
function UlDataencodepuschReceiveReqGrant_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.csiPart2BetaOffsetUpTo11Bits, buf, off + 55);
    l2l1_putU8(msg.csiPart2BetaOffsetMoreThan11Bits, buf, off + 56);
    l2l1_putU16(msg.numOfUciRes, buf, off + 58);
    encodeDynamicVariableSizedArray_csiReportStruct_t_8(msg.csiReportStruct, buf, off + 60);
    l1_commonencodelongTermCfoMetric_t(msg.longTermCfoMetric, buf, off + 68);
    l2l1_putU8(msg.foeValid, buf, off + 76);
    l2l1_putU8(msg.baseGraph, buf, off + 77);
    l2l1_putU8(msg.numOfCodeBlocks, buf, off + 78);
    l2l1_putU16(msg.codeBlockSize, buf, off + 80);
    l2l1_putU16(msg.numOfFillerBits, buf, off + 82);
    l2l1_putU16(msg.liftSize, buf, off + 84);
    l2l1_putU8(msg.liftSizeSetIndex, buf, off + 86);
    l2l1_putU8(msg.liftSizeColumnIndex, buf, off + 87);
    l2l1_putU8(msg.modulationOrder, buf, off + 88);
    l2l1_putU8(msg.rvIndex, buf, off + 89);
    l2l1_putU16(msg.ncb, buf, off + 90);
    l2l1_putU8(msg.k0divZ, buf, off + 92);
    l2l1_putU8(msg.numOfLayers, buf, off + 93);
    l2l1_putU8(msg.puschTransCoherence, buf, off + 94);
    l2l1_putU8(msg.puschTransformPrecoderFlag, buf, off + 95);
    l2l1_putU8(msg.fullPowerPuschPowerScalingRatio, buf, off + 96);
    l2l1_putU8(msg.blerTarget, buf, off + 97);
    ...
    encodeStaticFixedSizedArray_longTermCfoMetric_t_8(msg.longTermCfoMetricOfAnt, buf, off + 136);
    UlDataencodeeCpriFcpSectionConfig_t(msg.eCpriFcpSectionConfig, buf, off + 200);
    l2l1_putF32(msg.prachPeakMetric, buf, off + 216);
    encodeStaticVariableSizedArray_uint32_2(msg.ext, buf, off + 220);
    l2l1_putU16(msg.pairedUe, buf, off + 232);
}
