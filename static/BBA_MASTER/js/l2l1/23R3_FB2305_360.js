...
/*    if (!(result.blerTarget === [object Object] || result.blerTarget === [object Object]))
    ...
    result.longTermCfoMetricOfAnt = decodeDynamicVariableSizedArray_longTermCfoMetric_t_8(offset + 144);
    result.eCpriFcpSectionConfig = UlDatadecodeeCpriFcpSectionConfig_t(offset + 152);
    result.prachPeakMetric = l2l1_getF32(offset + 168);
    result.ulRiSelectionThreshold = l2l1_getF32(offset + 172);
    result.pBoost = l2l1_getF32(offset + 176);
    result.ext = decodeStaticVariableSizedArray_uint32_2(offset + 180);
    result.pairedUe = l2l1_getU16(offset + 192);
...
function UlDataencodepuschReceiveReqGrant_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_longTermCfoMetric_t_8(msg.longTermCfoMetricOfAnt, buf, off + 144);
    UlDataencodeeCpriFcpSectionConfig_t(msg.eCpriFcpSectionConfig, buf, off + 152);
    l2l1_putF32(msg.prachPeakMetric, buf, off + 168);
    l2l1_putF32(msg.ulRiSelectionThreshold, buf, off + 172);
    l2l1_putF32(msg.pBoost, buf, off + 176);
    encodeStaticVariableSizedArray_uint32_2(msg.ext, buf, off + 180);
    l2l1_putU16(msg.pairedUe, buf, off + 192);
}
...
/*    if (!(result.modulationType === [object Object] || result.modulationType === [object Object]))
    ...
    result.longTermCfoMetricOfAnt = decodeDynamicVariableSizedArray_longTermCfoMetric_t_8(offset + 68);
    result.eCpriPucchFcpAllocConf = UlDatadecodeeCpriPucchFcpAllocConf_t(offset + 76);
...
function UlDataencodepucchReceiveReqPucchResource_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_longTermCfoMetric_t_8(msg.longTermCfoMetricOfAnt, buf, off + 68);
    UlDataencodeeCpriPucchFcpAllocConf_t(msg.eCpriPucchFcpAllocConf, buf, off + 76);
}
