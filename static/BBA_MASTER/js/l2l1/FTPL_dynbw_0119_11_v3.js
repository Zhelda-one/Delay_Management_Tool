...
function DlDatadecodePdschSendReq_t(offset) {
    ...
    result.sfn = l2l1_getU16(offset + 2);
    result.slot = l2l1_getU8(offset + 4);
    result.bwMultiFactor = l2l1_getU8(offset + 5);
    result.beamWeights = decodeStaticVariableSizedArray_BeamWeight_144(offset + 8);
    result.grants = decodeDynamicPackedArray_PdschGrant_16(offset + 38028);
    result.msgCountCtrl = l2l1_getU8(offset + 38030);
...
function DlDataencodePdschSendReq_t(msg, buf, off) {
    ...
    l2l1_putU16(msg.sfn, buf, off + 2);
    l2l1_putU8(msg.slot, buf, off + 4);
    l2l1_putU8(msg.bwMultiFactor, buf, off + 5);
    encodeStaticVariableSizedArray_BeamWeight_144(msg.beamWeights, buf, off + 8);
    encodeDynamicPackedArray_PdschGrant_16(msg.grants, buf, off + 38028);
    l2l1_putU8(msg.msgCountCtrl, buf, off + 38030);
}
...
function UlDatadecodeSrsReceiveRespBmPs_t(offset) {
    ...
    result.bwvToeBuf = l2l1_getI32(offset + 34972);
...
function UlDataencodeSrsReceiveRespBmPs_t(msg, buf, off) {
    ...
    l2l1_putI32(msg.bwvToeBuf, buf, off + 34972);
}
function UlDatadecodesrsRespBmPsSubbands_t(offset) {
    let result = {};
...
function l2l1_encode_msg(l2l1) {
    ...
    case 0xE115: // DlData::FastAntennaSnapshotReq_t
        ...
        break;
    case 0xE118: // DlData::PdschSendReq_t
        buf.static = new Uint8Array(38032);
    ...
    case 0xE255: // UlData::SrsReceiveReq_t
        ...
        break;
    case 0xE256: // UlData::SrsReceiveRespBmPs_t
        buf.static = new Uint8Array(34976);
