...
/*    if (!(result.dmrsSequenceType === [object Object] || result.dmrsSequenceType === [object Object]))
    ...
    result.numOfBitsOfUciInformation = l2l1_getU8(offset + 40);
    result.srBit = l2l1_getU8(offset + 41);
...
function UlDataencodepucchReceiveRespPsPucchResource_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.numOfBitsOfUciInformation, buf, off + 40);
    l2l1_putU8(msg.srBit, buf, off + 41);
