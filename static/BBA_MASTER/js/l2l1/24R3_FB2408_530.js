...
function DlDataFHdecodeDciInfo(offset) {
    ...
    result.dciIndex = l2l1_getU8(offset + 36);
    result.ceAxCIndex = decodeDynamicVariableSizedArray_uint8_4(offset + 40);
    result.patternId = decodeDynamicVariableSizedArray_uint16_2(offset + 48);
...
function DlDataFHencodeDciInfo(msg, buf, off) {
    ...
    l2l1_putU8(msg.dciIndex, buf, off + 36);
    encodeDynamicVariableSizedArray_uint8_4(msg.ceAxCIndex, buf, off + 40);
    encodeDynamicVariableSizedArray_uint16_2(msg.patternId, buf, off + 48);
}
...
function DlDataFHdecodePdschGrant(offset) {
    ...
    result.unscheduledAreaStartPrb = l2l1_getU16(offset + 92);
    result.unscheduledAreaNumOfPrb = l2l1_getU16(offset + 94);
    result.unscheduledAreaStartSymbol = l2l1_getU8(offset + 96);
    result.unscheduledAreaNumOfSymbols = l2l1_getU8(offset + 97);
    result.symbolRateMatchingPositions = l2l1_getU16(offset + 98);
    result.sinr = l2l1_getF32(offset + 100);
    result.rtBfUeIndex = l2l1_getU16(offset + 104);
...
function DlDataFHencodePdschGrant(msg, buf, off) {
    ...
    l2l1_putU16(msg.unscheduledAreaStartPrb, buf, off + 92);
    l2l1_putU16(msg.unscheduledAreaNumOfPrb, buf, off + 94);
    l2l1_putU8(msg.unscheduledAreaStartSymbol, buf, off + 96);
    l2l1_putU8(msg.unscheduledAreaNumOfSymbols, buf, off + 97);
    l2l1_putU16(msg.symbolRateMatchingPositions, buf, off + 98);
    l2l1_putF32(msg.sinr, buf, off + 100);
    l2l1_putU16(msg.rtBfUeIndex, buf, off + 104);
}
function DlDataFHdecodePdschSendReq_t(offset) {
    ...
    result.bwvDumpGranularityInSubbands = l2l1_getU8(offset + 7);
...
function DlDataFHencodePdschSendReq_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.bwvDumpGranularityInSubbands, buf, off + 7);
}
function DlDataFHdecodeSlotTypeReq_t(offset) {
    let result = {};
    ...
    result.pwrReductionPerSymb_dB = decodeDynamicVariableSizedArray_uint8_14(offset + 8);

    return result;
}
function DlDataFHencodeSlotTypeReq_t(msg, buf, off) {
    l2l1_putU8(msg.subcellId, buf, off + 0);
    l2l1_putU16(msg.sfn, buf, off + 2);
    l2l1_putU8(msg.slot, buf, off + 4);
    l2l1_putU8(msg.slotType, buf, off + 5);
    encodeDynamicVariableSizedArray_uint8_14(msg.pwrReductionPerSymb_dB, buf, off + 8);
}
function DlDataFHdecodeRimRsSendReq_t(offset) {
    let result = {};

    result.sfn = l2l1_getU16(offset + 0);
    result.slot = l2l1_getU8(offset + 2);
    result.subcellId = l2l1_getU8(offset + 3);
    result.rimRsScramblingSequenceInt = l2l1_getU32(offset + 4);
    result.rimRsTransmitPower = l2l1_getI16(offset + 8);
    result.nscID = l2l1_getU16(offset + 10);
    result.startPrb = l2l1_getU16(offset + 12);
    result.numOfPrb = l2l1_getU8(offset + 14);
    result.startSymbol = l2l1_getU8(offset + 15);
    result.streamIndex = decodeDynamicVariableSizedArray_uint8_4(offset + 16);
    result.patternId = decodeDynamicVariableSizedArray_uint16_2(offset + 24);
    result.antStream = l2l1_getU8(offset + 32);
    result.subCarrierOffset = l2l1_getU8(offset + 33);

    return result;
}
function DlDataFHencodeRimRsSendReq_t(msg, buf, off) {
    l2l1_putU16(msg.sfn, buf, off + 0);
    l2l1_putU8(msg.slot, buf, off + 2);
    l2l1_putU8(msg.subcellId, buf, off + 3);
    l2l1_putU32(msg.rimRsScramblingSequenceInt, buf, off + 4);
    l2l1_putI16(msg.rimRsTransmitPower, buf, off + 8);
    l2l1_putU16(msg.nscID, buf, off + 10);
    l2l1_putU16(msg.startPrb, buf, off + 12);
    l2l1_putU8(msg.numOfPrb, buf, off + 14);
    l2l1_putU8(msg.startSymbol, buf, off + 15);
    encodeDynamicVariableSizedArray_uint8_4(msg.streamIndex, buf, off + 16);
    encodeDynamicVariableSizedArray_uint16_2(msg.patternId, buf, off + 24);
    l2l1_putU8(msg.antStream, buf, off + 32);
    l2l1_putU8(msg.subCarrierOffset, buf, off + 33);
}
...
function UlDataFHdecodepuschReceiveReqGrant_t(offset) {
    ...
    result.dmrsSequenceType = l2l1_getU8(offset + 22);
    ...
    result.ueReceiverSize = l2l1_getU8(offset + 73);
...
function UlDataFHencodepuschReceiveReqGrant_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.dmrsSequenceType, buf, off + 22);
    ...
    l2l1_putU8(msg.ueReceiverSize, buf, off + 73);
}
...
function UlDataFHdecodepuschReceiveRespPsGrant_t(offset) {
    ...
    result.suPostCombSinr = decodeDynamicVariableSizedArray_float32_2(offset + 64);
...
function UlDataFHencodepuschReceiveRespPsGrant_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_float32_2(msg.suPostCombSinr, buf, off + 64);
}
...
function UlDataFHdecodesrsSuMimoRu_t(offset) {
    ...
    result.ueReceiverSize = l2l1_getU8(offset + 21);
...
function UlDataFHencodesrsSuMimoRu_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.ueReceiverSize, buf, off + 21);
...
function UlDataFHdecodeSrsBmReceiveReq_t(offset) {
    ...
    result.srsPowerThresholdDl = l2l1_getI16(offset + 6);
    result.totalNumOfSrsSymbols = l2l1_getU8(offset + 8);
    result.totalNumOfSrsBmResources = l2l1_getU16(offset + 10);
...
function UlDataFHencodeSrsBmReceiveReq_t(msg, buf, off) {
    ...
    l2l1_putI16(msg.srsPowerThresholdDl, buf, off + 6);
    l2l1_putU8(msg.totalNumOfSrsSymbols, buf, off + 8);
    l2l1_putU16(msg.totalNumOfSrsBmResources, buf, off + 10);
...
function UlDataFHdecodesrsBmRuResp_t(offset) {
    ...
    result.dtxDl = l2l1_getU8(offset + 33);
...
function UlDataFHencodesrsBmRuResp_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.dtxDl, buf, off + 33);
}
...
function UlDataFHdecodesrsRtBfCyclicShifts_t(offset) {
    let result = {};
...
function UlDataFHencodesrsRtBfCyclicShifts_t(msg, buf, off) {
    l2l1_putU8(msg.transmissionCombId, buf, off + 0);
    l2l1_putU8(msg.cyclicShift, buf, off + 1);
    l2l1_putU8(msg.portIndex, buf, off + 2);
}
function UlDataFHdecodesrsRtBfReceiveReqUes_t(offset) {
    let result = {};

    result.rtBfUeIndex = l2l1_getU16(offset + 0);
    result.rnti = l2l1_getU16(offset + 2);
    result.symbolPosition = l2l1_getU8(offset + 4);
    result.numSrsPorts = l2l1_getU8(offset + 5);
    result.ceOperation = l2l1_getU8(offset + 6);
    result.srsBmSubbandIdLtCoMa = l2l1_getU8(offset + 7);
    result.startPrbltCoMa = l2l1_getU16(offset + 8);
    result.startPrb = l2l1_getU16(offset + 10);
    result.srsResourceIdentity = l2l1_getU8(offset + 12);
    result.srsRtBfCyclicShifts = decodeDynamicVariableSizedArray_srsRtBfCyclicShifts_t_6(offset + 16);

    return result;
}
function UlDataFHencodesrsRtBfReceiveReqUes_t(msg, buf, off) {
    l2l1_putU16(msg.rtBfUeIndex, buf, off + 0);
    l2l1_putU16(msg.rnti, buf, off + 2);
    l2l1_putU8(msg.symbolPosition, buf, off + 4);
    l2l1_putU8(msg.numSrsPorts, buf, off + 5);
    l2l1_putU8(msg.ceOperation, buf, off + 6);
    l2l1_putU8(msg.srsBmSubbandIdLtCoMa, buf, off + 7);
    l2l1_putU16(msg.startPrbltCoMa, buf, off + 8);
    l2l1_putU16(msg.startPrb, buf, off + 10);
    l2l1_putU8(msg.srsResourceIdentity, buf, off + 12);
    encodeDynamicVariableSizedArray_srsRtBfCyclicShifts_t_6(msg.srsRtBfCyclicShifts, buf, off + 16);
}
function UlDataFHdecodeSrsRtBfReceiveReq_t(offset) {
    let result = {};

    result.messageVersion = l2l1_getU32(offset + 0);
    result.sfn = l2l1_getU16(offset + 4);
    result.slot = l2l1_getU8(offset + 6);
    result.subcellId = l2l1_getU8(offset + 7);
    result.totalNumOfUEs = l2l1_getU8(offset + 8);
    result.ceDumpGranularityInSubbands = l2l1_getU8(offset + 9);
    result.srsPowerThreshold = l2l1_getI16(offset + 10);
    result.srsPowerThresholdDl = l2l1_getI16(offset + 12);
    result.srsRtBfReceiveReqUes = decodeDynamicVariableSizedArray_srsRtBfReceiveReqUes_t_16(offset + 16);

    return result;
}
function UlDataFHencodeSrsRtBfReceiveReq_t(msg, buf, off) {
    l2l1_putU32(msg.messageVersion, buf, off + 0);
    l2l1_putU16(msg.sfn, buf, off + 4);
    l2l1_putU8(msg.slot, buf, off + 6);
    l2l1_putU8(msg.subcellId, buf, off + 7);
    l2l1_putU8(msg.totalNumOfUEs, buf, off + 8);
    l2l1_putU8(msg.ceDumpGranularityInSubbands, buf, off + 9);
    l2l1_putI16(msg.srsPowerThreshold, buf, off + 10);
    l2l1_putI16(msg.srsPowerThresholdDl, buf, off + 12);
    encodeDynamicVariableSizedArray_srsRtBfReceiveReqUes_t_16(msg.srsRtBfReceiveReqUes, buf, off + 16);
}
function UlDataFHdecodesrsRtBfReceiveReqUes_t(offset) {
    let result = {};
...
function UlDataFHdecodesrsReceiveRespRtBfPsUes_t(offset) {
    let result = {};

    result.rnti = l2l1_getU16(offset + 0);
    result.rtBfUeIndex = l2l1_getU16(offset + 2);
    result.symbolPosition = l2l1_getU8(offset + 4);
    result.srsResourceIdentity = l2l1_getU8(offset + 5);
    result.timingOffset = l2l1_getI16(offset + 6);
    result.portPower = decodeDynamicVariableSizedArray_float32_4(offset + 8);
    result.sinr = decodeDynamicVariableSizedArray_float32_4(offset + 16);
    result.correlation = decodeDynamicVariableSizedArray_float32_4(offset + 24);
    result.dtx = decodeDynamicVariableSizedArray_uint8_4(offset + 32);
    result.numInterferedBfSubband = decodeDynamicVariableSizedArray_uint16_4(offset + 40);
    result.interferedSrsSubband = decodeDynamicVariableSizedArray_uint8_4(offset + 48);

    return result;
}
function UlDataFHencodesrsReceiveRespRtBfPsUes_t(msg, buf, off) {
    l2l1_putU16(msg.rnti, buf, off + 0);
    l2l1_putU16(msg.rtBfUeIndex, buf, off + 2);
    l2l1_putU8(msg.symbolPosition, buf, off + 4);
    l2l1_putU8(msg.srsResourceIdentity, buf, off + 5);
    l2l1_putI16(msg.timingOffset, buf, off + 6);
    encodeDynamicVariableSizedArray_float32_4(msg.portPower, buf, off + 8);
    encodeDynamicVariableSizedArray_float32_4(msg.sinr, buf, off + 16);
    encodeDynamicVariableSizedArray_float32_4(msg.correlation, buf, off + 24);
    encodeDynamicVariableSizedArray_uint8_4(msg.dtx, buf, off + 32);
    encodeDynamicVariableSizedArray_uint16_4(msg.numInterferedBfSubband, buf, off + 40);
    encodeDynamicVariableSizedArray_uint8_4(msg.interferedSrsSubband, buf, off + 48);
}
function UlDataFHdecodeSrsRtBfReceiveRespPs_t(offset) {
    let result = {};
    ...
    result.subcellId = l2l1_getU8(offset + 7);
    result.totalNumOfUEs = l2l1_getU8(offset + 8);
    result.srsReceiveRespRtBfPsUes = decodeDynamicVariableSizedArray_srsReceiveRespRtBfPsUes_t_16(offset + 12);

    return result;
}
function UlDataFHencodeSrsRtBfReceiveRespPs_t(msg, buf, off) {
    l2l1_putU32(msg.messageVersion, buf, off + 0);
    l2l1_putU16(msg.sfn, buf, off + 4);
    l2l1_putU8(msg.slot, buf, off + 6);
    l2l1_putU8(msg.subcellId, buf, off + 7);
    l2l1_putU8(msg.totalNumOfUEs, buf, off + 8);
    encodeDynamicVariableSizedArray_srsReceiveRespRtBfPsUes_t_16(msg.srsReceiveRespRtBfPsUes, buf, off + 12);
}
function UlDataFHdecodesrsReceiveRespRtBfPsUes_t(offset) {
    let result = {};
...
function UlDataFHdecodefhRimRsSeq_t(offset) {
    let result = {};

    result.detectionResUnits = decodeDynamicVariableSizedArray_uint8_56(offset + 0);
    result.seqInit = l2l1_getU32(offset + 8);
    result.nScid = l2l1_getU16(offset + 12);

    return result;
}
function UlDataFHencodefhRimRsSeq_t(msg, buf, off) {
    encodeDynamicVariableSizedArray_uint8_56(msg.detectionResUnits, buf, off + 0);
    l2l1_putU32(msg.seqInit, buf, off + 8);
    l2l1_putU16(msg.nScid, buf, off + 12);
}
function UlDataFHdecodeblankedRegion_t(offset) {
    let result = {};
...
function UlDataFHencodeblankedRegion_t(msg, buf, off) {
    l2l1_putU16(msg.blankStartPrb, buf, off + 0);
    l2l1_putU16(msg.blankNumOfPrb, buf, off + 2);
}
function UlDataFHdecodeRimReceiveReq_t(offset) {
    let result = {};

    result.sfn = l2l1_getU16(offset + 0);
    result.slot = l2l1_getU8(offset + 2);
    result.subcellId = l2l1_getU8(offset + 3);
    result.rimRssiRequest = l2l1_getU8(offset + 4);
    result.rimRsDetectionRequest = l2l1_getU8(offset + 5);
    result.patternId = l2l1_getU16(offset + 6);
    result.startAntennaIdx = l2l1_getU8(offset + 8);
    result.riStartSymbol = l2l1_getU8(offset + 9);
    result.riNumOfSymbols = l2l1_getU8(offset + 10);
    result.riNumOfPrbPerSubBand = l2l1_getU8(offset + 11);
    result.riStartPrbPerSubBand = decodeDynamicVariableSizedArray_uint16_5(offset + 12);
    result.rimRsStartPrb = decodeDynamicVariableSizedArray_uint16_4(offset + 20);
    result.rimRsSeq = decodeDynamicVariableSizedArray_fhRimRsSeq_t_8(offset + 28);
    result.blankedRegion = decodeDynamicVariableSizedArray_blankedRegion_t_5(offset + 36);
    result.rimRsNumPrb = l2l1_getU8(offset + 44);
    result.rimRsSubCarrierOffset = l2l1_getU8(offset + 45);

    return result;
}
function UlDataFHencodeRimReceiveReq_t(msg, buf, off) {
    l2l1_putU16(msg.sfn, buf, off + 0);
    l2l1_putU8(msg.slot, buf, off + 2);
    l2l1_putU8(msg.subcellId, buf, off + 3);
    l2l1_putU8(msg.rimRssiRequest, buf, off + 4);
    l2l1_putU8(msg.rimRsDetectionRequest, buf, off + 5);
    l2l1_putU16(msg.patternId, buf, off + 6);
    l2l1_putU8(msg.startAntennaIdx, buf, off + 8);
    l2l1_putU8(msg.riStartSymbol, buf, off + 9);
    l2l1_putU8(msg.riNumOfSymbols, buf, off + 10);
    l2l1_putU8(msg.riNumOfPrbPerSubBand, buf, off + 11);
    encodeDynamicVariableSizedArray_uint16_5(msg.riStartPrbPerSubBand, buf, off + 12);
    encodeDynamicVariableSizedArray_uint16_4(msg.rimRsStartPrb, buf, off + 20);
    encodeDynamicVariableSizedArray_fhRimRsSeq_t_8(msg.rimRsSeq, buf, off + 28);
    encodeDynamicVariableSizedArray_blankedRegion_t_5(msg.blankedRegion, buf, off + 36);
    l2l1_putU8(msg.rimRsNumPrb, buf, off + 44);
    l2l1_putU8(msg.rimRsSubCarrierOffset, buf, off + 45);
}
function UlDataFHdecodefhRimRsSeq_t(offset) {
    let result = {};
...
function UlDataFHdecodefhRimRsDetectionReport_t(offset) {
    let result = {};
    ...
    result.symbolIndex = l2l1_getU8(offset + 14);

    return result;
}
function UlDataFHencodefhRimRsDetectionReport_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.symbolIndex, buf, off + 14);
}
function UlDataFHdecodeRimReceiveRespPs_t(offset) {
    let result = {};

    result.sfn = l2l1_getU16(offset + 0);
    result.slot = l2l1_getU8(offset + 2);
    result.subcellId = l2l1_getU8(offset + 3);
    result.rimRssi = decodeDynamicVariableSizedArray_float32_70(offset + 4);
    result.rimRsDetectionReport = decodeDynamicVariableSizedArray_fhRimRsDetectionReport_t_448(offset + 12);

    return result;
}
function UlDataFHencodeRimReceiveRespPs_t(msg, buf, off) {
    l2l1_putU16(msg.sfn, buf, off + 0);
    l2l1_putU8(msg.slot, buf, off + 2);
    l2l1_putU8(msg.subcellId, buf, off + 3);
    encodeDynamicVariableSizedArray_float32_70(msg.rimRssi, buf, off + 4);
    encodeDynamicVariableSizedArray_fhRimRsDetectionReport_t_448(msg.rimRsDetectionReport, buf, off + 12);
}
function UlDataFHdecodefhRimRsDetectionReport_t(offset) {
    let result = {};
...
/*    if (!(result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object]))
...
/*    if (!(result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object]))
    ...
    result.txCorrection = l2l1_getI32(offset + 336);
    result.rxCorrection = l2l1_getI32(offset + 340);
...
function L1CpriencodeConfigureLinksReq_t(msg, buf, off) {
    ...
    l2l1_putI32(msg.txCorrection, buf, off + 336);
    l2l1_putI32(msg.rxCorrection, buf, off + 340);
}
...
/*    if (!(result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object]))
    ...
    result.cpriOffsetInd = l2l1_getU8(offset + 5);
...
function L1CpriencodeSubscribeReq_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.cpriOffsetInd, buf, off + 5);
...
function L1CpridecodeFrameOffsetInd_t(offset) {
    let result = {};
...
/*    if (!(result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object]))
    ...
    result.cpriOffset = l2l1_getU32(offset + 4);

    return result;
}
function L1CpriencodeFrameOffsetInd_t(msg, buf, off) {
    l2l1_putU8(msg.cpriLink, buf, off + 0);
    l2l1_putU32(msg.cpriOffset, buf, off + 4);
}
...
/*    if (!(result.status === [object Object] || result.status === [object Object]))
    ...
    result.cause = l2l1_getU8(offset + 5);
/*    if (!(result.cause === [object Object] || result.cause === [object Object]))
        throw new Error(`Value ${result.cause} is out of range for enum 'poolAddressCause_t'`); */
    Object.defineProperty(result, "__enum_cause", {
        enumerable: false,
        writable: false,
        value: "l1_common_poolAddressCause_t",
    });
    result.dlBbPoolingResourceReconfReqAddress = l2l1_getU32(offset + 8);
...
function DlPoolencodeAddressResp_t(msg, buf, off) {
    l2l1_putU32(msg.l1PoolId, buf, off + 0);
    l2l1_putU8(msg.status, buf, off + 4);
    l2l1_putU8(msg.cause, buf, off + 5);
    l2l1_putU32(msg.dlBbPoolingResourceReconfReqAddress, buf, off + 8);
}
...
/*    if (!(result.status === [object Object] || result.status === [object Object]))
    ...
    result.cause = l2l1_getU8(offset + 2);
/*    if (!(result.cause === [object Object] || result.cause === [object Object] || result.cause === [object Object] || result.cause === [object Object]))
        throw new Error(`Value ${result.cause} is out of range for enum 'cellDeleteCause_t'`); */
    Object.defineProperty(result, "__enum_cause", {
        enumerable: false,
        writable: false,
        value: "l1_common_cellDeleteCause_t",
    });
...
function DlCellencodeDeleteResp_t(msg, buf, off) {
    l2l1_putU8(msg.subcellId, buf, off + 0);
    l2l1_putU8(msg.status, buf, off + 1);
    l2l1_putU8(msg.cause, buf, off + 2);
}
...
/*    if (!(result.status === [object Object] || result.status === [object Object]))
    ...
    result.cause = l2l1_getU8(offset + 2);
/*    if (!(result.cause === [object Object] || result.cause === [object Object] || result.cause === [object Object] || result.cause === [object Object]))
        throw new Error(`Value ${result.cause} is out of range for enum 'dlDataAddressCause_t'`); */
    Object.defineProperty(result, "__enum_cause", {
        enumerable: false,
        writable: false,
        value: "l1_common_dlDataAddressCause_t",
    });
...
/*    if (!(result.rachStatus === [object Object] || result.rachStatus === [object Object] || result.rachStatus === [object Object] || result.rachStatus === [object Object] || result.rachStatus === [object Object]))
    ...
    result.sinr = l2l1_getF32(offset + 104);
    result.rtBfUeIndex = l2l1_getU16(offset + 108);
...
function DlDataencodePdschGrant(msg, buf, off) {
    ...
    l2l1_putF32(msg.sinr, buf, off + 104);
    l2l1_putU16(msg.rtBfUeIndex, buf, off + 108);
}
...
/*    if (!(result.cause === [object Object] || result.cause === [object Object]))
    ...
    result.ulBbPoolingResourceReconfReqAddress = l2l1_getU32(offset + 8);
...
function UlPoolencodeAddressResp_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.status, buf, off + 4);
    l2l1_putU8(msg.cause, buf, off + 5);
    l2l1_putU32(msg.ulBbPoolingResourceReconfReqAddress, buf, off + 8);
}
...
/*    if (!(result.pSRSnumCeAxCId === [object Object] || result.pSRSnumCeAxCId === [object Object] || result.pSRSnumCeAxCId === [object Object] || result.pSRSnumCeAxCId === [object Object] || result.pSRSnumCeAxCId === [object Object]))
...
/*    if (!(result.numberOfColTRX === [object Object] || result.numberOfColTRX === [object Object] || result.numberOfColTRX === [object Object]))
...
function UlCelldecodeSRSconfig_t(offset) {
    ...
    result.srsPosAct = l2l1_getU8(offset + 0);
...
function UlCellencodeSRSconfig_t(msg, buf, off) {
    l2l1_putU8(msg.srsPosAct, buf, off + 0);
...
/*    if (!(result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object]))
    ...
    result.k2 = l2l1_getU8(offset + 21);
...
function l1_commondecodeL1UlAddresses(offset) {
    ...
    result.srsPosReceiveReqAddress = l2l1_getU32(offset + 28);
...
function l1_commonencodeL1UlAddresses(msg, buf, off) {
    ...
    l2l1_putU32(msg.srsPosReceiveReqAddress, buf, off + 28);
}
...
/*    if (!(result.status === [object Object] || result.status === [object Object]))
    ...
    result.cause = l2l1_getU8(offset + 2);
/*    if (!(result.cause === [object Object] || result.cause === [object Object] || result.cause === [object Object] || result.cause === [object Object]))
        throw new Error(`Value ${result.cause} is out of range for enum 'ulDataAddressCause_t'`); */
    Object.defineProperty(result, "__enum_cause", {
        enumerable: false,
        writable: false,
        value: "l1_common_ulDataAddressCause_t",
    });
...
/*    if (!(result.dmrsSequenceType === [object Object] || result.dmrsSequenceType === [object Object]))
    ...
    result.k2 = l2l1_getU8(offset + 55);
...
/*    if (!(result.dmrsSequenceType === [object Object] || result.dmrsSequenceType === [object Object]))
    ...
    result.uciBits = decodeStaticFixedSizedArray_uint8_10(offset + 32);
    result.numOfBitsOfUciInformation = l2l1_getU8(offset + 44);
    result.srBit = l2l1_getU8(offset + 45);
/*    if (!(result.srBit === [object Object] || result.srBit === [object Object] || result.srBit === [object Object]))
    ...
    result.noisePower = l2l1_getF32(offset + 48);
    result.rssi = l2l1_getF32(offset + 52);
    result.dtxMetric = l2l1_getU32(offset + 56);
    result.dtxThreshold = l2l1_getU32(offset + 60);
    result.shortTermCfoMetric = l1_commondecodeshortTermCfoMetric_t(offset + 64);
    result.extendedParameters = decodeDynamicVariableSizedArray_extendedParameters_t_1(offset + 72);
...
function UlDataencodepucchReceiveRespPsPucchResource_t(msg, buf, off) {
    ...
    encodeStaticFixedSizedArray_uint8_10(msg.uciBits, buf, off + 32);
    l2l1_putU8(msg.numOfBitsOfUciInformation, buf, off + 44);
    l2l1_putU8(msg.srBit, buf, off + 45);
    l2l1_putF32(msg.noisePower, buf, off + 48);
    l2l1_putF32(msg.rssi, buf, off + 52);
    l2l1_putU32(msg.dtxMetric, buf, off + 56);
    l2l1_putU32(msg.dtxThreshold, buf, off + 60);
    l1_commonencodeshortTermCfoMetric_t(msg.shortTermCfoMetric, buf, off + 64);
    encodeDynamicVariableSizedArray_extendedParameters_t_1(msg.extendedParameters, buf, off + 72);
}
...
function UlDatadecodesrsReceiveReqUes_t(offset) {
    ...
    result.freqDomainShift = l2l1_getU16(offset + 8);
    result.cyclicShift = l2l1_getU8(offset + 10);
    result.patternId = decodeStaticFixedSizedArray_uint16_8(offset + 12);
    result.eCpriSectionId = l2l1_getU16(offset + 28);
    result.numOfSrsPorts = l2l1_getU8(offset + 30);
/*    if (!(result.numOfSrsPorts === [object Object] || result.numOfSrsPorts === [object Object] || result.numOfSrsPorts === [object Object]))
    ...
    result.ueReceiverSize = l2l1_getU8(offset + 31);
    result.startPrb = l2l1_getU16(offset + 32);
    result.puschTransCoherence = l2l1_getU8(offset + 34);
/*    if (!(result.puschTransCoherence === [object Object] || result.puschTransCoherence === [object Object] || result.puschTransCoherence === [object Object]))
        throw new Error(`Value ${result.puschTransCoherence} is out of range for enum 'puschTransCoherence_t'`); */
    Object.defineProperty(result, "__enum_puschTransCoherence", {
    ...
    result.fullPowerPuschPowerScalingRatio = l2l1_getU8(offset + 35);
    result.powerOffsetSrsToPuschPerAllocatedRe = l2l1_getF32(offset + 36);
    result.ulRiSelectionThreshold = l2l1_getF32(offset + 40);
    result.ueType = l2l1_getU8(offset + 44);
    result.numCeAxCIndex = l2l1_getU8(offset + 45);
/*    if (!(result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object]))
        throw new Error(`Value ${result.numCeAxCIndex} is out of range for enum 'numCeAxC_t'`); */
    Object.defineProperty(result, "__enum_numCeAxCIndex", {
        enumerable: false,
    ...
    result.ceAxCIndex = decodeStaticFixedSizedArray_uint8_8(offset + 48);
...
function UlDataencodesrsReceiveReqUes_t(msg, buf, off) {
    ...
    l2l1_putU16(msg.freqDomainShift, buf, off + 8);
    l2l1_putU8(msg.cyclicShift, buf, off + 10);
    encodeStaticFixedSizedArray_uint16_8(msg.patternId, buf, off + 12);
    l2l1_putU16(msg.eCpriSectionId, buf, off + 28);
    l2l1_putU8(msg.numOfSrsPorts, buf, off + 30);
    l2l1_putU8(msg.ueReceiverSize, buf, off + 31);
    l2l1_putU16(msg.startPrb, buf, off + 32);
    l2l1_putU8(msg.puschTransCoherence, buf, off + 34);
    l2l1_putU8(msg.fullPowerPuschPowerScalingRatio, buf, off + 35);
    l2l1_putF32(msg.powerOffsetSrsToPuschPerAllocatedRe, buf, off + 36);
    l2l1_putF32(msg.ulRiSelectionThreshold, buf, off + 40);
    l2l1_putU8(msg.ueType, buf, off + 44);
    l2l1_putU8(msg.numCeAxCIndex, buf, off + 45);
    encodeStaticFixedSizedArray_uint8_8(msg.ceAxCIndex, buf, off + 48);
}
...
function UlDatadecodesrsBmStruct_t(offset) {
    ...
    result.numSrsSymbols = l2l1_getU8(offset + 0);
...
function UlDataencodesrsBmStruct_t(msg, buf, off) {
    l2l1_putU8(msg.numSrsSymbols, buf, off + 0);
...
function UlDatadecodesrsRtBfCyclicShifts_t(offset) {
    let result = {};
...
function UlDataencodesrsRtBfCyclicShifts_t(msg, buf, off) {
    l2l1_putU8(msg.transmissionCombId, buf, off + 0);
    l2l1_putU8(msg.cyclicShift, buf, off + 1);
    l2l1_putU8(msg.portIndex, buf, off + 2);
}
function UlDatadecodesrsRtBfReceiveReqUes_t(offset) {
    let result = {};
...
function UlDataencodesrsRtBfReceiveReqUes_t(msg, buf, off) {
    l2l1_putU16(msg.rtBfUeIndex, buf, off + 0);
    l2l1_putU16(msg.rnti, buf, off + 2);
    l2l1_putU8(msg.symbolPosition, buf, off + 4);
    l2l1_putU8(msg.numSrsPorts, buf, off + 5);
...
function UlDatadecodesrsRtBfStruct_t(offset) {
    let result = {};

    result.ceDumpGranularityInSubbands = l2l1_getU8(offset + 0);
    result.srsRtBfReceiveReqUes = decodeDynamicVariableSizedArray_srsRtBfReceiveReqUes_t_16(offset + 4);

    return result;
}
function UlDataencodesrsRtBfStruct_t(msg, buf, off) {
    l2l1_putU8(msg.ceDumpGranularityInSubbands, buf, off + 0);
    encodeDynamicVariableSizedArray_srsRtBfReceiveReqUes_t_16(msg.srsRtBfReceiveReqUes, buf, off + 4);
}
function UlDatadecodesrsReceiveReqSubcell_t(offset) {
    ...
    result.srsRtBfEnable = l2l1_getU8(offset + 4);
    ...
    result.srsRtBfStruct = UlDatadecodesrsRtBfStruct_t(offset + 52);
    result.srsPowerThreshold = l2l1_getI16(offset + 64);
    result.srsPowerThresholdDl = l2l1_getI16(offset + 66);
...
function UlDataencodesrsReceiveReqSubcell_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.srsRtBfEnable, buf, off + 4);
    ...
    UlDataencodesrsRtBfStruct_t(msg.srsRtBfStruct, buf, off + 52);
    l2l1_putI16(msg.srsPowerThreshold, buf, off + 64);
    l2l1_putI16(msg.srsPowerThresholdDl, buf, off + 66);
}
...
/*    if (!(result.dtx === [object Object] || result.dtx === [object Object] || result.dtx === [object Object] || result.dtx === [object Object]))
    ...
    result.shortTermTaMetric = l2l1_getI16(offset + 26);
    result.shortTermTaPeakAmp = l2l1_getF32(offset + 28);
    result.srsAntMeas = decodeDynamicVariableSizedArray_srsAntMeas_t_16(offset + 32);
...
function UlDataencodesrsReceiveRespPsUes_t(msg, buf, off) {
    ...
    l2l1_putI16(msg.shortTermTaMetric, buf, off + 26);
    l2l1_putF32(msg.shortTermTaPeakAmp, buf, off + 28);
    encodeDynamicVariableSizedArray_srsAntMeas_t_16(msg.srsAntMeas, buf, off + 32);
}
...
/*    if (!(result.dtx === [object Object] || result.dtx === [object Object] || result.dtx === [object Object] || result.dtx === [object Object]))
    ...
    result.dtxDl = l2l1_getU8(offset + 33);
/*    if (!(result.dtxDl === [object Object] || result.dtxDl === [object Object] || result.dtxDl === [object Object] || result.dtxDl === [object Object]))
        throw new Error(`Value ${result.dtxDl} is out of range for enum 'dtx_t'`); */
    Object.defineProperty(result, "__enum_dtxDl", {
        enumerable: false,
        writable: false,
        value: "l1_common_dtx_t",
    });
...
function UlDatadecodePuschReceiveReqL1ru_t(offset) {
    ...
    result.slot = l2l1_getU8(offset + 2);
    result.subcellId = l2l1_getU8(offset + 3);
    result.postSuSinr = l2l1_getU8(offset + 4);
    result.grants = decodeDynamicVariableSizedArray_puschReceiveReqGrantL1ru_t_16(offset + 8);
...
function UlDataencodePuschReceiveReqL1ru_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.slot, buf, off + 2);
    l2l1_putU8(msg.subcellId, buf, off + 3);
    l2l1_putU8(msg.postSuSinr, buf, off + 4);
    encodeDynamicVariableSizedArray_puschReceiveReqGrantL1ru_t_16(msg.grants, buf, off + 8);
}
function UlDatadecodepuschReceiveReqGrantL1ru_t(offset) {
    let result = {};
...
function UlDatadecodesrsPosReportRequest_t(offset) {
    let result = {};

    result.rnti = l2l1_getU16(offset + 0);
    result.sequenceId = l2l1_getU16(offset + 2);
    result.startPrb = l2l1_getU16(offset + 4);
    result.numOfPrb = l2l1_getU16(offset + 6);
    result.symbolPosition = l2l1_getU8(offset + 8);
...
/*    if (!(result.transmissionComb === [object Object] || result.transmissionComb === [object Object]))
    ...
    result.cyclicShift = l2l1_getU8(offset + 11);
    result.numOfSrsPorts = l2l1_getU8(offset + 12);
/*    if (!(result.numOfSrsPorts === [object Object] || result.numOfSrsPorts === [object Object] || result.numOfSrsPorts === [object Object]))
        throw new Error(`Value ${result.numOfSrsPorts} is out of range for enum 'numOfSrsTxAntennaPorts_t'`); */
    Object.defineProperty(result, "__enum_numOfSrsPorts", {
        enumerable: false,
    ...
    result.measurements = l2l1_getU8(offset + 13);

    return result;
}
function UlDataencodesrsPosReportRequest_t(msg, buf, off) {
    l2l1_putU16(msg.rnti, buf, off + 0);
    l2l1_putU16(msg.sequenceId, buf, off + 2);
    l2l1_putU16(msg.startPrb, buf, off + 4);
    l2l1_putU16(msg.numOfPrb, buf, off + 6);
    l2l1_putU8(msg.symbolPosition, buf, off + 8);
    l2l1_putU8(msg.transmissionComb, buf, off + 9);
    l2l1_putU8(msg.transmissionCombId, buf, off + 10);
    l2l1_putU8(msg.cyclicShift, buf, off + 11);
    l2l1_putU8(msg.numOfSrsPorts, buf, off + 12);
    l2l1_putU8(msg.measurements, buf, off + 13);
}
function UlDatadecodeSrsPosReceiveReq_t(offset) {
    let result = {};

    result.srsReceiveRespPosClientAddress = l2l1_getU32(offset + 0);
    result.sfn = l2l1_getU16(offset + 4);
    result.slot = l2l1_getU8(offset + 6);
    result.subcellId = l2l1_getU8(offset + 7);
    result.srsPosReportRequests = decodeDynamicVariableSizedArray_srsPosReportRequest_t_8(offset + 8);

    return result;
}
function UlDataencodeSrsPosReceiveReq_t(msg, buf, off) {
    l2l1_putU32(msg.srsReceiveRespPosClientAddress, buf, off + 0);
    l2l1_putU16(msg.sfn, buf, off + 4);
    l2l1_putU8(msg.slot, buf, off + 6);
    l2l1_putU8(msg.subcellId, buf, off + 7);
    encodeDynamicVariableSizedArray_srsPosReportRequest_t_8(msg.srsPosReportRequests, buf, off + 8);
}
function UlDatadecodesrsPosReportRequest_t(offset) {
    let result = {};
...
function UlDatadecodesrsPosReport_t(offset) {
    let result = {};
...
/*    if (!(result.result === [object Object] || result.result === [object Object]))
        throw new Error(`Value ${result.result} is out of range for enum 'srsPosResult_t'`); */
    Object.defineProperty(result, "__enum_result", {
        enumerable: false,
        writable: false,
        value: "l1_common_srsPosResult_t",
    });
    result.timeOffsetPos = l2l1_getF32(offset + 8);
    result.rsrp = l2l1_getF32(offset + 12);

    return result;
}
function UlDataencodesrsPosReport_t(msg, buf, off) {
    l2l1_putU16(msg.rnti, buf, off + 0);
    l2l1_putU16(msg.sequenceId, buf, off + 2);
    l2l1_putU8(msg.symbolPosition, buf, off + 4);
    l2l1_putU8(msg.result, buf, off + 5);
    l2l1_putF32(msg.timeOffsetPos, buf, off + 8);
    l2l1_putF32(msg.rsrp, buf, off + 12);
}
function UlDatadecodeSrsPosReceiveRespPs_t(offset) {
    let result = {};

    result.sfn = l2l1_getU16(offset + 0);
    result.slot = l2l1_getU8(offset + 2);
    result.subcellId = l2l1_getU8(offset + 3);
    result.srsPosReports = decodeDynamicVariableSizedArray_srsPosReport_t_8(offset + 4);

    return result;
}
function UlDataencodeSrsPosReceiveRespPs_t(msg, buf, off) {
    l2l1_putU16(msg.sfn, buf, off + 0);
    l2l1_putU8(msg.slot, buf, off + 2);
    l2l1_putU8(msg.subcellId, buf, off + 3);
    encodeDynamicVariableSizedArray_srsPosReport_t_8(msg.srsPosReports, buf, off + 4);
}
function UlDatadecodesrsPosReport_t(offset) {
    let result = {};
...
function UlDatadecodesrsReceiveRespRtBfPsUes_t(offset) {
    let result = {};
...
function UlDataencodesrsReceiveRespRtBfPsUes_t(msg, buf, off) {
    l2l1_putU16(msg.rnti, buf, off + 0);
    l2l1_putU16(msg.rtBfUeIndex, buf, off + 2);
    l2l1_putU8(msg.symbolPosition, buf, off + 4);
    l2l1_putU8(msg.srsResourceIdentity, buf, off + 5);
...
function UlDatadecodeSrsReceiveRespRtBfPs_t(offset) {
    let result = {};

    result.sfn = l2l1_getU16(offset + 0);
    result.slot = l2l1_getU8(offset + 2);
    result.subcellId = l2l1_getU8(offset + 3);
    result.srsReceiveRespRtBfPsUes = decodeDynamicVariableSizedArray_srsReceiveRespRtBfPsUes_t_16(offset + 4);

    return result;
}
function UlDataencodeSrsReceiveRespRtBfPs_t(msg, buf, off) {
    l2l1_putU16(msg.sfn, buf, off + 0);
    l2l1_putU8(msg.slot, buf, off + 2);
    l2l1_putU8(msg.subcellId, buf, off + 3);
    encodeDynamicVariableSizedArray_srsReceiveRespRtBfPsUes_t_16(msg.srsReceiveRespRtBfPsUes, buf, off + 4);
}
function UlDatadecodesrsReceiveRespRtBfPsUes_t(offset) {
    let result = {};
...
function l2l1_decode_msg(l2l1) {
    ...
    case 0xE128: // DlDataFH::PdschSendReq_t
        ...
        break;
    case 0xE12B: // DlDataFH::SlotTypeReq_t
        result = DlDataFHdecodeSlotTypeReq_t(0);
        break;
    case 0xE12C: // DlDataFH::RimRsSendReq_t
        result = DlDataFHdecodeRimRsSendReq_t(0);
        break;
    ...
    case 0xE268: // UlDataFH::SrsBmReceiveRespPs_t
        ...
        break;
    case 0xE26C: // UlDataFH::SrsRtBfReceiveReq_t
        result = UlDataFHdecodeSrsRtBfReceiveReq_t(0);
        break;
    case 0xE26D: // UlDataFH::SrsRtBfReceiveRespPs_t
        result = UlDataFHdecodeSrsRtBfReceiveRespPs_t(0);
        break;
    case 0xE26E: // UlDataFH::RimReceiveReq_t
        result = UlDataFHdecodeRimReceiveReq_t(0);
        break;
    case 0xE26F: // UlDataFH::RimReceiveRespPs_t
        result = UlDataFHdecodeRimReceiveRespPs_t(0);
        break;
    ...
    case 0xe338: // L1Cpri::CpriPortEthernetPointerInd_t
        ...
        break;
    case 0xe339: // L1Cpri::FrameOffsetInd_t
        result = L1CpridecodeFrameOffsetInd_t(0);
        break;
    ...
    case 0xE266: // UlData::PrachReceiveInd_t
        result = UlDatadecodePrachReceiveInd_t(0);
        break;
    case 0xE269: // UlData::SrsPosReceiveReq_t
        result = UlDatadecodeSrsPosReceiveReq_t(0);
        break;
    case 0xE26A: // UlData::SrsPosReceiveRespPs_t
        result = UlDatadecodeSrsPosReceiveRespPs_t(0);
        break;
    case 0xE26B: // UlData::SrsReceiveRespRtBfPs_t
        result = UlDatadecodeSrsReceiveRespRtBfPs_t(0);
        break;
...
function l2l1_encode_msg(l2l1) {
    ...
    case 0xE12B: // DlDataFH::SlotTypeReq_t
        buf.static = new Uint8Array(16);
        DlDataFHencodeSlotTypeReq_t(l2l1, buf, 0);
        break;
    case 0xE12C: // DlDataFH::RimRsSendReq_t
        buf.static = new Uint8Array(36);
        DlDataFHencodeRimRsSendReq_t(l2l1, buf, 0);
        break;
    case 0xE25F: // UlDataFH::PuschReceiveReq_t
        buf.static = new Uint8Array(16);
    ...
    case 0xE26C: // UlDataFH::SrsRtBfReceiveReq_t
        ...
        UlDataFHencodeSrsRtBfReceiveReq_t(l2l1, buf, 0);
        break;
    case 0xE26D: // UlDataFH::SrsRtBfReceiveRespPs_t
        buf.static = new Uint8Array(20);
        UlDataFHencodeSrsRtBfReceiveRespPs_t(l2l1, buf, 0);
        break;
    case 0xE26E: // UlDataFH::RimReceiveReq_t
        buf.static = new Uint8Array(48);
        UlDataFHencodeRimReceiveReq_t(l2l1, buf, 0);
        break;
    case 0xE26F: // UlDataFH::RimReceiveRespPs_t
        buf.static = new Uint8Array(20);
        UlDataFHencodeRimReceiveRespPs_t(l2l1, buf, 0);
        break;
    case 0xe3f0: // L1Config::SwConfigurationReq_t
        buf.static = new Uint8Array(16);
    ...
    case 0xe339: // L1Cpri::FrameOffsetInd_t
        buf.static = new Uint8Array(8);
        L1CpriencodeFrameOffsetInd_t(l2l1, buf, 0);
        break;
    case 0xE11C: // DlPool::AddressReq_t
        buf.static = new Uint8Array(4);
    ...
    case 0xE269: // UlData::SrsPosReceiveReq_t
        buf.static = new Uint8Array(16);
        UlDataencodeSrsPosReceiveReq_t(l2l1, buf, 0);
        break;
    case 0xE26A: // UlData::SrsPosReceiveRespPs_t
        buf.static = new Uint8Array(12);
        UlDataencodeSrsPosReceiveRespPs_t(l2l1, buf, 0);
        break;
    case 0xE26B: // UlData::SrsReceiveRespRtBfPs_t
        buf.static = new Uint8Array(12);
        UlDataencodeSrsReceiveRespRtBfPs_t(l2l1, buf, 0);
        break;
    case 0xE387: // L1Fcp::DlUlChannelsReq_t
        buf.static = new Uint8Array(28);
...
function encodeStaticFixedSizedArray_uint8_10(arr, buf, off) {
    for (let i = 0; i < 10; i++)
        l2l1_putU8(arr[i], buf, off + i * 1);
}
function decodeStaticFixedSizedArray_uint8_10(offset) {
    const result = [];
    for (let i = 0; i < 10; i++)
        result.push(l2l1_getU8(offset + i * 1));
    return result;
...
function encodeDynamicVariableSizedArray_uint8_14(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_uint8_14(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_uint8_56(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_uint8_56(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_uint16_5(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_uint16_5(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_float32_70(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_float32_70(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_srsRtBfCyclicShifts_t_6(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        UlDataFHencodesrsRtBfCyclicShifts_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_srsRtBfCyclicShifts_t_6(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(UlDataFHdecodesrsRtBfCyclicShifts_t(offset));
        offset += 3;
    }

    return result;
}
function encodeDynamicVariableSizedArray_srsRtBfReceiveReqUes_t_16(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        UlDataFHencodesrsRtBfReceiveReqUes_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_srsRtBfReceiveReqUes_t_16(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(UlDataFHdecodesrsRtBfReceiveReqUes_t(offset));
        offset += 24;
    }

    return result;
}
function encodeDynamicVariableSizedArray_srsReceiveRespRtBfPsUes_t_16(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        UlDataFHencodesrsReceiveRespRtBfPsUes_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_srsReceiveRespRtBfPsUes_t_16(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(UlDataFHdecodesrsReceiveRespRtBfPsUes_t(offset));
        offset += 56;
    }

    return result;
}
function encodeDynamicVariableSizedArray_fhRimRsSeq_t_8(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        UlDataFHencodefhRimRsSeq_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_fhRimRsSeq_t_8(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(UlDataFHdecodefhRimRsSeq_t(offset));
        offset += 16;
    }
...
function encodeDynamicVariableSizedArray_blankedRegion_t_5(arr, buf, off) {
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        UlDataFHencodeblankedRegion_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_blankedRegion_t_5(offset) {
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(UlDataFHdecodeblankedRegion_t(offset));
        offset += 4;
    }

    return result;
}
function encodeDynamicVariableSizedArray_fhRimRsDetectionReport_t_448(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        UlDataFHencodefhRimRsDetectionReport_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_fhRimRsDetectionReport_t_448(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(UlDataFHdecodefhRimRsDetectionReport_t(offset));
        offset += 16;
    }
...
function encodeDynamicVariableSizedArray_srsRtBfCyclicShifts_t_6(arr, buf, off) {
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        UlDataencodesrsRtBfCyclicShifts_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_srsRtBfCyclicShifts_t_6(offset) {
    const arrayOff = l2l1_getU32(offset);
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(UlDatadecodesrsRtBfCyclicShifts_t(offset));
        offset += 3;
    }
...
function encodeDynamicVariableSizedArray_srsRtBfReceiveReqUes_t_16(arr, buf, off) {
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        UlDataencodesrsRtBfReceiveReqUes_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_srsRtBfReceiveReqUes_t_16(offset) {
    const arrayOff = l2l1_getU32(offset);
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(UlDatadecodesrsRtBfReceiveReqUes_t(offset));
        offset += 24;
    }
...
function encodeDynamicVariableSizedArray_srsAntMeas_t_16(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_srsAntMeas_t_16(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_srsPosReportRequest_t_8(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        UlDataencodesrsPosReportRequest_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_srsPosReportRequest_t_8(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(UlDatadecodesrsPosReportRequest_t(offset));
        offset += 14;
    }

    return result;
}
function encodeDynamicVariableSizedArray_srsPosReport_t_8(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        UlDataencodesrsPosReport_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_srsPosReport_t_8(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(UlDatadecodesrsPosReport_t(offset));
        offset += 16;
    }
...
function encodeDynamicVariableSizedArray_srsReceiveRespRtBfPsUes_t_16(arr, buf, off) {
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        UlDataencodesrsReceiveRespRtBfPsUes_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_srsReceiveRespRtBfPsUes_t_16(offset) {
    const arrayOff = l2l1_getU32(offset);
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(UlDatadecodesrsReceiveRespRtBfPsUes_t(offset));
        offset += 56;
    }
...
function decodeDynamicPackedArray_PdschGrant_16(offset) {
    ...
    for (let i = 0; i < length; i++)
        result.push(DlDataFHdecodePdschGrant(offset + 1 + arrOffset + i * 108));
    return result;
}
function encodeDynamicPackedArray_PdschGrant_16(arr, buf, off) {
    l2l1_putU8(arr.length, buf, off);
...
packetEnumMap = {
    ...
    l1_common_cellDeleteCause_t: {
        0: "cellDeleteCause::No_Error",
        1: "cellDeleteCause::Invalid_Subcell_Id",
        2: "cellDeleteCause::Subcell_Not_Exist",
        3: "cellDeleteCause::Internal_Error",
    },
    l1_common_ulDataAddressCause_t: {
        0: "ulDataAddressCause::No_Error",
        1: "ulDataAddressCause::Invalid_Subcell_Id",
        2: "ulDataAddressCause::Subcell_Not_Exist",
        3: "ulDataAddressCause::Ul_Startup_Incomplete",
    },
    l1_common_dlDataAddressCause_t: {
        0: "dlDataAddressCause::No_Error",
        1: "dlDataAddressCause::Invalid_Subcell_Id",
        2: "dlDataAddressCause::Subcell_Not_Exist",
        3: "dlDataAddressCause::Dl_Startup_Incomplete",
    },
    l1_common_poolAddressCause_t: {
        0: "poolAddressCause::No_Error",
        1: "poolAddressCause::Invalid_Pool_Id",
    },
    ...
    l1_common_SubcellType: {
        ...
        9: "SubcellType::C8_4",
        10: "SubcellType::C8_8",
        11: "SubcellType::C16_2",
        12: "SubcellType::C16_4",
        13: "SubcellType::C16_8",
    },
    ...
    l1_common_numberOfColTRX_t: {
        2: "numberOfColTRX::numberOfColTRX_2",
    ...
    l1_common_pSRSnumCeAxCId_t: {
        ...
        4: "pSRSnumCeAxCId::value4",
        8: "pSRSnumCeAxCId::value5",
    },
    ...
    l1_common_srsPosResult_t: {
        0: "srsPosResult::OK",
        1: "srsPosResult::SRS_DTX",
    },
    L1Fcp_DataDirection: {
