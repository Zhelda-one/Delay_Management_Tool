...
/*    if (!(result.puschTransCoherence === [object Object] || result.puschTransCoherence === [object Object] || result.puschTransCoherence === [object Object]))
    ...
    result.legacySRS = l2l1_getU8(offset + 36);
...
function UlDataencodesrsReceiveReqUes_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.legacySRS, buf, off + 36);
...
/*    if (!(result.dtx === [object Object] || result.dtx === [object Object] || result.dtx === [object Object] || result.dtx === [object Object]))
    ...
    result.srsAntMeas = decodeDynamicVariableSizedArray_srsAntMeas_t_8(offset + 36);
...
function UlDataencodesrsReceiveRespPsUes_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_srsAntMeas_t_8(msg.srsAntMeas, buf, off + 36);
}
...
/*    if (!(result.result === [object Object] || result.result === [object Object] || result.result === [object Object]))
    ...
    result.portPowerCsiRsSubband = decodeStaticFixedSizedArray_float32_4(offset + 24);
    result.timingOffset = l2l1_getI16(offset + 40);
    result.numBwvPerSubband = l2l1_getU8(offset + 42);
    result.numSubband = l2l1_getU16(offset + 44);
    result.startPatternId = l2l1_getU16(offset + 46);
...
function UlDataencodesrsBwvReport_t(msg, buf, off) {
    ...
    encodeStaticFixedSizedArray_float32_4(msg.portPowerCsiRsSubband, buf, off + 24);
    l2l1_putI16(msg.timingOffset, buf, off + 40);
    l2l1_putU8(msg.numBwvPerSubband, buf, off + 42);
    l2l1_putU16(msg.numSubband, buf, off + 44);
    l2l1_putU16(msg.startPatternId, buf, off + 46);
}
