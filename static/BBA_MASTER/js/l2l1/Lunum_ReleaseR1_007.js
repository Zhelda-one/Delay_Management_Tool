...
function LTE_LUNUM_DlData_decodedlUlChannelsReq_t(offset) {
    const result = {};

    result.inCellId = l2l1_getU32(offset + 0);
    result.eNbId = l2l1_getU32(offset + 4);
    result.eAxcId = l2l1_getU16(offset + 8);
    result.commonHeader = LTE_LUNUM_DlData_decodedlUlCommonHeader_t(offset + 10);
    result.sections = _decodeArray(offset + 20, LTE_LUNUM_DlData_decodedlUlSection_t, 32);
    result.extensionData = _decodeArray(offset + 28, l2l1_getU8, 1);

    return result;
}
function LTE_LUNUM_DlData_encodedlUlChannelsReq_t(msg, buf, off) {
    l2l1_putU32(msg.inCellId, buf, off + 0);
    l2l1_putU32(msg.eNbId, buf, off + 4);
    l2l1_putU16(msg.eAxcId, buf, off + 8);
    LTE_LUNUM_DlData_encodedlUlCommonHeader_t(msg.commonHeader, buf, off + 10);
    _encodeArray(msg.sections, buf, off + 20, LTE_LUNUM_DlData_encodedlUlSection_t, 32);
    _encodeArray(msg.extensionData, buf, off + 28, l2l1_putU8, 1);
}

function LTE_LUNUM_DlData_decodedlUlCommonHeader_t(offset) {
    const result = {};
...
function LTE_LUNUM_DlData_encodedlUlCommonHeader_t(msg, buf, off) {
...
function LTE_LUNUM_DlData_decodedlUlSection_t(offset) {
    const result = {};
    ...
    result.sectionExtensions = [];
    const sectionExtensionsLength = l2l1_getU32(offset + 16);
    for (let i = 0; i < sectionExtensionsLength && i < 3; i++)
        result.sectionExtensions.push(LTE_LUNUM_DlData_decodesectionExtension_t(offset + 20 + i * 4));

    return result;
}
function LTE_LUNUM_DlData_encodedlUlSection_t(msg, buf, off) {
    ...
    l2l1_putU32(msg.sectionExtensions.length, buf, off + 16);
    for (let i = 0; i < msg.sectionExtensions.length && i < 3; i++)
        LTE_LUNUM_DlData_encodesectionExtension_t(msg.sectionExtensions[i], buf, off + 16 + i * 4);
}

function LTE_LUNUM_DlData_decodesectionExtension_t(offset) {
    const result = {};
...
function LTE_LUNUM_DlData_encodesectionExtension_t(msg, buf, off) {
...
function L1ECpri_decodeMsgRcvCountersInd_t(offset) {
    ...
    for (let i = 0; i < MsgRcvCountersLength && i < 16; i++)
...
function L1ECpri_encodeMsgRcvCountersInd_t(msg, buf, off) {
    ...
    for (let i = 0; i < msg.MsgRcvCounters.length && i < 16; i++)
...
function Cell_decodeDeleteReq_t(offset) {
    const result = {};
...
function Cell_encodeDeleteReq_t(msg, buf, off) {
    l2l1_putU16(msg.physCellId, buf, off + 0);
}

function Cell_decodeDeleteResp_t(offset) {
    const result = {};
...
function Cell_encodeDeleteResp_t(msg, buf, off) {
    l2l1_putU16(msg.physCellId, buf, off + 0);
    l2l1_putU8(msg.status, buf, off + 2);
}

function Cell_decodeSetupReq_t(offset) {
    const result = {};
    ...
    result.eAxcStreams = _decodeArray(offset + 4, lunum_common_decodeeAxcStream_t, 10);

    return result;
}
function Cell_encodeSetupReq_t(msg, buf, off) {
    l2l1_putU16(msg.physCellId, buf, off + 0);
    l2l1_putU8(msg.dlBandwidth, buf, off + 2);
    l2l1_putU8(msg.ulBandwidth, buf, off + 3);
    _encodeArray(msg.eAxcStreams, buf, off + 4, lunum_common_encodeeAxcStream_t, 10);
}

function Cell_decodeSetupResp_t(offset) {
    const result = {};

    result.physCellId = l2l1_getU16(offset + 0);
    result.eAxcStreamsDelayMeasurements = _decodeArray(offset + 4, lunum_common_decodeeAxcStreamDelayMeasurement_t, 12);

    return result;
}
function Cell_encodeSetupResp_t(msg, buf, off) {
    l2l1_putU16(msg.physCellId, buf, off + 0);
    _encodeArray(msg.eAxcStreamsDelayMeasurements, buf, off + 4, lunum_common_encodeeAxcStreamDelayMeasurement_t, 12);
}
...
function l2l1_decode_msg(l2l1) {
    ...
    case 0xd260: // LTE_LUNUM_DlData::dlUlChannelsReq_t
        result = LTE_LUNUM_DlData_decodedlUlChannelsReq_t(0);
        break;
    ...
    case 0xf328: // DlCellUe::SetupReq_t
        ...
        break;
    case 0x0101: // Cell::SetupResp_t
        result = Cell_decodeSetupResp_t(0);
        break;
    case 0x0102: // Cell::DeleteReq_t
        result = Cell_decodeDeleteReq_t(0);
        break;
    case 0x0103: // Cell::DeleteResp_t
        result = Cell_decodeDeleteResp_t(0);
        break;
    case 0x012D: // Cell::SetupReq_t
        result = Cell_decodeSetupReq_t(0);
        break;
...
function l2l1_encode_msg(l2l1) {
    ...
    case 0xd260: // LTE_LUNUM_DlData::dlUlChannelsReq_t
        ...
        LTE_LUNUM_DlData_encodedlUlChannelsReq_t(l2l1, buf, 0);
        break;
    case 0x0a64: // L1Log::AntennaSnapshotInd_t
    ...
    case 0x0101: // Cell::SetupResp_t
        buf.static = new Uint8Array(12);
        Cell_encodeSetupResp_t(l2l1, buf, 0);
        break;
    case 0x0102: // Cell::DeleteReq_t
        buf.static = new Uint8Array(2);
        Cell_encodeDeleteReq_t(l2l1, buf, 0);
        break;
    case 0x0103: // Cell::DeleteResp_t
        buf.static = new Uint8Array(4);
        Cell_encodeDeleteResp_t(l2l1, buf, 0);
        break;
    case 0x012D: // Cell::SetupReq_t
        buf.static = new Uint8Array(12);
        Cell_encodeSetupReq_t(l2l1, buf, 0);
        break;
...
packetPropToStrMap["l2l1.message"] = {
    ...
    0x0101: "Cell::SetupResp",
    0x0102: "Cell::DeleteReq",
    0x0103: "Cell::DeleteResp",
    0x012D: "Cell::SetupReq",
};
