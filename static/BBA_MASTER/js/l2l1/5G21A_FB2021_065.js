...
/*    if (!(result.i2Codebook4AntPorts === [object Object] || result.i2Codebook4AntPorts === [object Object] || result.i2Codebook4AntPorts === [object Object] || result.i2Codebook4AntPorts === [object Object] || result.i2Codebook4AntPorts === [object Object]))
        throw new Error(`Value ${result.i2Codebook4AntPorts} is out of range for enum 'i2Codebook4AntPorts_t'`); */
    Object.defineProperty(result, "__enum_i2Codebook4AntPorts", {
        enumerable: false,
        writable: false,
        value: "l1_common_i2Codebook4AntPorts_t",
    });
...
function UlDatadecodepucchReceiveReqSubcell_t(offset) {
    ...
    result.pucchResources = decodeDynamicVariableSizedArray_pucchReceiveReqPucchResource_t_252(offset + 48);
...
function UlDataencodepucchReceiveReqSubcell_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_pucchReceiveReqPucchResource_t_252(msg.pucchResources, buf, off + 48);
}
function UlDatadecodepucchReceiveReqPucchResource_t(offset) {
    let result = {};
...
function UlDatadecodepucchReceiveRespPsSubcell_t(offset) {
    ...
    result.subcellId = l2l1_getU8(offset + 0);
    result.pucchResources = decodeDynamicVariableSizedArray_pucchReceiveRespPsPucchResource_t_252(offset + 4);

    return result;
}
function UlDataencodepucchReceiveRespPsSubcell_t(msg, buf, off) {
    l2l1_putU8(msg.subcellId, buf, off + 0);
    encodeDynamicVariableSizedArray_pucchReceiveRespPsPucchResource_t_252(msg.pucchResources, buf, off + 4);
}
function UlDatadecodepucchReceiveRespPsPucchResource_t(offset) {
    let result = {};
...
packetEnumMap = {
    ...
    l1_common_i2Codebook4AntPorts_t: {
        0: "i2Codebook4AntPorts::VAL_0",
        1: "i2Codebook4AntPorts::VAL_1",
        2: "i2Codebook4AntPorts::VAL_2",
        3: "i2Codebook4AntPorts::VAL_3",
        255: "i2Codebook4AntPorts::VAL_255_NOTABIL",
    },
