...
/*    if (!(result.ulRank === [object Object] || result.ulRank === [object Object] || result.ulRank === [object Object]))
    ...
    result.uciCsiPart1Bits = decodeStaticFixedSizedArray_uint64_7(offset + 72);
    result.csiPart1CrcCheck = l2l1_getU8(offset + 128);
/*    if (!(result.csiPart1CrcCheck === [object Object] || result.csiPart1CrcCheck === [object Object]))
    ...
    result.numOfUciCsiPart2Bits = l2l1_getU8(offset + 129);
    result.uciCsiPart2Bits = decodeStaticFixedSizedArray_uint8_7(offset + 132);
    result.csiPart2CrcCheck = l2l1_getU8(offset + 140);
/*    if (!(result.csiPart2CrcCheck === [object Object] || result.csiPart2CrcCheck === [object Object]))
    ...
    result.dtxCsiPart1 = l2l1_getU8(offset + 141);
    result.dtxMetricCsiPart1 = l2l1_getU16(offset + 142);
    result.dtxThresholdCsiPart1 = l2l1_getU16(offset + 144);
    result.dtxCsiPart2 = l2l1_getU8(offset + 146);
    result.dtxMetricCsiPart2 = l2l1_getU16(offset + 148);
    result.dtxThresholdCsiPart2 = l2l1_getU16(offset + 150);
    result.rssiOfAnt = decodeStaticFixedSizedArray_float32_4(offset + 152);
    result.rxPowerOfAnt = decodeStaticFixedSizedArray_float32_4(offset + 168);
    result.sinrOfAnt = decodeStaticFixedSizedArray_float32_4(offset + 184);
    result.shortTermTaMetricOfAnt = decodeStaticFixedSizedArray_int16_4(offset + 200);
    result.shortTermTaPeakAmpOfAnt = decodeStaticFixedSizedArray_float32_4(offset + 208);
    result.shortTermCfoMetricOfAnt = decodeStaticFixedSizedArray_shortTermCfoMetric_t_4(offset + 224);
...
function UlDataencodeUePuschReceiveRespPs_t(msg, buf, off) {
    ...
    encodeStaticFixedSizedArray_uint64_7(msg.uciCsiPart1Bits, buf, off + 72);
    l2l1_putU8(msg.csiPart1CrcCheck, buf, off + 128);
    l2l1_putU8(msg.numOfUciCsiPart2Bits, buf, off + 129);
    encodeStaticFixedSizedArray_uint8_7(msg.uciCsiPart2Bits, buf, off + 132);
    l2l1_putU8(msg.csiPart2CrcCheck, buf, off + 140);
    l2l1_putU8(msg.dtxCsiPart1, buf, off + 141);
    l2l1_putU16(msg.dtxMetricCsiPart1, buf, off + 142);
    l2l1_putU16(msg.dtxThresholdCsiPart1, buf, off + 144);
    l2l1_putU8(msg.dtxCsiPart2, buf, off + 146);
    l2l1_putU16(msg.dtxMetricCsiPart2, buf, off + 148);
    l2l1_putU16(msg.dtxThresholdCsiPart2, buf, off + 150);
    encodeStaticFixedSizedArray_float32_4(msg.rssiOfAnt, buf, off + 152);
    encodeStaticFixedSizedArray_float32_4(msg.rxPowerOfAnt, buf, off + 168);
    encodeStaticFixedSizedArray_float32_4(msg.sinrOfAnt, buf, off + 184);
    encodeStaticFixedSizedArray_int16_4(msg.shortTermTaMetricOfAnt, buf, off + 200);
    encodeStaticFixedSizedArray_float32_4(msg.shortTermTaPeakAmpOfAnt, buf, off + 208);
    encodeStaticFixedSizedArray_shortTermCfoMetric_t_4(msg.shortTermCfoMetricOfAnt, buf, off + 224);
}
...
/*    if (!(result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object]))
    ...
    result.csiReportStruct = decodeDynamicVariableSizedArray_csiReportStruct_t_8(offset + 64);
    result.longTermCfoMetric = l1_commondecodelongTermCfoMetric_t(offset + 72);
    result.foeValid = l2l1_getU8(offset + 80);
    result.baseGraph = l2l1_getU8(offset + 81);
/*    if (!(result.baseGraph === [object Object] || result.baseGraph === [object Object]))
        throw new Error(`Value ${result.baseGraph} is out of range for enum 'ldpcBaseGraph_t'`); */
    Object.defineProperty(result, "__enum_baseGraph", {
        enumerable: false,
    ...
    result.numOfCodeBlocks = l2l1_getU8(offset + 82);
    result.codeBlockSize = l2l1_getU16(offset + 84);
    result.numOfFillerBits = l2l1_getU16(offset + 86);
    result.liftSize = l2l1_getU16(offset + 88);
    result.liftSizeSetIndex = l2l1_getU8(offset + 90);
    result.liftSizeColumnIndex = l2l1_getU8(offset + 91);
    result.modulationOrder = l2l1_getU8(offset + 92);
/*    if (!(result.modulationOrder === [object Object] || result.modulationOrder === [object Object] || result.modulationOrder === [object Object] || result.modulationOrder === [object Object] || result.modulationOrder === [object Object]))
        throw new Error(`Value ${result.modulationOrder} is out of range for enum 'modulationOrder_t'`); */
    Object.defineProperty(result, "__enum_modulationOrder", {
        enumerable: false,
    ...
    result.rvIndex = l2l1_getU8(offset + 93);
    result.ncb = l2l1_getU16(offset + 94);
    result.k0divZ = l2l1_getU8(offset + 96);
    result.numOfLayers = l2l1_getU8(offset + 97);
    result.puschTransCoherence = l2l1_getU8(offset + 98);
/*    if (!(result.puschTransCoherence === [object Object] || result.puschTransCoherence === [object Object] || result.puschTransCoherence === [object Object]))
    ...
    result.puschTransformPrecoderFlag = l2l1_getU8(offset + 99);
/*    if (!(result.puschTransformPrecoderFlag === [object Object] || result.puschTransformPrecoderFlag === [object Object]))
    ...
    result.eCpriConfigStruct = UlDatadecodeeCpriConfigStruct_t(offset + 100);
    result.numOfDmrsCdmGroupWithoutData = l2l1_getU8(offset + 112);
    result.l2CtxtAnMgt = decodeStaticFixedSizedArray_uint8_8(offset + 116);
    result.eCpriSectionId = l2l1_getU16(offset + 124);
    result.longTermCfoMetricOfAnt = decodeStaticFixedSizedArray_longTermCfoMetric_t_4(offset + 128);
...
function UlDataencodepuschReceiveReqGrant_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_csiReportStruct_t_8(msg.csiReportStruct, buf, off + 64);
    l1_commonencodelongTermCfoMetric_t(msg.longTermCfoMetric, buf, off + 72);
    l2l1_putU8(msg.foeValid, buf, off + 80);
    l2l1_putU8(msg.baseGraph, buf, off + 81);
    l2l1_putU8(msg.numOfCodeBlocks, buf, off + 82);
    l2l1_putU16(msg.codeBlockSize, buf, off + 84);
    l2l1_putU16(msg.numOfFillerBits, buf, off + 86);
    l2l1_putU16(msg.liftSize, buf, off + 88);
    l2l1_putU8(msg.liftSizeSetIndex, buf, off + 90);
    l2l1_putU8(msg.liftSizeColumnIndex, buf, off + 91);
    l2l1_putU8(msg.modulationOrder, buf, off + 92);
    l2l1_putU8(msg.rvIndex, buf, off + 93);
    l2l1_putU16(msg.ncb, buf, off + 94);
    l2l1_putU8(msg.k0divZ, buf, off + 96);
    l2l1_putU8(msg.numOfLayers, buf, off + 97);
    l2l1_putU8(msg.puschTransCoherence, buf, off + 98);
    l2l1_putU8(msg.puschTransformPrecoderFlag, buf, off + 99);
    UlDataencodeeCpriConfigStruct_t(msg.eCpriConfigStruct, buf, off + 100);
    l2l1_putU8(msg.numOfDmrsCdmGroupWithoutData, buf, off + 112);
    encodeStaticFixedSizedArray_uint8_8(msg.l2CtxtAnMgt, buf, off + 116);
    l2l1_putU16(msg.eCpriSectionId, buf, off + 124);
    encodeStaticFixedSizedArray_longTermCfoMetric_t_4(msg.longTermCfoMetricOfAnt, buf, off + 128);
}
...
function l2l1_decode_msg(l2l1) {
    ...
    case 0xE223: // UlData::PucchReceiveReq_t
        ...
        break;
    case 0xE224: // UlData::PuschReceiveReq_t
...
function encodeStaticFixedSizedArray_uint64_7(arr, buf, off) {
    for (let i = 0; i < 7; i++)
        l2l1_putU64(arr[i], buf, off + i * 8);
}
function decodeStaticFixedSizedArray_uint64_7(offset) {
    const result = [];
    for (let i = 0; i < 7; i++)
