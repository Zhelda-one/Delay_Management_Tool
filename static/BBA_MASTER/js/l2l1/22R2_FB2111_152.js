...
/*    if (!(result.cpriDialectIndication === [object Object] || result.cpriDialectIndication === [object Object]))
    ...
    result.axcPosition = decodeStaticVariableSizedArray_uint32_16(offset + 492);
    result.dlScPerCarrierPart = decodeDynamicVariableSizedArray_uint16_4(offset + 560);
    result.dlEcpriFdBeamforming = l2l1_getU8(offset + 568);
    result.dlSubcellPoolId = l2l1_getU8(offset + 569);
    result.dlReferenceLevel = l2l1_getU16(offset + 570);
    result.actDlEcpriPhase4 = l2l1_getU8(offset + 572);
    result.actORANstep1 = l2l1_getU8(offset + 573);
    result.mantissaSize = l2l1_getU8(offset + 574);
/*    if (!(result.mantissaSize === [object Object] || result.mantissaSize === [object Object]))
    ...
    result.dlIqCompression = l2l1_getU8(offset + 575);
    result.dlActDownSampling = l2l1_getU8(offset + 576);
    result.actDlEcpriExtType12 = l2l1_getU8(offset + 577);
    result.l1SubpoolId = l2l1_getU16(offset + 578);
    result.firstCellSlotId = l2l1_getU16(offset + 580);
    result.cellSlotLength = l2l1_getU16(offset + 582);
...
function DlCellencodeSetupReq_t(msg, buf, off) {
    ...
    encodeStaticVariableSizedArray_uint32_16(msg.axcPosition, buf, off + 492);
    encodeDynamicVariableSizedArray_uint16_4(msg.dlScPerCarrierPart, buf, off + 560);
    l2l1_putU8(msg.dlEcpriFdBeamforming, buf, off + 568);
    l2l1_putU8(msg.dlSubcellPoolId, buf, off + 569);
    l2l1_putU16(msg.dlReferenceLevel, buf, off + 570);
    l2l1_putU8(msg.actDlEcpriPhase4, buf, off + 572);
    l2l1_putU8(msg.actORANstep1, buf, off + 573);
    l2l1_putU8(msg.mantissaSize, buf, off + 574);
    l2l1_putU8(msg.dlIqCompression, buf, off + 575);
    l2l1_putU8(msg.dlActDownSampling, buf, off + 576);
    l2l1_putU8(msg.actDlEcpriExtType12, buf, off + 577);
    l2l1_putU16(msg.l1SubpoolId, buf, off + 578);
    l2l1_putU16(msg.firstCellSlotId, buf, off + 580);
    l2l1_putU16(msg.cellSlotLength, buf, off + 582);
}
function DlCelldecodephaseCompensationLutIndex_t(offset) {
    let result = {};
...
/*    if (!(result.closedLoop3gppCodebook === [object Object] || result.closedLoop3gppCodebook === [object Object] || result.closedLoop3gppCodebook === [object Object] || result.closedLoop3gppCodebook === [object Object]))
...
/*    if (!(result.prachCohCombLen === [object Object] || result.prachCohCombLen === [object Object] || result.prachCohCombLen === [object Object]))
...
/*    if (!(result.cpriDialectIndication === [object Object] || result.cpriDialectIndication === [object Object]))
    ...
    result.axcPosition = decodeStaticVariableSizedArray_uint32_16(offset + 64);
    result.prachConfigurationIndex = l2l1_getU8(offset + 132);
    result.prachPrbOffset = l2l1_getU16(offset + 134);
    result.adjustPrachThresholdOffsetDb = l2l1_getU16(offset + 136);
    result.ulDlDataSlotRatio = l2l1_getU8(offset + 138);
/*    if (!(result.ulDlDataSlotRatio === [object Object] || result.ulDlDataSlotRatio === [object Object] || result.ulDlDataSlotRatio === [object Object] || result.ulDlDataSlotRatio === [object Object] || result.ulDlDataSlotRatio === [object Object] || result.ulDlDataSlotRatio === [object Object]))
    ...
    result.l1SubpoolId = l2l1_getU16(offset + 140);
    result.firstCellSlotId = l2l1_getU16(offset + 142);
    result.cellSlotLength = l2l1_getU16(offset + 144);
    result.ulEcpriFdBeamforming = l2l1_getU8(offset + 146);
    result.actUlEcpriExtType12 = l2l1_getU8(offset + 147);
    result.ulSubcellPoolId = l2l1_getU8(offset + 148);
    result.gainCorrection = l2l1_getI16(offset + 150);
    result.gainCorrectionForPrach = l2l1_getI16(offset + 152);
    result.ulScPerCarrierPart = decodeDynamicVariableSizedArray_uint16_4(offset + 156);
    result.actUlEcpriPhase4 = l2l1_getU8(offset + 164);
    result.prachDtxThresholdSelection = l2l1_getU8(offset + 165);
/*    if (!(result.prachDtxThresholdSelection === [object Object] || result.prachDtxThresholdSelection === [object Object]))
    ...
    result.actORANstep1 = l2l1_getU8(offset + 166);
    result.numberOfColTRX = l2l1_getU8(offset + 167);
/*    if (!(result.numberOfColTRX === [object Object] || result.numberOfColTRX === [object Object]))
    ...
    result.numberOfRowTRX = l2l1_getU8(offset + 168);
/*    if (!(result.numberOfRowTRX === [object Object] || result.numberOfRowTRX === [object Object] || result.numberOfRowTRX === [object Object]))
    ...
    result.ORANprachNumerology = l2l1_getU8(offset + 169);
    result.ulIqCompression = l2l1_getU8(offset + 170);
    result.ulActDownSampling = l2l1_getU8(offset + 171);
    result.mantissaSize = l2l1_getU8(offset + 172);
/*    if (!(result.mantissaSize === [object Object] || result.mantissaSize === [object Object]))
        throw new Error(`Value ${result.mantissaSize} is out of range for enum 'mantissaSize_t'`); */
    Object.defineProperty(result, "__enum_mantissaSize", {
        enumerable: false,
    ...
    result.staticLongPucch = l2l1_getU8(offset + 173);
    result.localCellResId = l2l1_getU32(offset + 176);
    result.pSRSact = l2l1_getU8(offset + 180);
    result.pSRSnumCeAxCId = l2l1_getU8(offset + 181);
/*    if (!(result.pSRSnumCeAxCId === [object Object] || result.pSRSnumCeAxCId === [object Object] || result.pSRSnumCeAxCId === [object Object]))
    ...
    result.realPartOfPrecombinerRows = decodeDynamicVariableSizedArray_int16_32(offset + 184);
    result.imagPartOfPrecombinerRows = decodeDynamicVariableSizedArray_int16_32(offset + 192);
    result.realPartOfPrecombinerColumns = decodeDynamicVariableSizedArray_int16_32(offset + 200);
    result.imagPartOfPrecombinerColumns = decodeDynamicVariableSizedArray_int16_32(offset + 208);
    result.beamWeight = decodeDynamicVariableSizedArray_beamWeight_t_400(offset + 216);
    result.actHighSpeedCell = l2l1_getU8(offset + 224);
...
function UlCellencodeSetupReq_t(msg, buf, off) {
    ...
    encodeStaticVariableSizedArray_uint32_16(msg.axcPosition, buf, off + 64);
    l2l1_putU8(msg.prachConfigurationIndex, buf, off + 132);
    l2l1_putU16(msg.prachPrbOffset, buf, off + 134);
    l2l1_putU16(msg.adjustPrachThresholdOffsetDb, buf, off + 136);
    l2l1_putU8(msg.ulDlDataSlotRatio, buf, off + 138);
    l2l1_putU16(msg.l1SubpoolId, buf, off + 140);
    l2l1_putU16(msg.firstCellSlotId, buf, off + 142);
    l2l1_putU16(msg.cellSlotLength, buf, off + 144);
    l2l1_putU8(msg.ulEcpriFdBeamforming, buf, off + 146);
    l2l1_putU8(msg.actUlEcpriExtType12, buf, off + 147);
    l2l1_putU8(msg.ulSubcellPoolId, buf, off + 148);
    l2l1_putI16(msg.gainCorrection, buf, off + 150);
    l2l1_putI16(msg.gainCorrectionForPrach, buf, off + 152);
    encodeDynamicVariableSizedArray_uint16_4(msg.ulScPerCarrierPart, buf, off + 156);
    l2l1_putU8(msg.actUlEcpriPhase4, buf, off + 164);
    l2l1_putU8(msg.prachDtxThresholdSelection, buf, off + 165);
    l2l1_putU8(msg.actORANstep1, buf, off + 166);
    l2l1_putU8(msg.numberOfColTRX, buf, off + 167);
    l2l1_putU8(msg.numberOfRowTRX, buf, off + 168);
    l2l1_putU8(msg.ORANprachNumerology, buf, off + 169);
    l2l1_putU8(msg.ulIqCompression, buf, off + 170);
    l2l1_putU8(msg.ulActDownSampling, buf, off + 171);
    l2l1_putU8(msg.mantissaSize, buf, off + 172);
    l2l1_putU8(msg.staticLongPucch, buf, off + 173);
    l2l1_putU32(msg.localCellResId, buf, off + 176);
    l2l1_putU8(msg.pSRSact, buf, off + 180);
    l2l1_putU8(msg.pSRSnumCeAxCId, buf, off + 181);
    encodeDynamicVariableSizedArray_int16_32(msg.realPartOfPrecombinerRows, buf, off + 184);
    encodeDynamicVariableSizedArray_int16_32(msg.imagPartOfPrecombinerRows, buf, off + 192);
    encodeDynamicVariableSizedArray_int16_32(msg.realPartOfPrecombinerColumns, buf, off + 200);
    encodeDynamicVariableSizedArray_int16_32(msg.imagPartOfPrecombinerColumns, buf, off + 208);
    encodeDynamicVariableSizedArray_beamWeight_t_400(msg.beamWeight, buf, off + 216);
    l2l1_putU8(msg.actHighSpeedCell, buf, off + 224);
}
function UlCelldecodebeamWeight_t(offset) {
    let result = {};
...
/*    if (!(result.puschTransformPrecoderFlag === [object Object] || result.puschTransformPrecoderFlag === [object Object]))
    ...
    result.ext = decodeStaticVariableSizedArray_uint32_2(offset + 168);
...
function UlDataencodepuschReceiveReqGrant_t(msg, buf, off) {
    ...
    encodeStaticVariableSizedArray_uint32_2(msg.ext, buf, off + 168);
}
...
function L1FcpdecodebfwWeights_t(offset) {
    let result = {};
...
function L1FcpencodebfwWeights_t(msg, buf, off) {
    l2l1_putU16(msg.bfwI, buf, off + 0);
    l2l1_putU16(msg.bfwQ, buf, off + 2);
}
function L1FcpdecodebfwSectionExtensions_t(offset) {
    let result = {};

    result.bfwCompHdr = l2l1_getU8(offset + 0);
    result.bfwCompParam = l2l1_getU8(offset + 1);
    result.bfwWeights = decodeDynamicVariableSizedArray_bfwWeights_t_64(offset + 4);

    return result;
}
function L1FcpencodebfwSectionExtensions_t(msg, buf, off) {
    l2l1_putU8(msg.bfwCompHdr, buf, off + 0);
    l2l1_putU8(msg.bfwCompParam, buf, off + 1);
    encodeDynamicVariableSizedArray_bfwWeights_t_64(msg.bfwWeights, buf, off + 4);
}
function L1FcpdecodenonContPrbAllocSectionExtensions_t(offset) {
    let result = {};
...
function L1FcpencodenonContPrbAllocSectionExtensions_t(msg, buf, off) {
...
/*    if (!(result.rb === [object Object] || result.rb === [object Object]))
    ...
    result.bfwSectionExtensions = decodeDynamicVariableSizedArray_bfwSectionExtensions_t_1(offset + 16);
    result.nonContPrbAllocSectionExtensions = decodeDynamicVariableSizedArray_nonContPrbAllocSectionExtensions_t_1(offset + 24);

    return result;
}
function L1Fcpencodesection_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_bfwSectionExtensions_t_1(msg.bfwSectionExtensions, buf, off + 16);
    encodeDynamicVariableSizedArray_nonContPrbAllocSectionExtensions_t_1(msg.nonContPrbAllocSectionExtensions, buf, off + 24);
}
...
/*    if (!(result.dataDirection === [object Object] || result.dataDirection === [object Object]))
        throw new Error(`Value ${result.dataDirection} is out of range for enum 'dataDirection_t'`); */
    Object.defineProperty(result, "__enum_dataDirection", {
        enumerable: false,
        writable: false,
        value: "L1Fcp_dataDirection_t",
    });
...
/*    if (!(result.filterIndex === [object Object] || result.filterIndex === [object Object] || result.filterIndex === [object Object] || result.filterIndex === [object Object] || result.filterIndex === [object Object]))
        throw new Error(`Value ${result.filterIndex} is out of range for enum 'filterIndex_t'`); */
    Object.defineProperty(result, "__enum_filterIndex", {
        enumerable: false,
        writable: false,
        value: "L1Fcp_filterIndex_t",
    });
    ...
    result.section = decodeDynamicVariableSizedArray_section_t_210(offset + 16);
...
function L1FcpencodeDlUlChannelsReq_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_section_t_210(msg.section, buf, off + 16);
}
function L1Fcpdecodesection_t(offset) {
    let result = {};
...
function decodebfwWeights_t(offset) {
    let result = {};
...
function encodebfwWeights_t(msg, buf, off) {
    l2l1_putU16(msg.bfwI, buf, off + 0);
    l2l1_putU16(msg.bfwQ, buf, off + 2);
}
...
function encodeDynamicVariableSizedArray_bfwWeights_t_64(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        L1FcpencodebfwWeights_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_bfwWeights_t_64(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(L1FcpdecodebfwWeights_t(offset));
        offset += 4;
    }

    return result;
}
function encodeDynamicVariableSizedArray_bfwSectionExtensions_t_1(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        L1FcpencodebfwSectionExtensions_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_bfwSectionExtensions_t_1(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(L1FcpdecodebfwSectionExtensions_t(offset));
        offset += 12;
    }

    return result;
}
function encodeDynamicVariableSizedArray_nonContPrbAllocSectionExtensions_t_1(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        L1FcpencodenonContPrbAllocSectionExtensions_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_nonContPrbAllocSectionExtensions_t_1(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(L1FcpdecodenonContPrbAllocSectionExtensions_t(offset));
        offset += 12;
    }

    return result;
}
function encodeDynamicVariableSizedArray_section_t_210(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        L1Fcpencodesection_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_section_t_210(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(L1Fcpdecodesection_t(offset));
        offset += 32;
    }
