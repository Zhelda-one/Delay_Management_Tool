function lunum_commondecodeeAxcStream_t(offset) {
    let result = {};

    result.eAxcId = l2l1_getU16(offset + 0);
    result.bipId = l2l1_getU16(offset + 2);
    result.phyChannelType = l2l1_getU8(offset + 4);
/*    if (!(result.phyChannelType === [object Object] || result.phyChannelType === [object Object] || result.phyChannelType === [object Object] || result.phyChannelType === [object Object]))
        throw new Error(`Value ${result.phyChannelType} is out of range for enum 'PhyChannelType__t'`); */
    Object.defineProperty(result, "__enum_phyChannelType", {
        enumerable: false,
        writable: false,
        value: "lunum_common_PhyChannelType__t",
    });
...
function lunum_commonencodeeAxcStream_t(msg, buf, off) {
...
function lunum_commondecodeeAxcStreamDelayMeasurement_t(offset) {
    let result = {};
...
function lunum_commonencodeeAxcStreamDelayMeasurement_t(msg, buf, off) {
    l2l1_putU16(msg.eAxcId, buf, off + 0);
    l2l1_putU16(msg.bipId, buf, off + 2);
    l2l1_putU32(msg.tdOneWayMin, buf, off + 4);
    l2l1_putU32(msg.tdOneWayMax, buf, off + 8);
}
function CelldecodeSetupReq_t(offset) {
    let result = {};

    result.physCellId = l2l1_getU16(offset + 0);
    result.dlBandwidth = l2l1_getU8(offset + 2);
/*    if (!(result.dlBandwidth === [object Object] || result.dlBandwidth === [object Object] || result.dlBandwidth === [object Object] || result.dlBandwidth === [object Object] || result.dlBandwidth === [object Object] || result.dlBandwidth === [object Object]))
        throw new Error(`Value ${result.dlBandwidth} is out of range for enum 'Bandwidth'`); */
    Object.defineProperty(result, "__enum_dlBandwidth", {
        enumerable: false,
        writable: false,
        value: "lunum_common_Bandwidth",
    });
    result.ulBandwidth = l2l1_getU8(offset + 3);
/*    if (!(result.ulBandwidth === [object Object] || result.ulBandwidth === [object Object] || result.ulBandwidth === [object Object] || result.ulBandwidth === [object Object] || result.ulBandwidth === [object Object] || result.ulBandwidth === [object Object]))
        throw new Error(`Value ${result.ulBandwidth} is out of range for enum 'Bandwidth'`); */
    Object.defineProperty(result, "__enum_ulBandwidth", {
        enumerable: false,
        writable: false,
        value: "lunum_common_Bandwidth",
    });
    result.eAxcStreams = decodeDynamicVariableSizedArray_eAxcStream_t_100(offset + 4);

    return result;
}
function CellencodeSetupReq_t(msg, buf, off) {
    l2l1_putU16(msg.physCellId, buf, off + 0);
    l2l1_putU8(msg.dlBandwidth, buf, off + 2);
    l2l1_putU8(msg.ulBandwidth, buf, off + 3);
    encodeDynamicVariableSizedArray_eAxcStream_t_100(msg.eAxcStreams, buf, off + 4);
}
function lunum_commondecodeeAxcStream_t(offset) {
    let result = {};
...
function CelldecodeSetupResp_t(offset) {
    let result = {};

    result.physCellId = l2l1_getU16(offset + 0);
    result.eAxcStreamsDelayMeasurements = decodeDynamicVariableSizedArray_eAxcStreamDelayMeasurement_t_100(offset + 4);

    return result;
}
function CellencodeSetupResp_t(msg, buf, off) {
    l2l1_putU16(msg.physCellId, buf, off + 0);
    encodeDynamicVariableSizedArray_eAxcStreamDelayMeasurement_t_100(msg.eAxcStreamsDelayMeasurements, buf, off + 4);
}
function CelldecodeDeleteReq_t(offset) {
    let result = {};
...
function CellencodeDeleteReq_t(msg, buf, off) {
    l2l1_putU16(msg.physCellId, buf, off + 0);
}
function CelldecodeDeleteResp_t(offset) {
    let result = {};
...
function CellencodeDeleteResp_t(msg, buf, off) {
    l2l1_putU16(msg.physCellId, buf, off + 0);
...
function LTE_LUNUM_DlDatadecodedlUlCommonHeader_t(offset) {
    let result = {};
...
/*    if (!(result.dataDirection === [object Object] || result.dataDirection === [object Object]))
    ...
    Object.defineProperty(result, "__enum_dataDirection", {
        enumerable: false,
        writable: false,
        value: "LTE_LUNUM_DlData_DataDirection",
    });
...
/*    if (!(result.filterIndex === [object Object] || result.filterIndex === [object Object] || result.filterIndex === [object Object] || result.filterIndex === [object Object] || result.filterIndex === [object Object]))
    ...
    Object.defineProperty(result, "__enum_filterIndex", {
        enumerable: false,
        writable: false,
        value: "LTE_LUNUM_DlData_FilterIndex",
    });
...
function LTE_LUNUM_DlDataencodedlUlCommonHeader_t(msg, buf, off) {
...
function LTE_LUNUM_DlDatadecodesectionExtension_t(offset) {
    let result = {};

    result.extType = l2l1_getU8(offset + 0);
/*    if (!(result.extType === [object Object] || result.extType === [object Object] || result.extType === [object Object] || result.extType === [object Object] || result.extType === [object Object] || result.extType === [object Object] || result.extType === [object Object]))
        throw new Error(`Value ${result.extType} is out of range for enum 'ExtType'`); */
    Object.defineProperty(result, "__enum_extType", {
        enumerable: false,
        writable: false,
        value: "LTE_LUNUM_DlData_ExtType",
    });
    result.extParamLen = l2l1_getU8(offset + 1);
    result.extParamOffset = l2l1_getU16(offset + 2);

    return result;
}
function LTE_LUNUM_DlDataencodesectionExtension_t(msg, buf, off) {
    l2l1_putU8(msg.extType, buf, off + 0);
    l2l1_putU8(msg.extParamLen, buf, off + 1);
    l2l1_putU16(msg.extParamOffset, buf, off + 2);
}
function LTE_LUNUM_DlDatadecodedlUlSection_t(offset) {
    let result = {};

    result.sectionId = l2l1_getU16(offset + 0);
    result.rb = l2l1_getU8(offset + 2);
    result.symInd = l2l1_getU8(offset + 3);
    ...
    result.numSectionExtension = l2l1_getU16(offset + 14);
    result.sectionExtensions = decodeStaticVariableSizedArray_sectionExtension_t_3(offset + 16);

    return result;
}
function LTE_LUNUM_DlDataencodedlUlSection_t(msg, buf, off) {
    l2l1_putU16(msg.sectionId, buf, off + 0);
    l2l1_putU8(msg.rb, buf, off + 2);
    l2l1_putU8(msg.symInd, buf, off + 3);
    ...
    l2l1_putU16(msg.numSectionExtension, buf, off + 14);
    encodeStaticVariableSizedArray_sectionExtension_t_3(msg.sectionExtensions, buf, off + 16);
}
function LTE_LUNUM_DlDatadecodedlUlChannelsReq_t(offset) {
    let result = {};

    result.inCellId = l2l1_getU32(offset + 0);
    result.eNbId = l2l1_getU32(offset + 4);
    result.eAxcId = l2l1_getU16(offset + 8);
    result.commonHeader = LTE_LUNUM_DlDatadecodedlUlCommonHeader_t(offset + 10);
    result.sections = decodeDynamicVariableSizedArray_dlUlSection_t_10(offset + 20);
    result.extensionData = decodeDynamicVariableSizedArray_uint8_500(offset + 28);

    return result;
}
function LTE_LUNUM_DlDataencodedlUlChannelsReq_t(msg, buf, off) {
    l2l1_putU32(msg.inCellId, buf, off + 0);
    l2l1_putU32(msg.eNbId, buf, off + 4);
    l2l1_putU16(msg.eAxcId, buf, off + 8);
    LTE_LUNUM_DlDataencodedlUlCommonHeader_t(msg.commonHeader, buf, off + 10);
    encodeDynamicVariableSizedArray_dlUlSection_t_10(msg.sections, buf, off + 20);
    encodeDynamicVariableSizedArray_uint8_500(msg.extensionData, buf, off + 28);
}
function l2l1_decode_msg(l2l1) {
    ...
    case 0x0243: // UlData::AddressReq_t
        ...
        break;
    case 0xd260: // LTE_LUNUM_DlData::dlUlChannelsReq_t
        result = LTE_LUNUM_DlDatadecodedlUlChannelsReq_t(0);
        break;
...
function l2l1_encode_msg(l2l1) {
    ...
    case 0x0203: // UlCell::DeleteResp_t
        ...
        break;
    case 0x0247: // UlCell::SetupReq_t
        buf.static = new Uint8Array(1520);
    ...
    case 0xd260: // LTE_LUNUM_DlData::dlUlChannelsReq_t
        buf.static = new Uint8Array(36);
        LTE_LUNUM_DlDataencodedlUlChannelsReq_t(l2l1, buf, 0);
        break;
...
function encodeStaticVariableSizedArray_sectionExtension_t_3(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off);
    for (let i = 0; i < arr.length && i < 3; i++)
        LTE_LUNUM_DlDataencodesectionExtension_t(arr[i], buf, off + i * 4);
}
function decodeStaticVariableSizedArray_sectionExtension_t_3(offset) {
    const result = [];
    const length = l2l1_getU32(offset);
    for (let i = 0; i < length && i < 3; i++)
        result.push(LTE_LUNUM_DlDatadecodesectionExtension_t(offset + 4 + i * 4));
    return result;
}
function encodeDynamicVariableSizedArray_eAxcStream_t_100(arr, buf, off) {
    ...
    for (const elem of arr) {
        lunum_commonencodeeAxcStream_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_eAxcStream_t_100(offset) {
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(lunum_commondecodeeAxcStream_t(offset));
        offset += 10;
    }

    return result;
}
function encodeDynamicVariableSizedArray_eAxcStreamDelayMeasurement_t_100(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        lunum_commonencodeeAxcStreamDelayMeasurement_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_eAxcStreamDelayMeasurement_t_100(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(lunum_commondecodeeAxcStreamDelayMeasurement_t(offset));
        offset += 12;
    }
...
function encodeDynamicVariableSizedArray_uint8_500(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_uint8_500(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_dlUlSection_t_10(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        LTE_LUNUM_DlDataencodedlUlSection_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_dlUlSection_t_10(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(LTE_LUNUM_DlDatadecodedlUlSection_t(offset));
        offset += 32;
    }
...
packetPropToStrMap["l2l1.message"] = {
    ...
    0xd260: "LTE_LUNUM_DlData::dlUlChannelsReq",
};

packetEnumMap = {
    lunum_common_Bandwidth: {
        6: "Bandwidth::prbs_6",
    ...
    lunum_common_PhyChannelType__t: {
    ...
    LTE_LUNUM_DlData_RbIndicatior: {
        0: "RbIndicatior::RbIndicator_EveryRb",
        1: "RbIndicatior::RbIndicator_EveryOtherRb",
    },
    LTE_LUNUM_DlData_ExtType: {
