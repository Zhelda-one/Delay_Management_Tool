...
function UlDatadecodesrsBwvReportRequest_t(offset) {
    ...
    result.rnti = l2l1_getU16(offset + 6);
    result.numSrsPorts = l2l1_getU8(offset + 8);
/*    if (!(result.numSrsPorts === [object Object] || result.numSrsPorts === [object Object] || result.numSrsPorts === [object Object]))
    ...
    result.startPatternId = l2l1_getU16(offset + 10);
    result.numPatternId = l2l1_getU16(offset + 12);
    result.startPrb = l2l1_getU16(offset + 14);
    result.numRbgPerSubband = l2l1_getU8(offset + 16);
    result.srsCyclicShifts = decodeDynamicVariableSizedArray_srsCyclicShifts_t_4(offset + 20);
...
function UlDataencodesrsBwvReportRequest_t(msg, buf, off) {
    ...
    l2l1_putU16(msg.rnti, buf, off + 6);
    l2l1_putU8(msg.numSrsPorts, buf, off + 8);
    l2l1_putU16(msg.startPatternId, buf, off + 10);
    l2l1_putU16(msg.numPatternId, buf, off + 12);
    l2l1_putU16(msg.startPrb, buf, off + 14);
    l2l1_putU8(msg.numRbgPerSubband, buf, off + 16);
    encodeDynamicVariableSizedArray_srsCyclicShifts_t_4(msg.srsCyclicShifts, buf, off + 20);
}
...
/*    if (!(result.transmissionComb === [object Object] || result.transmissionComb === [object Object]))
    ...
    result.sequenceId = l2l1_getU16(offset + 2);
    result.srsBwvReportRequests = decodeDynamicVariableSizedArray_srsBwvReportRequest_t_2(offset + 4);
...
function UlDataencodesrsBwvStruct_t(msg, buf, off) {
    ...
    l2l1_putU16(msg.sequenceId, buf, off + 2);
    encodeDynamicVariableSizedArray_srsBwvReportRequest_t_2(msg.srsBwvReportRequests, buf, off + 4);
}
...
function encodeDynamicVariableSizedArray_srsBwvReportRequest_t_2(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_srsBwvReportRequest_t_2(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
