...
/*    if (!(result.numOfLogicalResourceIds === [object Object] || result.numOfLogicalResourceIds === [object Object] || result.numOfLogicalResourceIds === [object Object] || result.numOfLogicalResourceIds === [object Object]))
...
/*    if (!(result.mantissaSize === [object Object] || result.mantissaSize === [object Object]))
    ...
    result.actAdaptiveReTxResMcsEnh = l2l1_getU8(offset + 173);
    ...
    result.numOfLogicalResourceIds = l2l1_getU8(offset + 240);
/*    if (!(result.numOfLogicalResourceIds === [object Object] || result.numOfLogicalResourceIds === [object Object] || result.numOfLogicalResourceIds === [object Object]))
    ...
    result.logicalResourceIds = decodeStaticFixedSizedArray_uint32_8(offset + 244);
...
function UlCellencodeSetupReq_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.actAdaptiveReTxResMcsEnh, buf, off + 173);
    ...
    l2l1_putU8(msg.numOfLogicalResourceIds, buf, off + 240);
    encodeStaticFixedSizedArray_uint32_8(msg.logicalResourceIds, buf, off + 244);
}
function UlCelldecodeulBeams_t(offset) {
    let result = {};
...
/*    if (!(result.csiPart2CrcCheck === [object Object] || result.csiPart2CrcCheck === [object Object]))
    ...
    result.linRssiOfAnt = decodeStaticFixedSizedArray_uint64_4(offset + 208);
    result.linNoiseOfAnt = decodeStaticFixedSizedArray_uint32_4(offset + 240);
...
function UlDataencodeUePuschReceiveRespPs_t(msg, buf, off) {
    ...
    encodeStaticFixedSizedArray_uint64_4(msg.linRssiOfAnt, buf, off + 208);
    encodeStaticFixedSizedArray_uint32_4(msg.linNoiseOfAnt, buf, off + 240);
}
