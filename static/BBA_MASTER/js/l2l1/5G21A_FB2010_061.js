...
/*    if (!(result.cpriDialectIndication === [object Object] || result.cpriDialectIndication === [object Object]))
    ...
    result.actDlEcpriPhase4 = l2l1_getU8(offset + 724);
    result.actORANstep1 = l2l1_getU8(offset + 725);
    result.mantissaSize = l2l1_getU8(offset + 726);
/*    if (!(result.mantissaSize === [object Object] || result.mantissaSize === [object Object]))
    ...
    result.dlIqCompression = l2l1_getU8(offset + 727);
    result.dlActDownSampling = l2l1_getU8(offset + 728);
...
function DlCellencodeSetupReq_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.actDlEcpriPhase4, buf, off + 724);
    l2l1_putU8(msg.actORANstep1, buf, off + 725);
    l2l1_putU8(msg.mantissaSize, buf, off + 726);
    l2l1_putU8(msg.dlIqCompression, buf, off + 727);
    l2l1_putU8(msg.dlActDownSampling, buf, off + 728);
}
...
/*    if (!(result.cpriDialectIndication === [object Object] || result.cpriDialectIndication === [object Object]))
    ...
    result.actUlEcpriPhase4 = l2l1_getU8(offset + 294);
    result.prachDtxThresholdSelection = l2l1_getU8(offset + 295);
/*    if (!(result.prachDtxThresholdSelection === [object Object] || result.prachDtxThresholdSelection === [object Object]))
    ...
    result.actORANstep1 = l2l1_getU8(offset + 296);
    result.numberOfTRX = l2l1_getU8(offset + 297);
/*    if (!(result.numberOfTRX === [object Object] || result.numberOfTRX === [object Object] || result.numberOfTRX === [object Object] || result.numberOfTRX === [object Object]))
    ...
    result.numberOfRowTRX = l2l1_getU8(offset + 298);
/*    if (!(result.numberOfRowTRX === [object Object] || result.numberOfRowTRX === [object Object] || result.numberOfRowTRX === [object Object]))
    ...
    result.ORANprachNumerology = l2l1_getU8(offset + 299);
    result.ulIqCompression = l2l1_getU8(offset + 300);
    result.ulActDownSampling = l2l1_getU8(offset + 301);
    result.mantissaSize = l2l1_getU8(offset + 302);
/*    if (!(result.mantissaSize === [object Object] || result.mantissaSize === [object Object]))
        throw new Error(`Value ${result.mantissaSize} is out of range for enum 'mantissaSize_t'`); */
    Object.defineProperty(result, "__enum_mantissaSize", {
        enumerable: false,
    ...
    result.staticLongPucch = l2l1_getU8(offset + 303);
...
function UlCellencodeSetupReq_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.actUlEcpriPhase4, buf, off + 294);
    l2l1_putU8(msg.prachDtxThresholdSelection, buf, off + 295);
    l2l1_putU8(msg.actORANstep1, buf, off + 296);
    l2l1_putU8(msg.numberOfTRX, buf, off + 297);
    l2l1_putU8(msg.numberOfRowTRX, buf, off + 298);
    l2l1_putU8(msg.ORANprachNumerology, buf, off + 299);
    l2l1_putU8(msg.ulIqCompression, buf, off + 300);
    l2l1_putU8(msg.ulActDownSampling, buf, off + 301);
    l2l1_putU8(msg.mantissaSize, buf, off + 302);
    l2l1_putU8(msg.staticLongPucch, buf, off + 303);
}
...
function UlDatadecodepucchReceiveReqSubcell_t(offset) {
    ...
    result.sfnForProcessing = l2l1_getU16(offset + 2);
    result.slotForProcessing = l2l1_getU8(offset + 4);
    result.pucchResources = decodeDynamicVariableSizedArray_pucchReceiveReqPucchResource_t_252(offset + 8);
...
function UlDataencodepucchReceiveReqSubcell_t(msg, buf, off) {
    ...
    l2l1_putU16(msg.sfnForProcessing, buf, off + 2);
    l2l1_putU8(msg.slotForProcessing, buf, off + 4);
    encodeDynamicVariableSizedArray_pucchReceiveReqPucchResource_t_252(msg.pucchResources, buf, off + 8);
}
function UlDatadecodepucchReceiveReqPucchResource_t(offset) {
    let result = {};
