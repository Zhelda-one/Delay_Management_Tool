...
/*    if (!(result.cellExtension === [object Object] || result.cellExtension === [object Object] || result.cellExtension === [object Object] || result.cellExtension === [object Object]))
...
/*    if (!(result.cpriDialectIndication === [object Object] || result.cpriDialectIndication === [object Object]))
    ...
    result.axcPosition = decodeStaticVariableSizedArray_uint32_16(offset + 60);
    result.prachConfigurationIndex = l2l1_getU8(offset + 128);
...
/*    if (!(result.ulDlDataSlotRatio === [object Object] || result.ulDlDataSlotRatio === [object Object] || result.ulDlDataSlotRatio === [object Object] || result.ulDlDataSlotRatio === [object Object] || result.ulDlDataSlotRatio === [object Object] || result.ulDlDataSlotRatio === [object Object]))
    ...
    result.ulScPerCarrierPart = decodeDynamicVariableSizedArray_uint16_4(offset + 152);
    result.actUlEcpriPhase4 = l2l1_getU8(offset + 160);
    result.prachDtxThresholdSelection = l2l1_getU8(offset + 161);
/*    if (!(result.prachDtxThresholdSelection === [object Object] || result.prachDtxThresholdSelection === [object Object]))
    ...
    result.actORANstep1 = l2l1_getU8(offset + 162);
    result.numberOfColTRX = l2l1_getU8(offset + 163);
/*    if (!(result.numberOfColTRX === [object Object] || result.numberOfColTRX === [object Object]))
    ...
    result.numberOfRowTRX = l2l1_getU8(offset + 164);
/*    if (!(result.numberOfRowTRX === [object Object] || result.numberOfRowTRX === [object Object] || result.numberOfRowTRX === [object Object]))
    ...
    result.ORANprachNumerology = l2l1_getU8(offset + 165);
    result.ulIqCompression = l2l1_getU8(offset + 166);
    result.ulActDownSampling = l2l1_getU8(offset + 167);
    result.mantissaSize = l2l1_getU8(offset + 168);
/*    if (!(result.mantissaSize === [object Object] || result.mantissaSize === [object Object]))
        throw new Error(`Value ${result.mantissaSize} is out of range for enum 'mantissaSize_t'`); */
    Object.defineProperty(result, "__enum_mantissaSize", {
        enumerable: false,
    ...
    result.staticLongPucch = l2l1_getU8(offset + 169);
    result.localCellResId = l2l1_getU32(offset + 172);
    result.pSRSact = l2l1_getU8(offset + 176);
    result.pSRSnumCeAxCId = l2l1_getU8(offset + 177);
/*    if (!(result.pSRSnumCeAxCId === [object Object] || result.pSRSnumCeAxCId === [object Object] || result.pSRSnumCeAxCId === [object Object]))
    ...
    result.realPartOfPrecombinerRows = decodeDynamicVariableSizedArray_int16_32(offset + 180);
    result.imagPartOfPrecombinerRows = decodeDynamicVariableSizedArray_int16_32(offset + 188);
    result.realPartOfPrecombinerColumns = decodeDynamicVariableSizedArray_int16_32(offset + 196);
    result.imagPartOfPrecombinerColumns = decodeDynamicVariableSizedArray_int16_32(offset + 204);
    result.beamWeight = decodeDynamicVariableSizedArray_beamWeight_t_400(offset + 212);
...
function UlCellencodeSetupReq_t(msg, buf, off) {
    ...
    encodeStaticVariableSizedArray_uint32_16(msg.axcPosition, buf, off + 60);
    ...
    encodeDynamicVariableSizedArray_uint16_4(msg.ulScPerCarrierPart, buf, off + 152);
    ...
    encodeDynamicVariableSizedArray_int16_32(msg.realPartOfPrecombinerRows, buf, off + 180);
    encodeDynamicVariableSizedArray_int16_32(msg.imagPartOfPrecombinerRows, buf, off + 188);
    encodeDynamicVariableSizedArray_int16_32(msg.realPartOfPrecombinerColumns, buf, off + 196);
    encodeDynamicVariableSizedArray_int16_32(msg.imagPartOfPrecombinerColumns, buf, off + 204);
    encodeDynamicVariableSizedArray_beamWeight_t_400(msg.beamWeight, buf, off + 212);
}
function UlCelldecodebeamWeight_t(offset) {
    let result = {};
...
packetEnumMap = {
    ...
    l1_common_dlScPerCarrierPart_t: {
        1296: "dlScPerCarrierPart::DL_BW_PER_CARRIER_15KHz",
    ...
    l1_common_ulScPerCarrierPart_t: {
        1296: "ulScPerCarrierPart::UL_BW_PER_CARRIER_15KHz",
