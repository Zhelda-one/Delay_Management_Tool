...
/*    if (!(result.mantissaSize === [object Object] || result.mantissaSize === [object Object]))
    ...
    result.actUlMuMimo = l2l1_getU8(offset + 225);
    result.ulSubCellCaps = l2l1_getU32(offset + 228);
...
function UlCellencodeSetupReq_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.actUlMuMimo, buf, off + 225);
    l2l1_putU32(msg.ulSubCellCaps, buf, off + 228);
}
function UlCelldecodeulBeams_t(offset) {
    let result = {};
...
/*    if (!(result.puschTransformPrecoderFlag === [object Object] || result.puschTransformPrecoderFlag === [object Object]))
    ...
    result.pairedUe = l2l1_getU16(offset + 180);
...
function UlDataencodepuschReceiveReqGrant_t(msg, buf, off) {
    ...
    l2l1_putU16(msg.pairedUe, buf, off + 180);
}
...
function UlDatadecoderimReceiveReqSubcell_t(offset) {
    ...
    result.unscheduledRegionInfo = decodeDynamicVariableSizedArray_unscheduledRegionInfo_t_14(offset + 32);
...
function UlDataencoderimReceiveReqSubcell_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_unscheduledRegionInfo_t_14(msg.unscheduledRegionInfo, buf, off + 32);
}
