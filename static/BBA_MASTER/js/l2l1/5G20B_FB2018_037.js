...
/*    if (!(result.reportType === [object Object] || result.reportType === [object Object] || result.reportType === [object Object] || result.reportType === [object Object]))
    ...
    result.fileList = decodeStaticVariableSizedArray_antennaSnapshotFile_t_2(offset + 12);
...
function L1LogencodeAntennaSnapshotInd_t(msg, buf, off) {
    ...
    encodeStaticVariableSizedArray_antennaSnapshotFile_t_2(msg.fileList, buf, off + 12);
}
function L1LogdecodeantennaSnapshotFile_t(offset) {
    let result = {};
...
function L1LogdecodeTraceReqHeader_t(offset) {
    ...
    result.trswEQID = l2l1_getU32(offset + 4);
    result.startStopReport = l2l1_getU8(offset + 8);
/*    if (!(result.startStopReport === [object Object] || result.startStopReport === [object Object]))
    ...
    result.outputMode = l2l1_getU8(offset + 9);
...
function L1LogencodeTraceReqHeader_t(msg, buf, off) {
    ...
    l2l1_putU32(msg.trswEQID, buf, off + 4);
    l2l1_putU8(msg.startStopReport, buf, off + 8);
    l2l1_putU8(msg.outputMode, buf, off + 9);
}
...
function L1LogdecodeTraceReq_t(offset) {
    ...
    result.traces = decodeStaticVariableSizedArray_TraceReqEntry_t_10(offset + 12);

    return result;
}
function L1LogencodeTraceReq_t(msg, buf, off) {
    L1LogencodeTraceReqHeader_t(msg.header, buf, off + 0);
    encodeStaticVariableSizedArray_TraceReqEntry_t_10(msg.traces, buf, off + 12);
}
...
function L1LogdecodeAntennaSnapshotConfigurationReq_t(offset) {
    ...
    result.ulSubcellId = decodeStaticVariableSizedArray_uint8_4(offset + 4);
    result.numDlSubCellId = l2l1_getU8(offset + 12);
    result.dlSubcellId = decodeStaticVariableSizedArray_uint8_4(offset + 16);
    result.AntSnapshotL1EventEnabled = l2l1_getU8(offset + 24);
/*    if (!(result.AntSnapshotL1EventEnabled === [object Object] || result.AntSnapshotL1EventEnabled === [object Object]))
...
function L1LogencodeAntennaSnapshotConfigurationReq_t(msg, buf, off) {
    ...
    encodeStaticVariableSizedArray_uint8_4(msg.ulSubcellId, buf, off + 4);
    l2l1_putU8(msg.numDlSubCellId, buf, off + 12);
    encodeStaticVariableSizedArray_uint8_4(msg.dlSubcellId, buf, off + 16);
    l2l1_putU8(msg.AntSnapshotL1EventEnabled, buf, off + 24);
}
...
function UlDatadecodesrsReceiveReqSubcell_t(offset) {
    ...
    result.srsBmStruct = UlDatadecodesrsBmStruct_t(offset + 44);
...
function UlDataencodesrsReceiveReqSubcell_t(msg, buf, off) {
    ...
    UlDataencodesrsBmStruct_t(msg.srsBmStruct, buf, off + 44);
}
...
function l2l1_decode_msg(l2l1) {
    ...
    case 0xE206: // UlData::PrachReceiveReq_t
        ...
        break;
    case 0xE207: // UlData::PucchReceiveReq_t
    ...
    case 0xE209: // UlData::PucchReceiveRespPs_t
        ...
        break;
    case 0xE20A: // UlData::PuschReceiveReq_t
    ...
    case 0xE20D: // UlData::PuschReceiveRespPs_t
        ...
        break;
    case 0xE20E: // UlData::SrsReceiveReq_t
...
function encodeStaticVariableSizedArray_uint8_4(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off);
    for (let i = 0; i < arr.length && i < 4; i++)
        l2l1_putU8(arr[i], buf, off + i * 1);
}
function decodeStaticVariableSizedArray_uint8_4(offset) {
    const result = [];
    const length = l2l1_getU32(offset);
...
function encodeStaticVariableSizedArray_antennaSnapshotFile_t_2(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off);
    for (let i = 0; i < arr.length && i < 2; i++)
        L1LogencodeantennaSnapshotFile_t(arr[i], buf, off + i * 92);
}
function decodeStaticVariableSizedArray_antennaSnapshotFile_t_2(offset) {
    const result = [];
    const length = l2l1_getU32(offset);
