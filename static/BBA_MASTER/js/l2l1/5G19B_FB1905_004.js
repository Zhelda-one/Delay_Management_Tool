...
/*    if (!(result.pdcchPrecodingOption2x2 === [object Object] || result.pdcchPrecodingOption2x2 === [object Object] || result.pdcchPrecodingOption2x2 === [object Object]))
        throw new Error(`Value ${result.pdcchPrecodingOption2x2} is out of range for enum 'pdcchPrecodingOption2x2_t'`); */
    Object.defineProperty(result, "__enum_pdcchPrecodingOption2x2", {
        enumerable: false,
        writable: false,
        value: "l1_common_pdcchPrecodingOption2x2_t",
    });
...
/*    if (!(result.numOfPdschSymbols === [object Object] || result.numOfPdschSymbols === [object Object] || result.numOfPdschSymbols === [object Object] || result.numOfPdschSymbols === [object Object] || result.numOfPdschSymbols === [object Object] || result.numOfPdschSymbols === [object Object] || result.numOfPdschSymbols === [object Object] || result.numOfPdschSymbols === [object Object] || result.numOfPdschSymbols === [object Object] || result.numOfPdschSymbols === [object Object]))
...
/*    if (!(result.modulationOrder === [object Object] || result.modulationOrder === [object Object] || result.modulationOrder === [object Object] || result.modulationOrder === [object Object]))
    ...
    result.padding_rbgSize = l2l1_getU8(offset + 69);
...
function DlDataencodePdschSendReq_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.padding_rbgSize, buf, off + 69);
...
/*    if (!(result.prachCohCombLen === [object Object] || result.prachCohCombLen === [object Object]))
    ...
    result.pucchHoppingId = l2l1_getU16(offset + 1276);
    result.dtxThresholdSrsTwoAntennaPorts = l2l1_getU16(offset + 1278);
...
/*    if (!(result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object]))
    ...
    result.eCpriLink = l2l1_getU8(offset + 1505);
/*    if (!(result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object]))
        throw new Error(`Value ${result.eCpriLink} is out of range for enum 'EECpriLink_t'`); */
    Object.defineProperty(result, "__enum_eCpriLink", {
        enumerable: false,
    ...
    result.numCeAxCId = l2l1_getU8(offset + 1506);
/*    if (!(result.numCeAxCId === [object Object] || result.numCeAxCId === [object Object]))
        throw new Error(`Value ${result.numCeAxCId} is out of range for enum 'numCeAxC_t'`); */
    Object.defineProperty(result, "__enum_numCeAxCId", {
        enumerable: false,
    ...
    result.ceAxCId = decodeStaticFixedSizedArray_uint16_4(offset + 1508);
    result.digitalOutputEnabled = l2l1_getU8(offset + 1516);
    result.digitalOutputType = l2l1_getU8(offset + 1517);
/*    if (!(result.digitalOutputType === [object Object] || result.digitalOutputType === [object Object]))
    ...
    result.digitalOutputRate = l2l1_getU8(offset + 1518);
/*    if (!(result.digitalOutputRate === [object Object] || result.digitalOutputRate === [object Object] || result.digitalOutputRate === [object Object]))
    ...
    result.bbSelector = l2l1_getU8(offset + 1519);
    result.frequencyShift7pt5khz = l2l1_getU8(offset + 1520);
...
function UlCellencodeSetupReq_t(msg, buf, off) {
    ...
    l2l1_putU16(msg.pucchHoppingId, buf, off + 1276);
    l2l1_putU16(msg.dtxThresholdSrsTwoAntennaPorts, buf, off + 1278);
    ...
    l2l1_putU8(msg.eCpriLink, buf, off + 1505);
    l2l1_putU8(msg.numCeAxCId, buf, off + 1506);
    encodeStaticFixedSizedArray_uint16_4(msg.ceAxCId, buf, off + 1508);
    l2l1_putU8(msg.digitalOutputEnabled, buf, off + 1516);
    l2l1_putU8(msg.digitalOutputType, buf, off + 1517);
    l2l1_putU8(msg.digitalOutputRate, buf, off + 1518);
    l2l1_putU8(msg.bbSelector, buf, off + 1519);
    l2l1_putU8(msg.frequencyShift7pt5khz, buf, off + 1520);
}
...
function l2l1_decode_msg(l2l1) {
    ...
    case 0x012C: // DlData::PdcchSendReq_t
        ...
        break;
    case 0x012F: // DlData::PdschSendReq_t
...
function l2l1_encode_msg(l2l1) {
    ...
    case 0x0203: // UlCell::DeleteResp_t
        ...
        break;
    case 0x0248: // UlCell::SetupReq_t
        buf.static = new Uint8Array(1524);
...
packetEnumMap = {
    ...
    l1_common_pdcchPrecodingOption2x2_t: {
