...
/*    if (!(result.fronthaulMode === [object Object] || result.fronthaulMode === [object Object] || result.fronthaulMode === [object Object] || result.fronthaulMode === [object Object]))
...
function L1Configdecodel1PoolConfiguration_t(offset) {
    ...
    result.l1SubPoolConfiguration = decodeDynamicVariableSizedArray_l1SubPoolConfiguration_t_2(offset + 4);

    return result;
}
function L1Configencodel1PoolConfiguration_t(msg, buf, off) {
    l2l1_putU32(msg.poolId, buf, off + 0);
    encodeDynamicVariableSizedArray_l1SubPoolConfiguration_t_2(msg.l1SubPoolConfiguration, buf, off + 4);
}
function L1ConfigdecodeL1Config_SwConfigurationReq_t(offset) {
    let result = {};
    ...
    result.l1PoolConfiguration = decodeDynamicVariableSizedArray_l1PoolConfiguration_t_1(offset + 8);

    return result;
}
function L1ConfigencodeL1Config_SwConfigurationReq_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_l1PoolConfiguration_t_1(msg.l1PoolConfiguration, buf, off + 8);
}
function L1Configdecodel1PoolConfiguration_t(offset) {
    let result = {};
...
/*    if (!(result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object]))
    ...
    result.l1SubPoolStatus = decodeDynamicVariableSizedArray_l1SubPoolStatus_t_2(offset + 8);
...
function L1Configencodel1PoolStatus_t(msg, buf, off) {
    l2l1_putU32(msg.poolId, buf, off + 0);
    l2l1_putU8(msg.status, buf, off + 4);
    encodeDynamicVariableSizedArray_l1SubPoolStatus_t_2(msg.l1SubPoolStatus, buf, off + 8);
}
function L1ConfigdecodeL1Config_SwConfigurationResp_t(offset) {
    let result = {};

    result.transactionId = l2l1_getU32(offset + 0);
    result.l1PoolStatus = decodeDynamicVariableSizedArray_l1PoolStatus_t_1(offset + 4);

    return result;
}
function L1ConfigencodeL1Config_SwConfigurationResp_t(msg, buf, off) {
    l2l1_putU32(msg.transactionId, buf, off + 0);
    encodeDynamicVariableSizedArray_l1PoolStatus_t_1(msg.l1PoolStatus, buf, off + 4);
}
function L1Configdecodel1PoolStatus_t(offset) {
    let result = {};
...
/*    if (!(result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object] || result.cpriLink === [object Object]))
    ...
    result.dfe_tx_delay = l2l1_getU32(offset + 4);
    result.dfe_rx_delay = l2l1_getU32(offset + 8);
    ...
    result.frameStart = l2l1_getI32(offset + 32);

    return result;
}
function L1CpriencodeDelayConfigReq_t(msg, buf, off) {
    l2l1_putU8(msg.cpriLink, buf, off + 0);
    l2l1_putU32(msg.dfe_tx_delay, buf, off + 4);
    l2l1_putU32(msg.dfe_rx_delay, buf, off + 8);
    ...
    l2l1_putI32(msg.frameStart, buf, off + 32);
}
...
/*    if (!(result.dlMimoMode === [object Object] || result.dlMimoMode === [object Object] || result.dlMimoMode === [object Object] || result.dlMimoMode === [object Object] || result.dlMimoMode === [object Object]))
...
/*    if (!(result.numCeAxCId === [object Object] || result.numCeAxCId === [object Object]))
    ...
    result.actBeamforming = l2l1_getU8(offset + 701);
    result.isLteCrsMappingEnable = l2l1_getU8(offset + 702);
    result.numLteCrsPorts = l2l1_getU8(offset + 703);
/*    if (!(result.numLteCrsPorts === [object Object] || result.numLteCrsPorts === [object Object] || result.numLteCrsPorts === [object Object]))
    ...
    result.reLteNuShift = l2l1_getU8(offset + 704);
    result.lteDlBandwidth = l2l1_getU8(offset + 705);
/*    if (!(result.lteDlBandwidth === [object Object] || result.lteDlBandwidth === [object Object] || result.lteDlBandwidth === [object Object] || result.lteDlBandwidth === [object Object]))
    ...
    result.actEcpriPhase2 = l2l1_getU8(offset + 706);
    result.cpriDialectIndication = l2l1_getU8(offset + 707);
/*    if (!(result.cpriDialectIndication === [object Object] || result.cpriDialectIndication === [object Object]))
    ...
    result.axcPosition = decodeStaticVariableSizedArray_uint32_4(offset + 708);
    result.dlEcpriFdBeamforming = l2l1_getU8(offset + 728);
    result.dlSubcellPoolId = l2l1_getU8(offset + 729);
    result.dlReferenceLevel = l2l1_getU16(offset + 730);
    result.actDlEcpriPhase4 = l2l1_getU8(offset + 732);
    result.actORANstep1 = l2l1_getU8(offset + 733);
    result.mantissaSize = l2l1_getU8(offset + 734);
/*    if (!(result.mantissaSize === [object Object] || result.mantissaSize === [object Object]))
    ...
    result.dlIqCompression = l2l1_getU8(offset + 735);
    result.dlActDownSampling = l2l1_getU8(offset + 736);
...
function DlCellencodeSetupReq_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.isLteCrsMappingEnable, buf, off + 702);
    l2l1_putU8(msg.numLteCrsPorts, buf, off + 703);
    l2l1_putU8(msg.reLteNuShift, buf, off + 704);
    l2l1_putU8(msg.lteDlBandwidth, buf, off + 705);
    l2l1_putU8(msg.actEcpriPhase2, buf, off + 706);
    l2l1_putU8(msg.cpriDialectIndication, buf, off + 707);
    encodeStaticVariableSizedArray_uint32_4(msg.axcPosition, buf, off + 708);
    l2l1_putU8(msg.dlEcpriFdBeamforming, buf, off + 728);
    l2l1_putU8(msg.dlSubcellPoolId, buf, off + 729);
    l2l1_putU16(msg.dlReferenceLevel, buf, off + 730);
    l2l1_putU8(msg.actDlEcpriPhase4, buf, off + 732);
    l2l1_putU8(msg.actORANstep1, buf, off + 733);
    l2l1_putU8(msg.mantissaSize, buf, off + 734);
    l2l1_putU8(msg.dlIqCompression, buf, off + 735);
    l2l1_putU8(msg.dlActDownSampling, buf, off + 736);
}
...
function l1_commondecodeL1DlAddresses(offset) {
    ...
    result.DlfastAntennaSnapshotReqAddress = l2l1_getU32(offset + 28);
...
function l1_commonencodeL1DlAddresses(msg, buf, off) {
    ...
    l2l1_putU32(msg.DlfastAntennaSnapshotReqAddress, buf, off + 28);
}
...
/*    if (!(result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object]))
...
/*    if (!(result.numStreamIndex === [object Object] || result.numStreamIndex === [object Object]))
...
/*    if (!(result.openLoopScheme === [object Object] || result.openLoopScheme === [object Object] || result.openLoopScheme === [object Object] || result.openLoopScheme === [object Object]))
    ...
    result.padding_bytes = l2l1_getU32(offset + 92);
...
function DlDataencodePdschGrant(msg, buf, off) {
    ...
    l2l1_putU32(msg.padding_bytes, buf, off + 92);
}
...
/*    if (!(result.csiRsPrecodingMatrix === [object Object] || result.csiRsPrecodingMatrix === [object Object]))
...
function DlDatadecodeCsiRsSendReq_t(offset) {
    ...
    result.sfn = l2l1_getU16(offset + 2);
    result.slot = l2l1_getU8(offset + 4);
    result.csiRsResources = decodeDynamicVariableSizedArray_CsiRsResource_t_20(offset + 8);
...
function DlDataencodeCsiRsSendReq_t(msg, buf, off) {
    ...
    l2l1_putU16(msg.sfn, buf, off + 2);
    l2l1_putU8(msg.slot, buf, off + 4);
    encodeDynamicVariableSizedArray_CsiRsResource_t_20(msg.csiRsResources, buf, off + 8);
}
...
function DlDatadecodeFastAntennaSnapshotReq_t(offset) {
    ...
    result.numDlSubCellId = l2l1_getU8(offset + 0);
    result.dlSubCellId = decodeStaticFixedSizedArray_uint8_4(offset + 4);
    result.numUlSubCellId = l2l1_getU8(offset + 8);
    result.ulSubCellId = decodeStaticFixedSizedArray_uint8_4(offset + 12);
    result.sfn = l2l1_getU16(offset + 16);
    result.slot = l2l1_getU8(offset + 18);
    result.numOfEvents = l2l1_getU8(offset + 19);
    result.eventsList = decodeStaticFixedSizedArray_FastAntennaSnapshotEventsList_t_8(offset + 20);

    return result;
}
function DlDataencodeFastAntennaSnapshotReq_t(msg, buf, off) {
    l2l1_putU8(msg.numDlSubCellId, buf, off + 0);
    encodeStaticFixedSizedArray_uint8_4(msg.dlSubCellId, buf, off + 4);
    l2l1_putU8(msg.numUlSubCellId, buf, off + 8);
    encodeStaticFixedSizedArray_uint8_4(msg.ulSubCellId, buf, off + 12);
    l2l1_putU16(msg.sfn, buf, off + 16);
    l2l1_putU8(msg.slot, buf, off + 18);
    l2l1_putU8(msg.numOfEvents, buf, off + 19);
    encodeStaticFixedSizedArray_FastAntennaSnapshotEventsList_t_8(msg.eventsList, buf, off + 20);
}
...
/*    if (!(result.measIntervalMsgRcv === [object Object] || result.measIntervalMsgRcv === [object Object] || result.measIntervalMsgRcv === [object Object] || result.measIntervalMsgRcv === [object Object] || result.measIntervalMsgRcv === [object Object] || result.measIntervalMsgRcv === [object Object] || result.measIntervalMsgRcv === [object Object] || result.measIntervalMsgRcv === [object Object]))
...
function L1ECpridecodeMsgRcvCountersInd_t(offset) {
    ...
    result.numOfItems = l2l1_getU32(offset + 0);
    result.MsgRcvCounters = decodeStaticVariableSizedArray_SMsgRcvCountersItem_16(offset + 8);

    return result;
}
function L1ECpriencodeMsgRcvCountersInd_t(msg, buf, off) {
    l2l1_putU32(msg.numOfItems, buf, off + 0);
    encodeStaticVariableSizedArray_SMsgRcvCountersItem_16(msg.MsgRcvCounters, buf, off + 8);
}
...
/*    if (!(result.reportType === [object Object] || result.reportType === [object Object] || result.reportType === [object Object] || result.reportType === [object Object]))
    ...
    result.fileList = decodeStaticVariableSizedArray_antennaSnapshotFile_t_32(offset + 12);
...
function L1LogencodeAntennaSnapshotInd_t(msg, buf, off) {
    ...
    encodeStaticVariableSizedArray_antennaSnapshotFile_t_32(msg.fileList, buf, off + 12);
}
function L1LogdecodeantennaSnapshotFile_t(offset) {
    let result = {};
...
function L1LogdecodeTraceReqHeader_t(offset) {
    ...
    result.lnCellId = l2l1_getU32(offset + 0);
    result.physCellId = l2l1_getU16(offset + 4);
...
function L1LogencodeTraceReqHeader_t(msg, buf, off) {
    l2l1_putU32(msg.lnCellId, buf, off + 0);
    l2l1_putU16(msg.physCellId, buf, off + 4);
...
function L1LogdecodeTraceReq_t(offset) {
    ...
    result.traces = decodeStaticVariableSizedArray_TraceReqEntry_t_10(offset + 16);

    return result;
}
function L1LogencodeTraceReq_t(msg, buf, off) {
    L1LogencodeTraceReqHeader_t(msg.header, buf, off + 0);
    encodeStaticVariableSizedArray_TraceReqEntry_t_10(msg.traces, buf, off + 16);
}
...
function L1LogdecodeAntennaSnapshotConfigurationReq_t(offset) {
    ...
    result.numDlSubCellId = l2l1_getU8(offset + 48);
    result.dlSubcellId = decodeStaticFixedSizedArray_uint8_4(offset + 52);
    result.AntSnapshotL1EventEnabled = l2l1_getU8(offset + 56);
/*    if (!(result.AntSnapshotL1EventEnabled === [object Object] || result.AntSnapshotL1EventEnabled === [object Object]))
...
function L1LogencodeAntennaSnapshotConfigurationReq_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.numDlSubCellId, buf, off + 48);
    encodeStaticFixedSizedArray_uint8_4(msg.dlSubcellId, buf, off + 52);
    l2l1_putU8(msg.AntSnapshotL1EventEnabled, buf, off + 56);
}
function L1LogdecodeAntennaSnapshotConfigurationResp_t(offset) {
    ...
    result.status = l2l1_getU8(offset + 0);
/*    if (!(result.status === [object Object] || result.status === [object Object]))
        throw new Error(`Value ${result.status} is out of range for enum 'EAntennaSnapshotConfigurationStatusType'`); */
    Object.defineProperty(result, "__enum_status", {
        enumerable: false,
        writable: false,
        value: "L1Log_EAntennaSnapshotConfigurationStatusType",
    });
...
/*    if (!(result.prachCohCombLen === [object Object] || result.prachCohCombLen === [object Object]))
    ...
    result.phaseCompensationLutIndex = decodeStaticFixedSizedArray_uint16_112(offset + 20);
    result.ulSubcellPosition = l2l1_getU8(offset + 244);
/*    if (!(result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object]))
    ...
    result.eCpriLink = l2l1_getU8(offset + 245);
/*    if (!(result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object] || result.eCpriLink === [object Object]))
        throw new Error(`Value ${result.eCpriLink} is out of range for enum 'EECpriLink_t'`); */
    Object.defineProperty(result, "__enum_eCpriLink", {
        enumerable: false,
    ...
    result.numCeAxCId = l2l1_getU8(offset + 246);
/*    if (!(result.numCeAxCId === [object Object] || result.numCeAxCId === [object Object] || result.numCeAxCId === [object Object]))
    ...
    result.ceAxCId = decodeStaticFixedSizedArray_uint16_8(offset + 248);
    result.digitalOutputEnabled = l2l1_getU8(offset + 264);
    result.digitalOutputType = l2l1_getU8(offset + 265);
/*    if (!(result.digitalOutputType === [object Object] || result.digitalOutputType === [object Object]))
    ...
    result.digitalOutputRate = l2l1_getU8(offset + 266);
/*    if (!(result.digitalOutputRate === [object Object] || result.digitalOutputRate === [object Object] || result.digitalOutputRate === [object Object]))
    ...
    result.bbSelector = l2l1_getU8(offset + 267);
    result.frequencyShift7pt5khz = l2l1_getU8(offset + 268);
    result.pfaTargetPrachId = l2l1_getU8(offset + 269);
    result.actEcpriPhase2 = l2l1_getU8(offset + 270);
    result.cpriDialectIndication = l2l1_getU8(offset + 271);
/*    if (!(result.cpriDialectIndication === [object Object] || result.cpriDialectIndication === [object Object]))
        throw new Error(`Value ${result.cpriDialectIndication} is out of range for enum 'cpriDialectIndication_t'`); */
    Object.defineProperty(result, "__enum_cpriDialectIndication", {
        enumerable: false,
    ...
    result.axcPosition = decodeStaticVariableSizedArray_uint32_4(offset + 272);
    result.prachConfigurationIndex = l2l1_getU8(offset + 292);
    result.prachPrbOffset = l2l1_getU16(offset + 294);
    result.ulEcpriFdBeamforming = l2l1_getU8(offset + 296);
    result.ulSubcellPoolId = l2l1_getU8(offset + 297);
    result.gainCorrection = l2l1_getI16(offset + 298);
    result.gainCorrectionForPrach = l2l1_getI16(offset + 300);
    result.actUlEcpriPhase4 = l2l1_getU8(offset + 302);
    result.prachDtxThresholdSelection = l2l1_getU8(offset + 303);
/*    if (!(result.prachDtxThresholdSelection === [object Object] || result.prachDtxThresholdSelection === [object Object]))
    ...
    result.actORANstep1 = l2l1_getU8(offset + 304);
    result.numberOfTRX = l2l1_getU8(offset + 305);
/*    if (!(result.numberOfTRX === [object Object] || result.numberOfTRX === [object Object] || result.numberOfTRX === [object Object] || result.numberOfTRX === [object Object]))
        throw new Error(`Value ${result.numberOfTRX} is out of range for enum 'numberOfTRX_t'`); */
    Object.defineProperty(result, "__enum_numberOfTRX", {
        enumerable: false,
        writable: false,
        value: "l1_common_numberOfTRX_t",
    });
    result.numberOfRowTRX = l2l1_getU8(offset + 306);
/*    if (!(result.numberOfRowTRX === [object Object] || result.numberOfRowTRX === [object Object] || result.numberOfRowTRX === [object Object]))
    ...
    result.ORANprachNumerology = l2l1_getU8(offset + 307);
    result.ulIqCompression = l2l1_getU8(offset + 308);
    result.ulActDownSampling = l2l1_getU8(offset + 309);
    result.mantissaSize = l2l1_getU8(offset + 310);
/*    if (!(result.mantissaSize === [object Object] || result.mantissaSize === [object Object]))
        throw new Error(`Value ${result.mantissaSize} is out of range for enum 'mantissaSize_t'`); */
    Object.defineProperty(result, "__enum_mantissaSize", {
        enumerable: false,
    ...
    result.staticLongPucch = l2l1_getU8(offset + 311);
...
function UlCellencodeSetupReq_t(msg, buf, off) {
    ...
    encodeStaticFixedSizedArray_uint16_112(msg.phaseCompensationLutIndex, buf, off + 20);
    l2l1_putU8(msg.ulSubcellPosition, buf, off + 244);
    l2l1_putU8(msg.eCpriLink, buf, off + 245);
    l2l1_putU8(msg.numCeAxCId, buf, off + 246);
    encodeStaticFixedSizedArray_uint16_8(msg.ceAxCId, buf, off + 248);
    l2l1_putU8(msg.digitalOutputEnabled, buf, off + 264);
    l2l1_putU8(msg.digitalOutputType, buf, off + 265);
    l2l1_putU8(msg.digitalOutputRate, buf, off + 266);
    l2l1_putU8(msg.bbSelector, buf, off + 267);
    l2l1_putU8(msg.frequencyShift7pt5khz, buf, off + 268);
    l2l1_putU8(msg.pfaTargetPrachId, buf, off + 269);
    l2l1_putU8(msg.actEcpriPhase2, buf, off + 270);
    l2l1_putU8(msg.cpriDialectIndication, buf, off + 271);
    encodeStaticVariableSizedArray_uint32_4(msg.axcPosition, buf, off + 272);
    l2l1_putU8(msg.prachConfigurationIndex, buf, off + 292);
    l2l1_putU16(msg.prachPrbOffset, buf, off + 294);
    l2l1_putU8(msg.ulEcpriFdBeamforming, buf, off + 296);
    l2l1_putU8(msg.ulSubcellPoolId, buf, off + 297);
    l2l1_putI16(msg.gainCorrection, buf, off + 298);
    l2l1_putI16(msg.gainCorrectionForPrach, buf, off + 300);
    l2l1_putU8(msg.actUlEcpriPhase4, buf, off + 302);
    l2l1_putU8(msg.prachDtxThresholdSelection, buf, off + 303);
    l2l1_putU8(msg.actORANstep1, buf, off + 304);
    l2l1_putU8(msg.numberOfTRX, buf, off + 305);
    l2l1_putU8(msg.numberOfRowTRX, buf, off + 306);
    l2l1_putU8(msg.ORANprachNumerology, buf, off + 307);
    l2l1_putU8(msg.ulIqCompression, buf, off + 308);
    l2l1_putU8(msg.ulActDownSampling, buf, off + 309);
    l2l1_putU8(msg.mantissaSize, buf, off + 310);
    l2l1_putU8(msg.staticLongPucch, buf, off + 311);
}
...
/*    if (!(result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object]))
    ...
    result.data = decodeDynamicVariableSizedArray_uint8_50205(offset + 16);
...
function UlDataencodePuschReceiveRespLo_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_uint8_50205(msg.data, buf, off + 16);
}
...
function l1_commondecodeL1UlAddresses(offset) {
    ...
    result.UlfastAntennaSnapshotReqAddress = l2l1_getU32(offset + 16);
...
function l1_commonencodeL1UlAddresses(msg, buf, off) {
    ...
    l2l1_putU32(msg.UlfastAntennaSnapshotReqAddress, buf, off + 16);
}
...
/*    if (!(result.ulRank === [object Object] || result.ulRank === [object Object] || result.ulRank === [object Object]))
    ...
    result.uciCsiPart1Bits = decodeStaticFixedSizedArray_uint8_6(offset + 72);
    result.csiPart1CrcCheck = l2l1_getU8(offset + 76);
/*    if (!(result.csiPart1CrcCheck === [object Object] || result.csiPart1CrcCheck === [object Object]))
    ...
    result.numOfUciCsiPart2Bits = l2l1_getU8(offset + 77);
    result.uciCsiPart2Bits = decodeStaticFixedSizedArray_uint8_2(offset + 80);
    result.csiPart2CrcCheck = l2l1_getU8(offset + 80);
/*    if (!(result.csiPart2CrcCheck === [object Object] || result.csiPart2CrcCheck === [object Object]))
    ...
    result.dtxCsiPart1 = l2l1_getU8(offset + 81);
    result.dtxMetricCsiPart1 = l2l1_getU16(offset + 82);
    result.dtxThresholdCsiPart1 = l2l1_getU16(offset + 84);
    result.dtxCsiPart2 = l2l1_getU8(offset + 86);
    result.dtxMetricCsiPart2 = l2l1_getU16(offset + 88);
    result.dtxThresholdCsiPart2 = l2l1_getU16(offset + 90);
    result.rssiOfAnt = decodeStaticFixedSizedArray_float32_4(offset + 92);
    result.rxPowerOfAnt = decodeStaticFixedSizedArray_float32_4(offset + 108);
    result.sinrOfAnt = decodeStaticFixedSizedArray_float32_4(offset + 124);
    result.shortTermTaMetricOfAnt = decodeStaticFixedSizedArray_int16_4(offset + 140);
    result.shortTermTaPeakAmpOfAnt = decodeStaticFixedSizedArray_float32_4(offset + 148);
    result.shortTermCfoMetricOfAnt = decodeStaticFixedSizedArray_shortTermCfoMetric_t_4(offset + 164);
...
function UlDataencodeUePuschReceiveRespPs_t(msg, buf, off) {
    ...
    encodeStaticFixedSizedArray_uint8_6(msg.uciCsiPart1Bits, buf, off + 72);
    l2l1_putU8(msg.csiPart1CrcCheck, buf, off + 76);
    l2l1_putU8(msg.numOfUciCsiPart2Bits, buf, off + 77);
    encodeStaticFixedSizedArray_uint8_2(msg.uciCsiPart2Bits, buf, off + 80);
    l2l1_putU8(msg.csiPart2CrcCheck, buf, off + 80);
    l2l1_putU8(msg.dtxCsiPart1, buf, off + 81);
    l2l1_putU16(msg.dtxMetricCsiPart1, buf, off + 82);
    l2l1_putU16(msg.dtxThresholdCsiPart1, buf, off + 84);
    l2l1_putU8(msg.dtxCsiPart2, buf, off + 86);
    l2l1_putU16(msg.dtxMetricCsiPart2, buf, off + 88);
    l2l1_putU16(msg.dtxThresholdCsiPart2, buf, off + 90);
    encodeStaticFixedSizedArray_float32_4(msg.rssiOfAnt, buf, off + 92);
    encodeStaticFixedSizedArray_float32_4(msg.rxPowerOfAnt, buf, off + 108);
    encodeStaticFixedSizedArray_float32_4(msg.sinrOfAnt, buf, off + 124);
    encodeStaticFixedSizedArray_int16_4(msg.shortTermTaMetricOfAnt, buf, off + 140);
    encodeStaticFixedSizedArray_float32_4(msg.shortTermTaPeakAmpOfAnt, buf, off + 148);
    encodeStaticFixedSizedArray_shortTermCfoMetric_t_4(msg.shortTermCfoMetricOfAnt, buf, off + 164);
}
function UlDatadecodepuschReceiveRespPsSubcell_t(offset) {
    ...
    result.rtwpOfAnt = decodeStaticFixedSizedArray_float32_4(offset + 8);
...
function UlDataencodepuschReceiveRespPsSubcell_t(msg, buf, off) {
    ...
    encodeStaticFixedSizedArray_float32_4(msg.rtwpOfAnt, buf, off + 8);
...
function UlDatadecodecsiReportStruct_t(offset) {
    ...
    result.riUsageMap = l2l1_getU8(offset + 1);
    result.csiPart1Only = l2l1_getU8(offset + 2);
    result.numOfWidebandCsiPart2BitsRi1 = l2l1_getU8(offset + 3);
    result.numOfWidebandCsiPart2BitsRi2 = l2l1_getU8(offset + 4);
    result.numOfWidebandCsiPart2BitsRi3 = l2l1_getU8(offset + 5);
    result.numOfWidebandCsiPart2BitsRi4 = l2l1_getU8(offset + 6);
...
function UlDataencodecsiReportStruct_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.riUsageMap, buf, off + 1);
    l2l1_putU8(msg.csiPart1Only, buf, off + 2);
    l2l1_putU8(msg.numOfWidebandCsiPart2BitsRi1, buf, off + 3);
    l2l1_putU8(msg.numOfWidebandCsiPart2BitsRi2, buf, off + 4);
    l2l1_putU8(msg.numOfWidebandCsiPart2BitsRi3, buf, off + 5);
    l2l1_putU8(msg.numOfWidebandCsiPart2BitsRi4, buf, off + 6);
...
/*    if (!(result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object]))
    ...
    result.maxNumOfUciCsiPart2Symbols = l2l1_getU16(offset + 40);
    result.maxNumOfUciCsiPart2BitsPlusCrc = l2l1_getU16(offset + 42);
    result.numOfUciAckBits = l2l1_getU8(offset + 44);
    result.numOfUciAckSymbols = l2l1_getU16(offset + 46);
    result.numOfUciAckSymbols1bit = l2l1_getU16(offset + 48);
    result.uciOnly = l2l1_getU8(offset + 50);
    result.csiPart2CodeRate = l2l1_getF32(offset + 52);
    result.csiReportStruct = decodeDynamicVariableSizedArray_csiReportStruct_t_8(offset + 56);
    result.longTermCfoMetric = l1_commondecodelongTermCfoMetric_t(offset + 64);
    result.foeValid = l2l1_getU8(offset + 72);
    result.baseGraph = l2l1_getU8(offset + 73);
/*    if (!(result.baseGraph === [object Object] || result.baseGraph === [object Object]))
        throw new Error(`Value ${result.baseGraph} is out of range for enum 'ldpcBaseGraph_t'`); */
    Object.defineProperty(result, "__enum_baseGraph", {
        enumerable: false,
    ...
    result.numOfCodeBlocks = l2l1_getU8(offset + 74);
    result.codeBlockSize = l2l1_getU16(offset + 76);
    result.numOfFillerBits = l2l1_getU16(offset + 78);
    result.liftSize = l2l1_getU16(offset + 80);
    result.liftSizeSetIndex = l2l1_getU8(offset + 82);
    result.liftSizeColumnIndex = l2l1_getU8(offset + 83);
    result.modulationOrder = l2l1_getU8(offset + 84);
/*    if (!(result.modulationOrder === [object Object] || result.modulationOrder === [object Object] || result.modulationOrder === [object Object] || result.modulationOrder === [object Object]))
        throw new Error(`Value ${result.modulationOrder} is out of range for enum 'modulationOrder_t'`); */
    Object.defineProperty(result, "__enum_modulationOrder", {
        enumerable: false,
    ...
    result.rvIndex = l2l1_getU8(offset + 85);
    result.ncb = l2l1_getU16(offset + 86);
    result.k0divZ = l2l1_getU8(offset + 88);
    result.numOfLayers = l2l1_getU8(offset + 89);
    result.puschTransCoherence = l2l1_getU8(offset + 90);
/*    if (!(result.puschTransCoherence === [object Object] || result.puschTransCoherence === [object Object] || result.puschTransCoherence === [object Object]))
    ...
    result.eCpriConfigStruct = UlDatadecodeeCpriConfigStruct_t(offset + 92);
    result.numOfDmrsCdmGroupWithoutData = l2l1_getU8(offset + 104);
    result.l2CtxtAnMgt = decodeStaticFixedSizedArray_uint8_8(offset + 108);
    result.eCpriSectionId = l2l1_getU16(offset + 116);
    result.longTermCfoMetricOfAnt = decodeStaticFixedSizedArray_longTermCfoMetric_t_4(offset + 120);
...
function UlDataencodepuschReceiveReqGrant_t(msg, buf, off) {
    ...
    l2l1_putU16(msg.maxNumOfUciCsiPart2Symbols, buf, off + 40);
    l2l1_putU16(msg.maxNumOfUciCsiPart2BitsPlusCrc, buf, off + 42);
    l2l1_putU8(msg.numOfUciAckBits, buf, off + 44);
    l2l1_putU16(msg.numOfUciAckSymbols, buf, off + 46);
    l2l1_putU16(msg.numOfUciAckSymbols1bit, buf, off + 48);
    l2l1_putU8(msg.uciOnly, buf, off + 50);
    l2l1_putF32(msg.csiPart2CodeRate, buf, off + 52);
    encodeDynamicVariableSizedArray_csiReportStruct_t_8(msg.csiReportStruct, buf, off + 56);
    l1_commonencodelongTermCfoMetric_t(msg.longTermCfoMetric, buf, off + 64);
    l2l1_putU8(msg.foeValid, buf, off + 72);
    l2l1_putU8(msg.baseGraph, buf, off + 73);
    l2l1_putU8(msg.numOfCodeBlocks, buf, off + 74);
    l2l1_putU16(msg.codeBlockSize, buf, off + 76);
    l2l1_putU16(msg.numOfFillerBits, buf, off + 78);
    l2l1_putU16(msg.liftSize, buf, off + 80);
    l2l1_putU8(msg.liftSizeSetIndex, buf, off + 82);
    l2l1_putU8(msg.liftSizeColumnIndex, buf, off + 83);
    l2l1_putU8(msg.modulationOrder, buf, off + 84);
    l2l1_putU8(msg.rvIndex, buf, off + 85);
    l2l1_putU16(msg.ncb, buf, off + 86);
    l2l1_putU8(msg.k0divZ, buf, off + 88);
    l2l1_putU8(msg.numOfLayers, buf, off + 89);
    l2l1_putU8(msg.puschTransCoherence, buf, off + 90);
    UlDataencodeeCpriConfigStruct_t(msg.eCpriConfigStruct, buf, off + 92);
    l2l1_putU8(msg.numOfDmrsCdmGroupWithoutData, buf, off + 104);
    encodeStaticFixedSizedArray_uint8_8(msg.l2CtxtAnMgt, buf, off + 108);
    l2l1_putU16(msg.eCpriSectionId, buf, off + 116);
    encodeStaticFixedSizedArray_longTermCfoMetric_t_4(msg.longTermCfoMetricOfAnt, buf, off + 120);
}
...
/*    if (!(result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object]))
    ...
    result.ceAxCIndex = decodeStaticFixedSizedArray_uint8_4(offset + 28);
    result.patternId = decodeStaticFixedSizedArray_uint16_2(offset + 32);
    result.startSymbol = l2l1_getU8(offset + 36);
/*    if (!(result.startSymbol === [object Object]))
    ...
    result.numSymbols = l2l1_getU8(offset + 37);
...
function UlDataencodestaticLongPucchConfigEcpri_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.numCeAxCIndex, buf, off + 24);
    encodeStaticFixedSizedArray_uint8_4(msg.ceAxCIndex, buf, off + 28);
    encodeStaticFixedSizedArray_uint16_2(msg.patternId, buf, off + 32);
    l2l1_putU8(msg.startSymbol, buf, off + 36);
    l2l1_putU8(msg.numSymbols, buf, off + 37);
}
...
/*    if (!(result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object]))
    ...
    result.ceAxCIndex = decodeStaticFixedSizedArray_uint8_4(offset + 28);
    result.patternId = decodeStaticFixedSizedArray_uint16_2(offset + 32);
    result.modulationType = l2l1_getU8(offset + 36);
/*    if (!(result.modulationType === [object Object] || result.modulationType === [object Object]))
    ...
    result.longTermCfoMetric = l1_commondecodelongTermCfoMetric_t(offset + 40);
    result.l2CtxtAnMgt = decodeStaticFixedSizedArray_uint8_8(offset + 48);
    result.eCpriSectionId = decodeStaticFixedSizedArray_uint16_2(offset + 56);
    result.longTermCfoMetricOfAnt = decodeStaticFixedSizedArray_longTermCfoMetric_t_4(offset + 60);
...
function UlDataencodepucchReceiveReqPucchResource_t(msg, buf, off) {
    ...
    encodeStaticFixedSizedArray_uint8_4(msg.ceAxCIndex, buf, off + 28);
    encodeStaticFixedSizedArray_uint16_2(msg.patternId, buf, off + 32);
    l2l1_putU8(msg.modulationType, buf, off + 36);
    l1_commonencodelongTermCfoMetric_t(msg.longTermCfoMetric, buf, off + 40);
    encodeStaticFixedSizedArray_uint8_8(msg.l2CtxtAnMgt, buf, off + 48);
    encodeStaticFixedSizedArray_uint16_2(msg.eCpriSectionId, buf, off + 56);
    encodeStaticFixedSizedArray_longTermCfoMetric_t_4(msg.longTermCfoMetricOfAnt, buf, off + 60);
}
function UlDatadecodepucchReceiveReqSubcell_t(offset) {
    ...
    result.pucchResources = decodeDynamicVariableSizedArray_pucchReceiveReqPucchResource_t_176(offset + 48);
...
function UlDataencodepucchReceiveReqSubcell_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_pucchReceiveReqPucchResource_t_176(msg.pucchResources, buf, off + 48);
}
function UlDatadecodepucchReceiveReqPucchResource_t(offset) {
    let result = {};
...
/*    if (!(result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object]))
    ...
    result.uciBits = decodeStaticFixedSizedArray_uint8_7(offset + 32);
...
function UlDataencodepucchReceiveRespPsPucchResource_t(msg, buf, off) {
    ...
    encodeStaticFixedSizedArray_uint8_7(msg.uciBits, buf, off + 32);
...
function UlDatadecodepucchReceiveRespPsSubcell_t(offset) {
    ...
    result.subcellId = l2l1_getU8(offset + 0);
    result.pucchResources = decodeDynamicVariableSizedArray_pucchReceiveRespPsPucchResource_t_176(offset + 4);

    return result;
}
function UlDataencodepucchReceiveRespPsSubcell_t(msg, buf, off) {
    l2l1_putU8(msg.subcellId, buf, off + 0);
    encodeDynamicVariableSizedArray_pucchReceiveRespPsPucchResource_t_176(msg.pucchResources, buf, off + 4);
}
function UlDatadecodepucchReceiveRespPsPucchResource_t(offset) {
    let result = {};
...
function UlDatadecodePucchReceiveRespPs_t(offset) {
    ...
    result.slotForProcessing = l2l1_getU8(offset + 6);
    result.bcn_reservation_for_debug = l2l1_getU8(offset + 7);
    result.subcells = decodeDynamicVariableSizedArray_pucchReceiveRespPsSubcell_t_4(offset + 8);
...
function UlDataencodePucchReceiveRespPs_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.slotForProcessing, buf, off + 6);
    l2l1_putU8(msg.bcn_reservation_for_debug, buf, off + 7);
    encodeDynamicVariableSizedArray_pucchReceiveRespPsSubcell_t_4(msg.subcells, buf, off + 8);
}
...
function UlDatadecodepucchReceiveRespHarqDSubcell_t(offset) {
    ...
    result.subcellId = l2l1_getU8(offset + 0);
    result.pucchResources = decodeDynamicVariableSizedArray_pucchReceiveRespHarqDPucchResource_t_176(offset + 4);

    return result;
}
function UlDataencodepucchReceiveRespHarqDSubcell_t(msg, buf, off) {
    l2l1_putU8(msg.subcellId, buf, off + 0);
    encodeDynamicVariableSizedArray_pucchReceiveRespHarqDPucchResource_t_176(msg.pucchResources, buf, off + 4);
}
function UlDatadecodepucchReceiveRespHarqDPucchResource_t(offset) {
    let result = {};
...
function UlDatadecodePucchReceiveRespHarqD_t(offset) {
    ...
    result.sfnForProcessing = l2l1_getU16(offset + 4);
    result.slotForProcessing = l2l1_getU8(offset + 6);
    result.subcells = decodeDynamicVariableSizedArray_pucchReceiveRespHarqDSubcell_t_4(offset + 8);
...
function UlDataencodePucchReceiveRespHarqD_t(msg, buf, off) {
    ...
    l2l1_putU16(msg.sfnForProcessing, buf, off + 4);
    l2l1_putU8(msg.slotForProcessing, buf, off + 6);
    encodeDynamicVariableSizedArray_pucchReceiveRespHarqDSubcell_t_4(msg.subcells, buf, off + 8);
}
...
function UlDatadecodesrsReceiveReqBands_t(offset) {
    let result = {};

    result.eCpriSectionId = l2l1_getU16(offset + 0);

    return result;
}
function UlDataencodesrsReceiveReqBands_t(msg, buf, off) {
    l2l1_putU16(msg.eCpriSectionId, buf, off + 0);
}
...
/*    if (!(result.numOfSrsPorts === [object Object] || result.numOfSrsPorts === [object Object] || result.numOfSrsPorts === [object Object]))
    ...
    result.numCeAxCIndex = l2l1_getU8(offset + 20);
/*    if (!(result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object]))
        throw new Error(`Value ${result.numCeAxCIndex} is out of range for enum 'numCeAxC_t'`); */
    Object.defineProperty(result, "__enum_numCeAxCIndex", {
        enumerable: false,
    ...
    result.ceAxCIndex = decodeStaticFixedSizedArray_uint8_4(offset + 24);
    result.patternId = decodeStaticFixedSizedArray_uint16_2(offset + 28);
    result.powerOffsetSrsToPuschPerAllocatedRe = l2l1_getF32(offset + 32);
    result.puschTransCoherence = l2l1_getU8(offset + 36);
/*    if (!(result.puschTransCoherence === [object Object] || result.puschTransCoherence === [object Object] || result.puschTransCoherence === [object Object]))
        throw new Error(`Value ${result.puschTransCoherence} is out of range for enum 'puschTransCoherence_t'`); */
    Object.defineProperty(result, "__enum_puschTransCoherence", {
        enumerable: false,
    ...
    result.srsReceiveReqBands = decodeDynamicVariableSizedArray_srsReceiveReqBands_t_68(offset + 40);
...
function UlDataencodesrsSuMimoStruct_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.numCeAxCIndex, buf, off + 20);
    encodeStaticFixedSizedArray_uint8_4(msg.ceAxCIndex, buf, off + 24);
    encodeStaticFixedSizedArray_uint16_2(msg.patternId, buf, off + 28);
    l2l1_putF32(msg.powerOffsetSrsToPuschPerAllocatedRe, buf, off + 32);
    l2l1_putU8(msg.puschTransCoherence, buf, off + 36);
    encodeDynamicVariableSizedArray_srsReceiveReqBands_t_68(msg.srsReceiveReqBands, buf, off + 40);
}
function UlDatadecodesrsBmCombShiftPairs_t(offset) {
    let result = {};

    result.bmComb = l2l1_getU8(offset + 0);
    result.bmCyclicShift = l2l1_getU8(offset + 1);

    return result;
}
function UlDataencodesrsBmCombShiftPairs_t(msg, buf, off) {
    l2l1_putU8(msg.bmComb, buf, off + 0);
    l2l1_putU8(msg.bmCyclicShift, buf, off + 1);
}
function UlDatadecodesrsBmSubbands_t(offset) {
    let result = {};

    result.srsBmCombsShifts = decodeDynamicVariableSizedArray_srsBmCombShiftPairs_t_16(offset + 0);
...
function UlDataencodesrsBmSubbands_t(msg, buf, off) {
    encodeDynamicVariableSizedArray_srsBmCombShiftPairs_t_16(msg.srsBmCombsShifts, buf, off + 0);
...
/*    if (!(result.transmissionComb === [object Object] || result.transmissionComb === [object Object]))
    ...
    result.bmSubbands = decodeDynamicVariableSizedArray_srsBmSubbands_t_8(offset + 8);
...
function UlDataencodesrsBmStruct_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_srsBmSubbands_t_8(msg.bmSubbands, buf, off + 8);
}
function UlDatadecodesrsReceiveReqSubcell_t(offset) {
    ...
    result.srsSuMimoStruct = UlDatadecodesrsSuMimoStruct_t(offset + 4);
    result.srsBmStruct = UlDatadecodesrsBmStruct_t(offset + 52);
...
function UlDataencodesrsReceiveReqSubcell_t(msg, buf, off) {
    ...
    UlDataencodesrsSuMimoStruct_t(msg.srsSuMimoStruct, buf, off + 4);
    UlDataencodesrsBmStruct_t(msg.srsBmStruct, buf, off + 52);
}
function UlDatadecodeSrsReceiveReq_t(offset) {
    ...
    result.sfn = l2l1_getU16(offset + 8);
    result.slot = l2l1_getU8(offset + 10);
    result.subcells = decodeDynamicVariableSizedArray_srsReceiveReqSubcell_t_4(offset + 12);
...
function UlDataencodeSrsReceiveReq_t(msg, buf, off) {
    ...
    l2l1_putU16(msg.sfn, buf, off + 8);
    l2l1_putU8(msg.slot, buf, off + 10);
    encodeDynamicVariableSizedArray_srsReceiveReqSubcell_t_4(msg.subcells, buf, off + 12);
}
function UlDatadecodesrsReceiveReqSubcell_t(offset) {
    let result = {};
...
/*    if (!(result.dtx === [object Object] || result.dtx === [object Object]))
    ...
    result.numOfSrsTxPorts = l2l1_getU8(offset + 36);
    result.rxPowerOfAnt = decodeStaticFixedSizedArray_float32_4(offset + 40);
    result.sinrOfAnt = decodeStaticFixedSizedArray_float32_4(offset + 56);
    result.shortTermTaMetricOfAnt = decodeStaticFixedSizedArray_int16_4(offset + 72);
    result.shortTermTaPeakAmpOfAnt = decodeStaticFixedSizedArray_float32_4(offset + 80);
...
function UlDataencodesrsReceiveRespPsSubcell_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.numOfSrsTxPorts, buf, off + 36);
    encodeStaticFixedSizedArray_float32_4(msg.rxPowerOfAnt, buf, off + 40);
    encodeStaticFixedSizedArray_float32_4(msg.sinrOfAnt, buf, off + 56);
    encodeStaticFixedSizedArray_int16_4(msg.shortTermTaMetricOfAnt, buf, off + 72);
    encodeStaticFixedSizedArray_float32_4(msg.shortTermTaPeakAmpOfAnt, buf, off + 80);
}
...
function UlDatadecodeSrsReceiveRespBmPs_t(offset) {
    ...
    result.feScalingFactor = decodeStaticFixedSizedArray_uint32_8(offset + 8);
    result.data = decodeDynamicVariableSizedArray_uint8_4608(offset + 40);
    result.PaddingBytes = decodeStaticFixedSizedArray_uint8_8(offset + 48);
...
function UlDataencodeSrsReceiveRespBmPs_t(msg, buf, off) {
    ...
    encodeStaticFixedSizedArray_uint32_8(msg.feScalingFactor, buf, off + 8);
    encodeDynamicVariableSizedArray_uint8_4608(msg.data, buf, off + 40);
    encodeStaticFixedSizedArray_uint8_8(msg.PaddingBytes, buf, off + 48);
}
function l1_commondecodeFastAntennaSnapshotEventsList_t(offset) {
    let result = {};
...
function l2l1_decode_msg(l2l1) {
    ...
    case 0xe3f0: // L1Config::L1Config_SwConfigurationReq_t
        result = L1ConfigdecodeL1Config_SwConfigurationReq_t(0);
        break;
    case 0xe3f1: // L1Config::L1Config_SwConfigurationResp_t
        result = L1ConfigdecodeL1Config_SwConfigurationResp_t(0);
        break;
    ...
    case 0x0a16: // L1Cpri::GetLinkParamResp_t
        ...
        break;
    case 0x0a41: // L1Cpri::DelayConfigReq_t
    ...
    case 0x0a40: // L1ECpri::MsgRcvCountersInd_t
        ...
        break;
    case 0xe302: // L1ECpri::DelayConfigReq_t
    ...
    case 0x0203: // UlCell::DeleteResp_t
        ...
        break;
    case 0xE219: // UlCell::SetupReq_t
        result = UlCelldecodeSetupReq_t(0);
        break;
    case 0xE20C: // UlData::PuschReceiveRespLo_t
    ...
    case 0x0243: // UlData::AddressReq_t
        ...
        break;
    case 0x024B: // UlData::SrsReceiveRespBmPs_t
    ...
    case 0xE205: // UlData::PrachReceiveInd_t
        result = UlDatadecodePrachReceiveInd_t(0);
        break;
    case 0xE206: // UlData::PrachReceiveReq_t
    ...
    case 0xE20B: // UlData::PuschReceiveRespHarqU_t
        ...
        break;
    case 0xE218: // UlData::SrsReceiveReq_t
        result = UlDatadecodeSrsReceiveReq_t(0);
        break;
    case 0xE21A: // UlData::AddressResp_t
        result = UlDatadecodeAddressResp_t(0);
        break;
    case 0xE21B: // UlData::FastAntennaSnapshotReq_t
...
function l2l1_encode_msg(l2l1) {
    ...
    case 0xe3f0: // L1Config::L1Config_SwConfigurationReq_t
        ...
        L1ConfigencodeL1Config_SwConfigurationReq_t(l2l1, buf, 0);
        break;
    case 0xe3f1: // L1Config::L1Config_SwConfigurationResp_t
        buf.static = new Uint8Array(12);
        L1ConfigencodeL1Config_SwConfigurationResp_t(l2l1, buf, 0);
        break;
    case 0x0a00: // L1Cpri::AlarmInd_t
...
function encodeStaticFixedSizedArray_uint8_6(arr, buf, off) {
    for (let i = 0; i < 6; i++)
        l2l1_putU8(arr[i], buf, off + i * 1);
}
function decodeStaticFixedSizedArray_uint8_6(offset) {
    const result = [];
    for (let i = 0; i < 6; i++)
        result.push(l2l1_getU8(offset + i * 1));
    return result;
...
function encodeStaticFixedSizedArray_int16_4(arr, buf, off) {
    for (let i = 0; i < 4; i++)
        l2l1_putI16(arr[i], buf, off + i * 2);
}
function decodeStaticFixedSizedArray_int16_4(offset) {
    const result = [];
    for (let i = 0; i < 4; i++)
        result.push(l2l1_getI16(offset + i * 2));
    return result;
}
function encodeStaticFixedSizedArray_shortTermCfoMetric_t_4(arr, buf, off) {
    for (let i = 0; i < 4; i++)
        l1_commonencodeshortTermCfoMetric_t(arr[i], buf, off + i * 8);
}
function decodeStaticFixedSizedArray_shortTermCfoMetric_t_4(offset) {
    const result = [];
    for (let i = 0; i < 4; i++)
...
function encodeStaticVariableSizedArray_SMsgRcvCountersItem_16(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off);
    for (let i = 0; i < arr.length && i < 16; i++)
        L1ECpriencodeSMsgRcvCountersItem(arr[i], buf, off + i * 56);
}
function decodeStaticVariableSizedArray_SMsgRcvCountersItem_16(offset) {
    const result = [];
    const length = l2l1_getU32(offset);
    for (let i = 0; i < length && i < 16; i++)
...
function encodeStaticVariableSizedArray_antennaSnapshotFile_t_32(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off);
    for (let i = 0; i < arr.length && i < 32; i++)
        L1LogencodeantennaSnapshotFile_t(arr[i], buf, off + i * 92);
}
function decodeStaticVariableSizedArray_antennaSnapshotFile_t_32(offset) {
    const result = [];
    const length = l2l1_getU32(offset);
...
function encodeDynamicVariableSizedArray_l1SubPoolConfiguration_t_2(arr, buf, off) {
...
function decodeDynamicVariableSizedArray_l1SubPoolConfiguration_t_2(offset) {
...
function encodeDynamicVariableSizedArray_l1PoolConfiguration_t_1(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_l1PoolConfiguration_t_1(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_l1SubPoolStatus_t_2(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_l1SubPoolStatus_t_2(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_l1PoolStatus_t_1(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_l1PoolStatus_t_1(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_uint8_4608(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_uint8_4608(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_CsiRsResource_t_20(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_CsiRsResource_t_20(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_pucchReceiveReqPucchResource_t_176(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_pucchReceiveReqPucchResource_t_176(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_pucchReceiveRespPsPucchResource_t_176(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_pucchReceiveRespPsPucchResource_t_176(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_pucchReceiveRespHarqDPucchResource_t_176(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_pucchReceiveRespHarqDPucchResource_t_176(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_srsReceiveReqBands_t_68(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        UlDataencodesrsReceiveReqBands_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_srsReceiveReqBands_t_68(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(UlDatadecodesrsReceiveReqBands_t(offset));
        offset += 2;
    }

    return result;
}
function encodeDynamicVariableSizedArray_srsBmCombShiftPairs_t_16(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_srsBmCombShiftPairs_t_16(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_srsBmSubbands_t_8(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_srsBmSubbands_t_8(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
packetPropToStrMap["l2l1.message"] = {
    ...
    0x0131: "DlData::CsiRsSendReq",
    0x0133: "DlData::PdcchSendReq",
    0xE101: "DlData::PatternConfigReq",
    0xE105: "DlData::SsBlockSendReq",
    0xE107: "DlData::PdschSendReq",
    0xE10A: "DlData::AddressResp",
    0xE10B: "DlData::FastAntennaSnapshotReq",
    ...
    0xE219: "UlCell::SetupReq",
    0xE20C: "UlData::PuschReceiveRespLo",
    ...
    0xE206: "UlData::PrachReceiveReq",
    0xE208: "UlData::PucchReceiveRespHarqD",
    0xE20B: "UlData::PuschReceiveRespHarqU",
    0xE218: "UlData::SrsReceiveReq",
    0xE21A: "UlData::AddressResp",
    0xE21B: "UlData::FastAntennaSnapshotReq",
    0xE21C: "UlData::FastAntennaSnapshotResp",
    0xE21E: "UlData::PuschReceiveReq",
    0xE21F: "UlData::PuschReceiveRespPs",
    0xE221: "UlData::SrsReceiveRespPs",
    0xE222: "UlData::PucchReceiveRespPs",
    0xE223: "UlData::PucchReceiveReq",
};
...
packetEnumMap = {
    ...
    l1_common_numberOfTRX_t: {
        8: "numberOfTRX::numberOfTRX_8",
        16: "numberOfTRX::numberOfTRX_16",
        32: "numberOfTRX::numberOfTRX_32",
        64: "numberOfTRX::numberOfTRX_64",
    },
