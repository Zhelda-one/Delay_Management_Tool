...
/*    if (!(result.cpriDialectIndication === [object Object] || result.cpriDialectIndication === [object Object]))
    ...
    result.axcPosition = decodeStaticVariableSizedArray_uint16_4(offset + 708);
    result.dlEcpriFdBeamforming = l2l1_getU8(offset + 720);
    result.dlSubcellPoolId = l2l1_getU8(offset + 721);
    result.dlReferenceLevel = l2l1_getU16(offset + 722);
...
function DlCellencodeSetupReq_t(msg, buf, off) {
    ...
    encodeStaticVariableSizedArray_uint16_4(msg.axcPosition, buf, off + 708);
    l2l1_putU8(msg.dlEcpriFdBeamforming, buf, off + 720);
    l2l1_putU8(msg.dlSubcellPoolId, buf, off + 721);
    l2l1_putU16(msg.dlReferenceLevel, buf, off + 722);
}
...
/*    if (!(result.pdschPrecodingOption4x4 === [object Object] || result.pdschPrecodingOption4x4 === [object Object] || result.pdschPrecodingOption4x4 === [object Object] || result.pdschPrecodingOption4x4 === [object Object] || result.pdschPrecodingOption4x4 === [object Object] || result.pdschPrecodingOption4x4 === [object Object] || result.pdschPrecodingOption4x4 === [object Object] || result.pdschPrecodingOption4x4 === [object Object]))
    ...
    result.numCeAxCIndex = l2l1_getU8(offset + 74);
/*    if (!(result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object]))
        throw new Error(`Value ${result.numCeAxCIndex} is out of range for enum 'numCeAxC_t'`); */
    Object.defineProperty(result, "__enum_numCeAxCIndex", {
        enumerable: false,
    ...
    result.ceAxCIndex = decodeStaticFixedSizedArray_uint8_4(offset + 76);
...
function DlDataencodePdschGrant(msg, buf, off) {
    ...
    l2l1_putU8(msg.numCeAxCIndex, buf, off + 74);
    encodeStaticFixedSizedArray_uint8_4(msg.ceAxCIndex, buf, off + 76);
...
/*    if (!(result.cpriDialectIndication === [object Object] || result.cpriDialectIndication === [object Object]))
    ...
    result.axcPosition = decodeStaticVariableSizedArray_uint16_4(offset + 272);
    result.prachConfigurationIndex = l2l1_getU8(offset + 284);
    result.prachPrbOffset = l2l1_getU16(offset + 286);
    result.ulEcpriFdBeamforming = l2l1_getU8(offset + 288);
    result.ulSubcellPoolId = l2l1_getU8(offset + 289);
    result.gainCorrection = l2l1_getI16(offset + 290);
    result.gainCorrectionForPrach = l2l1_getI16(offset + 292);
...
function UlCellencodeSetupReq_t(msg, buf, off) {
    ...
    encodeStaticVariableSizedArray_uint16_4(msg.axcPosition, buf, off + 272);
    l2l1_putU8(msg.prachConfigurationIndex, buf, off + 284);
    l2l1_putU16(msg.prachPrbOffset, buf, off + 286);
    l2l1_putU8(msg.ulEcpriFdBeamforming, buf, off + 288);
    l2l1_putU8(msg.ulSubcellPoolId, buf, off + 289);
    l2l1_putI16(msg.gainCorrection, buf, off + 290);
    l2l1_putI16(msg.gainCorrectionForPrach, buf, off + 292);
}
...
/*    if (!(result.dtxCsiPart1 === [object Object] || result.dtxCsiPart1 === [object Object]))
        throw new Error(`Value ${result.dtxCsiPart1} is out of range for enum 'dtx_t'`); */
    Object.defineProperty(result, "__enum_dtxCsiPart1", {
        enumerable: false,
        writable: false,
        value: "l1_common_dtx_t",
    });
...
/*    if (!(result.dtxCsiPart2 === [object Object] || result.dtxCsiPart2 === [object Object]))
        throw new Error(`Value ${result.dtxCsiPart2} is out of range for enum 'dtx_t'`); */
    Object.defineProperty(result, "__enum_dtxCsiPart2", {
        enumerable: false,
        writable: false,
        value: "l1_common_dtx_t",
    });
...
function UlDatadecodepuschReceiveRespPsSubcell_t(offset) {
    ...
    result.grants = decodeDynamicVariableSizedArray_UePuschReceiveRespPs_t_16(offset + 8);
...
function UlDataencodepuschReceiveRespPsSubcell_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_UePuschReceiveRespPs_t_16(msg.grants, buf, off + 8);
}
function UlDatadecodeUePuschReceiveRespPs_t(offset) {
    let result = {};
...
/*    if (!(result.dtxAck1Bit === [object Object] || result.dtxAck1Bit === [object Object]))
        throw new Error(`Value ${result.dtxAck1Bit} is out of range for enum 'dtxAck_t'`); */
    Object.defineProperty(result, "__enum_dtxAck1Bit", {
        enumerable: false,
        writable: false,
        value: "l1_common_dtxAck_t",
    });
...
/*    if (!(result.dtxAckMoreThan1Bit === [object Object] || result.dtxAckMoreThan1Bit === [object Object]))
        throw new Error(`Value ${result.dtxAckMoreThan1Bit} is out of range for enum 'dtxAck_t'`); */
    Object.defineProperty(result, "__enum_dtxAckMoreThan1Bit", {
        enumerable: false,
        writable: false,
        value: "l1_common_dtxAck_t",
    });
...
function UlDatadecodepuschReceiveRespHarqDSubcell_t(offset) {
    ...
    result.subcellId = l2l1_getU8(offset + 0);
    result.grants = decodeDynamicVariableSizedArray_puschReceiveRespHarqDGrants_t_4(offset + 4);

    return result;
}
function UlDataencodepuschReceiveRespHarqDSubcell_t(msg, buf, off) {
    l2l1_putU8(msg.subcellId, buf, off + 0);
    encodeDynamicVariableSizedArray_puschReceiveRespHarqDGrants_t_4(msg.grants, buf, off + 4);
}
...
function UlDatadecodepucchReceiveReqSubcell_t(offset) {
    ...
    result.sfnForProcessing = l2l1_getU16(offset + 2);
    result.slotForProcessing = l2l1_getU8(offset + 4);
    result.pucchResources = decodeDynamicVariableSizedArray_pucchReceiveReqPucchResource_t_86(offset + 8);
...
function UlDataencodepucchReceiveReqSubcell_t(msg, buf, off) {
    ...
    l2l1_putU16(msg.sfnForProcessing, buf, off + 2);
    l2l1_putU8(msg.slotForProcessing, buf, off + 4);
    encodeDynamicVariableSizedArray_pucchReceiveReqPucchResource_t_86(msg.pucchResources, buf, off + 8);
}
function UlDatadecodepucchReceiveReqPucchResource_t(offset) {
    let result = {};
...
function UlDatadecodepucchReceiveRespPsPucchResource_t(offset) {
    ...
    result.crc = l2l1_getU8(offset + 4);
/*    if (!(result.crc === [object Object] || result.crc === [object Object]))
        throw new Error(`Value ${result.crc} is out of range for enum 'crc_t'`); */
    Object.defineProperty(result, "__enum_crc", {
        enumerable: false,
    ...
    result.dtx = l2l1_getU8(offset + 5);
/*    if (!(result.dtx === [object Object] || result.dtx === [object Object]))
        throw new Error(`Value ${result.dtx} is out of range for enum 'dtx_t'`); */
    Object.defineProperty(result, "__enum_dtx", {
        enumerable: false,
    ...
    result.pucchFormat = l2l1_getU8(offset + 6);
/*    if (!(result.pucchFormat === [object Object] || result.pucchFormat === [object Object] || result.pucchFormat === [object Object] || result.pucchFormat === [object Object]))
        throw new Error(`Value ${result.pucchFormat} is out of range for enum 'pucchFormat_t'`); */
    Object.defineProperty(result, "__enum_pucchFormat", {
        enumerable: false,
    ...
    result.harqProcessIndex = l2l1_getU8(offset + 7);
/*    if (!(result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object] || result.harqProcessIndex === [object Object]))
        throw new Error(`Value ${result.harqProcessIndex} is out of range for enum 'harqProcessIndex_t'`); */
    Object.defineProperty(result, "__enum_harqProcessIndex", {
        enumerable: false,
...
/*    if (!(result.srBit === [object Object] || result.srBit === [object Object] || result.srBit === [object Object]))
    ...
    result.shortTermCfoMetric = l1_commondecodeshortTermCfoMetric_t(offset + 56);
...
function UlDataencodepucchReceiveRespPsPucchResource_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.crc, buf, off + 4);
    l2l1_putU8(msg.dtx, buf, off + 5);
    l2l1_putU8(msg.pucchFormat, buf, off + 6);
    l2l1_putU8(msg.harqProcessIndex, buf, off + 7);
    ...
    l1_commonencodeshortTermCfoMetric_t(msg.shortTermCfoMetric, buf, off + 56);
}
function UlDatadecodepucchReceiveRespPsSubcell_t(offset) {
    let result = {};

    result.subcellId = l2l1_getU8(offset + 0);
    result.pucchResources = decodeDynamicVariableSizedArray_pucchReceiveRespPsPucchResource_t_86(offset + 4);

    return result;
}
function UlDataencodepucchReceiveRespPsSubcell_t(msg, buf, off) {
    l2l1_putU8(msg.subcellId, buf, off + 0);
    encodeDynamicVariableSizedArray_pucchReceiveRespPsPucchResource_t_86(msg.pucchResources, buf, off + 4);
}
function UlDatadecodepucchReceiveRespPsPucchResource_t(offset) {
    let result = {};
...
function UlDatadecodepucchReceiveRespHarqDSubcell_t(offset) {
    ...
    result.subcellId = l2l1_getU8(offset + 0);
    result.pucchResources = decodeDynamicVariableSizedArray_pucchReceiveRespHarqDPucchResource_t_86(offset + 4);

    return result;
}
function UlDataencodepucchReceiveRespHarqDSubcell_t(msg, buf, off) {
    l2l1_putU8(msg.subcellId, buf, off + 0);
    encodeDynamicVariableSizedArray_pucchReceiveRespHarqDPucchResource_t_86(msg.pucchResources, buf, off + 4);
}
function UlDatadecodepucchReceiveRespHarqDPucchResource_t(offset) {
    let result = {};
...
function UlDatadecodesrsReceiveReqUes_t(offset) {
    ...
    result.rnti = l2l1_getU16(offset + 0);
    result.transmissionCombId = l2l1_getU8(offset + 2);
    result.cyclicShift = l2l1_getU8(offset + 3);
    result.numOfSrsPorts = l2l1_getU8(offset + 4);
/*    if (!(result.numOfSrsPorts === [object Object] || result.numOfSrsPorts === [object Object] || result.numOfSrsPorts === [object Object]))
    ...
    result.patternId = decodeStaticFixedSizedArray_uint16_2(offset + 8);
    result.powerOffsetSrsToPuschPerAllocatedRe = l2l1_getF32(offset + 12);
...
function UlDataencodesrsReceiveReqUes_t(msg, buf, off) {
    l2l1_putU16(msg.rnti, buf, off + 0);
    l2l1_putU8(msg.transmissionCombId, buf, off + 2);
    l2l1_putU8(msg.cyclicShift, buf, off + 3);
    l2l1_putU8(msg.numOfSrsPorts, buf, off + 4);
    encodeStaticFixedSizedArray_uint16_2(msg.patternId, buf, off + 8);
    l2l1_putF32(msg.powerOffsetSrsToPuschPerAllocatedRe, buf, off + 12);
    l2l1_putU8(msg.puschTransCoherence, buf, off + 16);
}
function UlDatadecodesrsReceiveReqBands_t(offset) {
    let result = {};

    result.srsBandId = l2l1_getU8(offset + 0);
    result.startPrb = l2l1_getU16(offset + 2);
    result.eCpriSectionId = l2l1_getU16(offset + 4);
    result.srsReceiveReqUes = decodeDynamicVariableSizedArray_srsReceiveReqUes_t_4(offset + 8);

    return result;
}
function UlDataencodesrsReceiveReqBands_t(msg, buf, off) {
    l2l1_putU8(msg.srsBandId, buf, off + 0);
    l2l1_putU16(msg.startPrb, buf, off + 2);
    l2l1_putU16(msg.eCpriSectionId, buf, off + 4);
    encodeDynamicVariableSizedArray_srsReceiveReqUes_t_4(msg.srsReceiveReqUes, buf, off + 8);
}
function UlDatadecodesrsSuMimoStruct_t(offset) {
    ...
    result.numRbgPerSubband = l2l1_getU8(offset + 8);
...
/*    if (!(result.transmissionComb === [object Object] || result.transmissionComb === [object Object]))
    ...
    result.numCeAxCIndex = l2l1_getU8(offset + 10);
/*    if (!(result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object]))
        throw new Error(`Value ${result.numCeAxCIndex} is out of range for enum 'numCeAxC_t'`); */
    Object.defineProperty(result, "__enum_numCeAxCIndex", {
        enumerable: false,
    ...
    result.ceAxCIndex = decodeStaticFixedSizedArray_uint8_4(offset + 12);
    result.symbolPosition = l2l1_getU8(offset + 16);
    result.srsReceiveReqBands = decodeDynamicVariableSizedArray_srsReceiveReqBands_t_68(offset + 20);
...
function UlDataencodesrsSuMimoStruct_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.numRbgPerSubband, buf, off + 8);
    l2l1_putU8(msg.transmissionComb, buf, off + 9);
    l2l1_putU8(msg.numCeAxCIndex, buf, off + 10);
    encodeStaticFixedSizedArray_uint8_4(msg.ceAxCIndex, buf, off + 12);
    l2l1_putU8(msg.symbolPosition, buf, off + 16);
    encodeDynamicVariableSizedArray_srsReceiveReqBands_t_68(msg.srsReceiveReqBands, buf, off + 20);
}
...
function UlDatadecodeSrsReceiveReq_t(offset) {
    ...
    result.srsReceiveRespClientAddress = l2l1_getU32(offset + 0);
    result.srsReceiveRespBmClientAddress = l2l1_getU32(offset + 4);
    result.sfn = l2l1_getU16(offset + 8);
    result.slot = l2l1_getU8(offset + 10);
...
function UlDataencodeSrsReceiveReq_t(msg, buf, off) {
    l2l1_putU32(msg.srsReceiveRespClientAddress, buf, off + 0);
    l2l1_putU32(msg.srsReceiveRespBmClientAddress, buf, off + 4);
    l2l1_putU16(msg.sfn, buf, off + 8);
    l2l1_putU8(msg.slot, buf, off + 10);
...
function UlDatadecodesrsReceiveRespUes_t(offset) {
    let result = {};
...
function UlDataencodesrsReceiveRespUes_t(msg, buf, off) {
    l2l1_putU16(msg.rnti, buf, off + 0);
...
function UlDatadecodesrsReceiveRespPsBands_t(offset) {
    let result = {};

    result.srsBandId = l2l1_getU8(offset + 0);
    result.srsReceiveRespUes = decodeDynamicVariableSizedArray_srsReceiveRespUes_t_4(offset + 4);

    return result;
}
function UlDataencodesrsReceiveRespPsBands_t(msg, buf, off) {
    l2l1_putU8(msg.srsBandId, buf, off + 0);
    encodeDynamicVariableSizedArray_srsReceiveRespUes_t_4(msg.srsReceiveRespUes, buf, off + 4);
}
function UlDatadecodesrsReceiveRespPsSubcell_t(offset) {
    ...
    result.srsBands = decodeDynamicVariableSizedArray_srsReceiveRespPsBands_t_4(offset + 4);
...
function UlDataencodesrsReceiveRespPsSubcell_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_srsReceiveRespPsBands_t_4(msg.srsBands, buf, off + 4);
}
...
function l2l1_decode_msg(l2l1) {
    ...
    case 0xE101: // DlData::PatternConfigReq_t
        ...
        break;
    case 0xE103: // DlData::PdschSendReq_t
    ...
    case 0xE208: // UlData::PucchReceiveRespHarqD_t
        ...
        break;
    case 0xE209: // UlData::PucchReceiveRespPs_t
    ...
    case 0xE20B: // UlData::PuschReceiveRespHarqU_t
        ...
        break;
    case 0xE20D: // UlData::PuschReceiveRespPs_t
        result = UlDatadecodePuschReceiveRespPs_t(0);
        break;
    case 0xE216: // UlData::PucchReceiveReq_t
        result = UlDatadecodePucchReceiveReq_t(0);
        break;
    case 0xE217: // UlData::PuschReceiveReq_t
        result = UlDatadecodePuschReceiveReq_t(0);
        break;
    case 0xE211: // UlData::SrsReceiveReq_t
        result = UlDatadecodeSrsReceiveReq_t(0);
        break;
    case 0xE212: // UlData::SrsReceiveRespPs_t
...
function encodeStaticVariableSizedArray_uint16_4(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off);
    for (let i = 0; i < arr.length && i < 4; i++)
        l2l1_putU16(arr[i], buf, off + i * 2);
}
function decodeStaticVariableSizedArray_uint16_4(offset) {
    const result = [];
    const length = l2l1_getU32(offset);
    for (let i = 0; i < length && i < 4; i++)
        result.push(l2l1_getU16(offset + 4 + i * 2));
    return result;
}
...
function encodeDynamicVariableSizedArray_puschReceiveRespHarqDGrants_t_4(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_puschReceiveRespHarqDGrants_t_4(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_pucchReceiveReqPucchResource_t_86(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_pucchReceiveReqPucchResource_t_86(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_pucchReceiveRespPsPucchResource_t_86(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_pucchReceiveRespPsPucchResource_t_86(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_pucchReceiveRespHarqDPucchResource_t_86(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_pucchReceiveRespHarqDPucchResource_t_86(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_srsReceiveReqUes_t_4(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_srsReceiveReqUes_t_4(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_srsReceiveRespUes_t_4(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        UlDataencodesrsReceiveRespUes_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_srsReceiveRespUes_t_4(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(UlDatadecodesrsReceiveRespUes_t(offset));
        offset += 32;
    }

    return result;
}
function encodeDynamicVariableSizedArray_srsReceiveRespPsBands_t_4(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
    ...
    const dynamic = buf.asDynamic();
    for (const elem of arr) {
        UlDataencodesrsReceiveRespPsBands_t(elem, dynamic, dynamic.length);
    }
}
function decodeDynamicVariableSizedArray_srsReceiveRespPsBands_t_4(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
    ...
    const result = [];
    for (let i = 0; i < len; i++) {
        result.push(UlDatadecodesrsReceiveRespPsBands_t(offset));
        offset += 12;
    }
...
packetPropToStrMap["l2l1.message"] = {
    ...
    0xE209: "UlData::PucchReceiveRespPs",
    0xE20B: "UlData::PuschReceiveRespHarqU",
    0xE20D: "UlData::PuschReceiveRespPs",
    0xE216: "UlData::PucchReceiveReq",
    0xE217: "UlData::PuschReceiveReq",
    0xE211: "UlData::SrsReceiveReq",
    0xE212: "UlData::SrsReceiveRespPs",
};
