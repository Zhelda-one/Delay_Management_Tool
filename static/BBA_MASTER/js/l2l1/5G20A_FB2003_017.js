...
function L1CpridecodeConfigureAxcInfoReq_t(offset) {
    ...
    result.axcContainers = decodeDynamicVariableSizedArray_configureAxcContainersReq_t_63(offset + 0);

    return result;
}
function L1CpriencodeConfigureAxcInfoReq_t(msg, buf, off) {
    encodeDynamicVariableSizedArray_configureAxcContainersReq_t_63(msg.axcContainers, buf, off + 0);
}
function L1CpridecodeconfigureAxcContainersReq_t(offset) {
    let result = {};
...
function L1CpridecodeConfigureAxcInfoResp_t(offset) {
    ...
    result.axcContainers = decodeDynamicVariableSizedArray_configureAxcContainersResp_t_63(offset + 0);

    return result;
}
function L1CpriencodeConfigureAxcInfoResp_t(msg, buf, off) {
    encodeDynamicVariableSizedArray_configureAxcContainersResp_t_63(msg.axcContainers, buf, off + 0);
}
function L1CpridecodeconfigureAxcContainersResp_t(offset) {
    let result = {};
...
function L1CpridecodeDeleteAxcInfoReq_t(offset) {
    ...
    result.axcContainers = decodeDynamicVariableSizedArray_axcContainersDeleteReq_t_63(offset + 0);

    return result;
}
function L1CpriencodeDeleteAxcInfoReq_t(msg, buf, off) {
    encodeDynamicVariableSizedArray_axcContainersDeleteReq_t_63(msg.axcContainers, buf, off + 0);
}
function L1CpridecodeaxcContainersDeleteReq_t(offset) {
    let result = {};
...
function L1CpridecodeDeleteAxcInfoResp_t(offset) {
    ...
    result.axcContainers = decodeDynamicVariableSizedArray_axcContainersDeleteResp_t_63(offset + 0);

    return result;
}
function L1CpriencodeDeleteAxcInfoResp_t(msg, buf, off) {
    encodeDynamicVariableSizedArray_axcContainersDeleteResp_t_63(msg.axcContainers, buf, off + 0);
}
function L1CpridecodeaxcContainersDeleteResp_t(offset) {
    let result = {};
...
/*    if (!(result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object]))
...
/*    if (!(result.digitalOutputRate === [object Object] || result.digitalOutputRate === [object Object] || result.digitalOutputRate === [object Object]))
    ...
    result.cpriDialectIndication = l2l1_getU8(offset + 263);
/*    if (!(result.cpriDialectIndication === [object Object] || result.cpriDialectIndication === [object Object]))
        throw new Error(`Value ${result.cpriDialectIndication} is out of range for enum 'cpriDialectIndication_t'`); */
    Object.defineProperty(result, "__enum_cpriDialectIndication", {
        enumerable: false,
...
function UlCellencodeSetupReq_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.cpriDialectIndication, buf, off + 263);
}
...
function l2l1_decode_msg(l2l1) {
    ...
    case 0x0a41: // L1Cpri::DelayConfigReq_t
        ...
        break;
    case 0x0A42: // L1Cpri::ConfigureAxcInfoReq_t
...
function encodeDynamicVariableSizedArray_configureAxcContainersReq_t_63(arr, buf, off) {
...
function decodeDynamicVariableSizedArray_configureAxcContainersReq_t_63(offset) {
...
function encodeDynamicVariableSizedArray_configureAxcContainersResp_t_63(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_configureAxcContainersResp_t_63(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_axcContainersDeleteReq_t_63(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_axcContainersDeleteReq_t_63(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_axcContainersDeleteResp_t_63(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_axcContainersDeleteResp_t_63(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
packetPropToStrMap["l2l1.message"] = {
    ...
    0x0A42: "L1Cpri::ConfigureAxcInfoReq",
