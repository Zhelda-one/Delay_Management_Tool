...
function DlDatadecodePatternConfigReq_t(offset) {
    ...
    result.data = decodeStaticFixedSizedArray_PatternIdPolListPerSymbol_t_14(offset + 12);
...
function DlDataencodePatternConfigReq_t(msg, buf, off) {
    ...
    encodeStaticFixedSizedArray_PatternIdPolListPerSymbol_t_14(msg.data, buf, off + 12);
