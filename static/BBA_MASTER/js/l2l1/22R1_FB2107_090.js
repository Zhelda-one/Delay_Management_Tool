...
/*    if (!(result.cpriDialectIndication === [object Object] || result.cpriDialectIndication === [object Object]))
    ...
    result.ulDlDataSlotRatio = l2l1_getU8(offset + 100);
/*    if (!(result.ulDlDataSlotRatio === [object Object] || result.ulDlDataSlotRatio === [object Object] || result.ulDlDataSlotRatio === [object Object] || result.ulDlDataSlotRatio === [object Object] || result.ulDlDataSlotRatio === [object Object] || result.ulDlDataSlotRatio === [object Object]))
    ...
    result.l1SubpoolId = l2l1_getU16(offset + 102);
    result.firstCellSlotId = l2l1_getU16(offset + 104);
    result.cellSlotLength = l2l1_getU16(offset + 106);
    result.ulEcpriFdBeamforming = l2l1_getU8(offset + 108);
    result.actUlEcpriExtType12 = l2l1_getU8(offset + 109);
    result.ulSubcellPoolId = l2l1_getU8(offset + 110);
    result.gainCorrection = l2l1_getI16(offset + 112);
    result.gainCorrectionForPrach = l2l1_getI16(offset + 114);
    result.ulScPerCarrierPart = decodeDynamicVariableSizedArray_uint16_2(offset + 116);
    result.actUlEcpriPhase4 = l2l1_getU8(offset + 124);
    result.prachDtxThresholdSelection = l2l1_getU8(offset + 125);
/*    if (!(result.prachDtxThresholdSelection === [object Object] || result.prachDtxThresholdSelection === [object Object]))
    ...
    result.actORANstep1 = l2l1_getU8(offset + 126);
    result.numberOfColTRX = l2l1_getU8(offset + 127);
/*    if (!(result.numberOfColTRX === [object Object] || result.numberOfColTRX === [object Object]))
    ...
    result.numberOfRowTRX = l2l1_getU8(offset + 128);
/*    if (!(result.numberOfRowTRX === [object Object] || result.numberOfRowTRX === [object Object] || result.numberOfRowTRX === [object Object]))
    ...
    result.ORANprachNumerology = l2l1_getU8(offset + 129);
    result.ulIqCompression = l2l1_getU8(offset + 130);
    result.ulActDownSampling = l2l1_getU8(offset + 131);
    result.mantissaSize = l2l1_getU8(offset + 132);
/*    if (!(result.mantissaSize === [object Object] || result.mantissaSize === [object Object]))
        throw new Error(`Value ${result.mantissaSize} is out of range for enum 'mantissaSize_t'`); */
    Object.defineProperty(result, "__enum_mantissaSize", {
        enumerable: false,
    ...
    result.staticLongPucch = l2l1_getU8(offset + 133);
    result.localCellResId = l2l1_getU32(offset + 136);
    result.pSRSact = l2l1_getU8(offset + 140);
    result.pSRSnumCeAxCId = l2l1_getU8(offset + 141);
/*    if (!(result.pSRSnumCeAxCId === [object Object] || result.pSRSnumCeAxCId === [object Object] || result.pSRSnumCeAxCId === [object Object]))
    ...
    result.realPartOfPrecombinerRows = decodeDynamicVariableSizedArray_int16_32(offset + 144);
    result.imagPartOfPrecombinerRows = decodeDynamicVariableSizedArray_int16_32(offset + 152);
    result.realPartOfPrecombinerColumns = decodeDynamicVariableSizedArray_int16_32(offset + 160);
    result.imagPartOfPrecombinerColumns = decodeDynamicVariableSizedArray_int16_32(offset + 168);
    result.beamWeight = decodeDynamicVariableSizedArray_beamWeight_t_400(offset + 176);
...
function UlCellencodeSetupReq_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.ulDlDataSlotRatio, buf, off + 100);
    l2l1_putU16(msg.l1SubpoolId, buf, off + 102);
    l2l1_putU16(msg.firstCellSlotId, buf, off + 104);
    l2l1_putU16(msg.cellSlotLength, buf, off + 106);
    l2l1_putU8(msg.ulEcpriFdBeamforming, buf, off + 108);
    l2l1_putU8(msg.actUlEcpriExtType12, buf, off + 109);
    l2l1_putU8(msg.ulSubcellPoolId, buf, off + 110);
    l2l1_putI16(msg.gainCorrection, buf, off + 112);
    l2l1_putI16(msg.gainCorrectionForPrach, buf, off + 114);
    encodeDynamicVariableSizedArray_uint16_2(msg.ulScPerCarrierPart, buf, off + 116);
    l2l1_putU8(msg.actUlEcpriPhase4, buf, off + 124);
    l2l1_putU8(msg.prachDtxThresholdSelection, buf, off + 125);
    l2l1_putU8(msg.actORANstep1, buf, off + 126);
    l2l1_putU8(msg.numberOfColTRX, buf, off + 127);
    l2l1_putU8(msg.numberOfRowTRX, buf, off + 128);
    l2l1_putU8(msg.ORANprachNumerology, buf, off + 129);
    l2l1_putU8(msg.ulIqCompression, buf, off + 130);
    l2l1_putU8(msg.ulActDownSampling, buf, off + 131);
    l2l1_putU8(msg.mantissaSize, buf, off + 132);
    l2l1_putU8(msg.staticLongPucch, buf, off + 133);
    l2l1_putU32(msg.localCellResId, buf, off + 136);
    l2l1_putU8(msg.pSRSact, buf, off + 140);
    l2l1_putU8(msg.pSRSnumCeAxCId, buf, off + 141);
    encodeDynamicVariableSizedArray_int16_32(msg.realPartOfPrecombinerRows, buf, off + 144);
    encodeDynamicVariableSizedArray_int16_32(msg.imagPartOfPrecombinerRows, buf, off + 152);
    encodeDynamicVariableSizedArray_int16_32(msg.realPartOfPrecombinerColumns, buf, off + 160);
    encodeDynamicVariableSizedArray_int16_32(msg.imagPartOfPrecombinerColumns, buf, off + 168);
    encodeDynamicVariableSizedArray_beamWeight_t_400(msg.beamWeight, buf, off + 176);
}
function UlCelldecodebeamWeight_t(offset) {
    let result = {};
