...
function DlDatadecodePdcchSendReq_t(offset) {
    ...
    result.dciInfo = decodeDynamicVariableSizedArray_DciInfo_30(offset + 8);
...
function DlDataencodePdcchSendReq_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_DciInfo_30(msg.dciInfo, buf, off + 8);
}
...
function UlDatadecodepuschReceiveRespPsSubcell_t(offset) {
    ...
    result.grants = decodeDynamicVariableSizedArray_UePuschReceiveRespPs_t_30(offset + 24);
...
function UlDataencodepuschReceiveRespPsSubcell_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_UePuschReceiveRespPs_t_30(msg.grants, buf, off + 24);
}
function UlDatadecodeUePuschReceiveRespPs_t(offset) {
    let result = {};
...
function UlDatadecodepuschReceiveReqSubcell_t(offset) {
    ...
    result.msgCountCtrl = l2l1_getU8(offset + 5);
    result.grants = decodeDynamicVariableSizedArray_puschReceiveReqGrant_t_30(offset + 8);
...
function UlDataencodepuschReceiveReqSubcell_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.msgCountCtrl, buf, off + 5);
    encodeDynamicVariableSizedArray_puschReceiveReqGrant_t_30(msg.grants, buf, off + 8);
}
function UlDatadecodepuschReceiveReqGrant_t(offset) {
    let result = {};
...
function UlDatadecodepuschReceiveRespHarqUSubcell_t(offset) {
    ...
    result.subcellId = l2l1_getU8(offset + 0);
    result.grants = decodeDynamicVariableSizedArray_UePuschReceiveRespHarqU_t_30(offset + 4);

    return result;
}
function UlDataencodepuschReceiveRespHarqUSubcell_t(msg, buf, off) {
    l2l1_putU8(msg.subcellId, buf, off + 0);
    encodeDynamicVariableSizedArray_UePuschReceiveRespHarqU_t_30(msg.grants, buf, off + 4);
}
function UlDatadecodeUePuschReceiveRespHarqU_t(offset) {
    let result = {};
...
function encodeDynamicVariableSizedArray_DciInfo_30(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_DciInfo_30(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_UePuschReceiveRespPs_t_30(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_UePuschReceiveRespPs_t_30(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_puschReceiveReqGrant_t_30(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_puschReceiveReqGrant_t_30(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
...
function encodeDynamicVariableSizedArray_UePuschReceiveRespHarqU_t_30(arr, buf, off) {
    l2l1_putU32(arr.length, buf, off); // length
    off += 4;
    l2l1_putU32(buf.static.length - off + buf.dynamic.getLength(), buf, off); // relative offset forward
...
function decodeDynamicVariableSizedArray_UePuschReceiveRespHarqU_t_30(offset) {
    const arrayOff = l2l1_getU32(offset);
    const len = l2l1_getU32(offset + 4);
    offset = arrayOff + offset;
