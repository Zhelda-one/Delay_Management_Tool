...
function UlData_decodepuschReceiveRespPsSubcell_t(offset) {
    ...
    result.subcellId = l2l1_getU8(offset + 0);
    result.noisePower = l2l1_getF32(offset + 4);
    result.grants = _decodeArray(offset + 8, UlData_decodeUePuschReceiveRespPs_t, 84);
...
function UlData_encodepuschReceiveRespPsSubcell_t(msg, buf, off) {
    l2l1_putU8(msg.subcellId, buf, off + 0);
    l2l1_putF32(msg.noisePower, buf, off + 4);
    _encodeArray(msg.grants, buf, off + 8, UlData_encodeUePuschReceiveRespPs_t, 84);
}
...
function UlData_decodeUePuschReceiveRespPs_t(offset) {
    ...
    result.uciCsiPart2Bits = [];
    for (let i = 0; i < 7; i++)
        result.uciCsiPart2Bits.push(l2l1_getU8(offset + 73 + i * 1));
...
function lunum_common_decodeeAxcStream_t(offset) {
    ...
    result.ruMacaddress = [];
    const ruMacaddressLength = l2l1_getU32(offset + 12);
    for (let i = 0; i < ruMacaddressLength && i < 6; i++)
        result.ruMacaddress.push(l2l1_getU8(offset + 16 + i * 1));
    result.vlanId = l2l1_getU32(offset + 20);
    result.vlanPcp = l2l1_getU32(offset + 24);
...
function lunum_common_encodeeAxcStream_t(msg, buf, off) {
    ...
    l2l1_putU32(msg.ruMacaddress.length, buf, off + 12);
    for (let i = 0; i < msg.ruMacaddress.length && i < 6; i++)
        l2l1_putU8(msg.ruMacaddress[i], buf, off + 12 + i * 1);
    l2l1_putU32(msg.vlanId, buf, off + 20);
    l2l1_putU32(msg.vlanPcp, buf, off + 24);
}
...
function LteLunum_L1ECpri_decodeConfigureLinksReq_t(offset) {
    const result = {};
    ...
    for (let i = 0; i < eCpriLinkLength && i < 16; i++)
        result.eCpriLink.push(LteLunum_L1ECpri_decodeSECpriLinkItem_t(offset + 8 + i * 1));
    result.scs = l2l1_getU8(offset + 24);

    return result;
}
function LteLunum_L1ECpri_encodeConfigureLinksReq_t(msg, buf, off) {
    l2l1_putU32(msg.numOfItems, buf, off + 0);
    l2l1_putU32(msg.eCpriLink.length, buf, off + 4);
    for (let i = 0; i < msg.eCpriLink.length && i < 16; i++)
        LteLunum_L1ECpri_encodeSECpriLinkItem_t(msg.eCpriLink[i], buf, off + 4 + i * 1);
    l2l1_putU8(msg.scs, buf, off + 20);
}

function LteLunum_L1ECpri_decodeSECpriLinkItem_t(offset) {
    const result = {};
...
function LteLunum_L1ECpri_encodeSECpriLinkItem_t(msg, buf, off) {
    l2l1_putU8(msg.eCpriLink, buf, off + 0);
}

function LteLunum_L1ECpri_decodeConfigureLinksResp_t(offset) {
    const result = {};
...
function LteLunum_L1ECpri_encodeConfigureLinksResp_t(msg, buf, off) {
    l2l1_putU8(msg.state, buf, off + 0);
}

function LteLunum_L1ECpri_decodeConfigureMeasurementsReq_t(offset) {
    const result = {};
...
function LteLunum_L1ECpri_encodeConfigureMeasurementsReq_t(msg, buf, off) {
    l2l1_putU32(msg.sicad, buf, off + 0);
    l2l1_putU8(msg.measIntervalMsgRcv, buf, off + 4);
}

function LteLunum_L1ECpri_decodeConfigureMeasurementsResp_t(offset) {
    const result = {};
...
function LteLunum_L1ECpri_encodeConfigureMeasurementsResp_t(msg, buf, off) {
    l2l1_putU8(msg.state, buf, off + 0);
}

function LteLunum_L1ECpri_decodeConfigureTransportReq_t(offset) {
    const result = {};
...
function LteLunum_L1ECpri_encodeConfigureTransportReq_t(msg, buf, off) {
    l2l1_putU8(msg.eCpriLink, buf, off + 0);
...
function LteLunum_L1ECpri_decodeConfigureTransportResp_t(offset) {
    const result = {};
...
function LteLunum_L1ECpri_encodeConfigureTransportResp_t(msg, buf, off) {
    l2l1_putU8(msg.eCpriLink, buf, off + 0);
    l2l1_putU8(msg.state, buf, off + 1);
}

function LteLunum_L1ECpri_decodeDelayConfigReq_t(offset) {
    const result = {};
...
function LteLunum_L1ECpri_encodeDelayConfigReq_t(msg, buf, off) {
    l2l1_putU8(msg.eCpriLink, buf, off + 0);
...
function LteLunum_L1ECpri_decodeDelayConfigResp_t(offset) {
    const result = {};
...
function LteLunum_L1ECpri_encodeDelayConfigResp_t(msg, buf, off) {
    l2l1_putU8(msg.eCpriLink, buf, off + 0);
    l2l1_putU8(msg.state, buf, off + 1);
}

function LteLunum_L1ECpri_decodeDelayMeasInd_t(offset) {
    const result = {};
...
function LteLunum_L1ECpri_encodeDelayMeasInd_t(msg, buf, off) {
    l2l1_putU8(msg.eCpriLink, buf, off + 0);
    l2l1_putU32(msg.tdOneWayMin, buf, off + 4);
    l2l1_putU32(msg.tdOneWayMax, buf, off + 8);
}

function LteLunum_L1ECpri_decodeInitialDelayMeasReq_t(offset) {
    const result = {};
...
function LteLunum_L1ECpri_encodeInitialDelayMeasReq_t(msg, buf, off) {
    l2l1_putU8(msg.eCpriLink, buf, off + 0);
...
function LteLunum_L1ECpri_decodeInitialDelayMeasResp_t(offset) {
    const result = {};
...
function LteLunum_L1ECpri_encodeInitialDelayMeasResp_t(msg, buf, off) {
    l2l1_putU8(msg.eCpriLink, buf, off + 0);
    l2l1_putU8(msg.state, buf, off + 1);
    l2l1_putU32(msg.tdOneWayMin, buf, off + 4);
    l2l1_putU32(msg.tdOneWayMax, buf, off + 8);
...
function LteLunum_L1ECpri_decodeMsgRcvCountersInd_t(offset) {
    const result = {};
    ...
    for (let i = 0; i < MsgRcvCountersLength && i < 80; i++)
        result.MsgRcvCounters.push(LteLunum_L1ECpri_decodeSMsgRcvCountersItem(offset + 8 + i * 56));

    return result;
}
function LteLunum_L1ECpri_encodeMsgRcvCountersInd_t(msg, buf, off) {
    l2l1_putU32(msg.numOfItems, buf, off + 0);
    l2l1_putU32(msg.MsgRcvCounters.length, buf, off + 4);
    for (let i = 0; i < msg.MsgRcvCounters.length && i < 80; i++)
        LteLunum_L1ECpri_encodeSMsgRcvCountersItem(msg.MsgRcvCounters[i], buf, off + 4 + i * 56);
}

function LteLunum_L1ECpri_decodeSetOutputReq_t(offset) {
    const result = {};
...
function LteLunum_L1ECpri_encodeSetOutputReq_t(msg, buf, off) {
    l2l1_putU8(msg.eCpriLink, buf, off + 0);
    l2l1_putU8(msg.outputState, buf, off + 1);
}

function LteLunum_L1ECpri_decodeSetOutputResp_t(offset) {
    const result = {};
...
function LteLunum_L1ECpri_encodeSetOutputResp_t(msg, buf, off) {
    l2l1_putU8(msg.eCpriLink, buf, off + 0);
    l2l1_putU8(msg.state, buf, off + 1);
    l2l1_putU8(msg.outputState, buf, off + 2);
}

function LteLunum_L1ECpri_decodeSMsgRcvCountersItem(offset) {
    const result = {};
...
function LteLunum_L1ECpri_encodeSMsgRcvCountersItem(msg, buf, off) {
    l2l1_putU8(msg.eCpriLink, buf, off + 0);
...
function LteLunum_L1ECpri_decodeStateInd_t(offset) {
    const result = {};
...
function LteLunum_L1ECpri_encodeStateInd_t(msg, buf, off) {
    l2l1_putU8(msg.eCpriLink, buf, off + 0);
    l2l1_putU8(msg.eCpriState, buf, off + 1);
}

function LteLunum_L1ECpri_decodeSubscribeReq_t(offset) {
    const result = {};
...
function LteLunum_L1ECpri_encodeSubscribeReq_t(msg, buf, off) {
    l2l1_putU8(msg.eCpriLink, buf, off + 0);
    l2l1_putU32(msg.sicad, buf, off + 4);
}

function LteLunum_L1ECpri_decodeSubscribeResp_t(offset) {
    const result = {};
...
function LteLunum_L1ECpri_encodeSubscribeResp_t(msg, buf, off) {
    l2l1_putU8(msg.eCpriLink, buf, off + 0);
    l2l1_putU8(msg.state, buf, off + 1);
    l2l1_putU32(msg.sicad, buf, off + 4);
}
...
function LteLunum_DlUlCell_decodeSetupReq_t(offset) {
    ...
    result.eAxcStreams = _decodeArray(offset + 8, lunum_common_decodeeAxcStream_t, 28);
...
function LteLunum_DlUlCell_encodeSetupReq_t(msg, buf, off) {
    ...
    _encodeArray(msg.eAxcStreams, buf, off + 8, lunum_common_encodeeAxcStream_t, 28);
...
function LteLunum_DlData_decodetriggerIQSnapshotReq_t(offset) {
    const result = {};

    result.cellId = l2l1_getU32(offset + 0);
    result.commonHeader = LteLunum_DlData_decodedlUlCommonHeader_t(offset + 4);
    result.sections = LteLunum_DlData_decodetriggerIQSnapshotSection_t(offset + 12);

    return result;
}
function LteLunum_DlData_encodetriggerIQSnapshotReq_t(msg, buf, off) {
    l2l1_putU32(msg.cellId, buf, off + 0);
    LteLunum_DlData_encodedlUlCommonHeader_t(msg.commonHeader, buf, off + 4);
    LteLunum_DlData_encodetriggerIQSnapshotSection_t(msg.sections, buf, off + 12);
}

function LteLunum_DlData_decodetriggerIQSnapshotSection_t(offset) {
    const result = {};

    result.sectionId = l2l1_getU16(offset + 0);
    result.historyFrameId = l2l1_getU16(offset + 2);
    result.historySubFrameId = l2l1_getU8(offset + 4);
    result.historySlotId = l2l1_getU8(offset + 5);
    result.triggerEvent = [];
    for (let i = 0; i < 8; i++)
        result.triggerEvent.push(l2l1_getU8(offset + 6 + i * 1));

    return result;
}
function LteLunum_DlData_encodetriggerIQSnapshotSection_t(msg, buf, off) {
    l2l1_putU16(msg.sectionId, buf, off + 0);
    l2l1_putU16(msg.historyFrameId, buf, off + 2);
    l2l1_putU8(msg.historySubFrameId, buf, off + 4);
    l2l1_putU8(msg.historySlotId, buf, off + 5);
    for (let i = 0; i < 8; i++)
        l2l1_putU8(msg.triggerEvent[i], buf, off + 6 + i * 1);
}
...
function l2l1_decode_msg(l2l1) {
    ...
    case 0xd260: // LteLunum_DlData::dlUlChannelsReq_t
        ...
        break;
    case 0xd261: // LteLunum_DlData::triggerIQSnapshotReq_t
        result = LteLunum_DlData_decodetriggerIQSnapshotReq_t(0);
        break;
...
function l2l1_encode_msg(l2l1) {
    ...
    case 0xd261: // LteLunum_DlData::triggerIQSnapshotReq_t
        buf.static = new Uint8Array(28);
        LteLunum_DlData_encodetriggerIQSnapshotReq_t(l2l1, buf, 0);
        break;
    case 0x1636: // LteLunum_DlUlCell::SetupReq_t
        buf.static = new Uint8Array(24);
...
packetPropToStrMap["l2l1.message"] = {
    ...
    0xd261: "LteLunum_DlData::triggerIQSnapshotReq",
