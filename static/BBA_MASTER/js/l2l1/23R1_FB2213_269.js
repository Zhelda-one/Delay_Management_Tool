...
function L1ConfigdecodeL1Config_AutohealingActivationReq_t(offset) {
    let result = {};
...
function L1ConfigencodeL1Config_AutohealingActivationReq_t(msg, buf, off) {
    l2l1_putU32(msg.transactionId, buf, off + 0);
    l2l1_putU8(msg.isAutohealingEnabled, buf, off + 4);
}
function L1ConfigdecodeL1Config_AutohealingActivationResp_t(offset) {
    let result = {};
...
function L1ConfigencodeL1Config_AutohealingActivationResp_t(msg, buf, off) {
    l2l1_putU32(msg.transactionId, buf, off + 0);
    l2l1_putU8(msg.status, buf, off + 4);
}
...
function L1StatusdecodeL1Status_AutohealingSubscribeReq_t(offset) {
    let result = {};
...
function L1StatusencodeL1Status_AutohealingSubscribeReq_t(msg, buf, off) {
    l2l1_putU32(msg.transactionId, buf, off + 0);
    l2l1_putU32(msg.address, buf, off + 4);
}
function L1StatusdecodeL1Status_AutohealingSubscribeResp_t(offset) {
    let result = {};
...
function L1StatusencodeL1Status_AutohealingSubscribeResp_t(msg, buf, off) {
    l2l1_putU32(msg.transactionId, buf, off + 0);
    l2l1_putU8(msg.status, buf, off + 4);
}
function L1StatusdecodeL1Status_AutohealingStatusInd_t(offset) {
    let result = {};
...
function L1StatusencodeL1Status_AutohealingStatusInd_t(msg, buf, off) {
    l2l1_putU32(msg.transactionId, buf, off + 0);
    l2l1_putU8(msg.status, buf, off + 4);
...
function decodeL1Status_AutohealingSubscribeReq_t(offset) {
    let result = {};
...
function encodeL1Status_AutohealingSubscribeReq_t(msg, buf, off) {
    l2l1_putU32(msg.transactionId, buf, off + 0);
    l2l1_putU32(msg.address, buf, off + 4);
}
...
/*    if (!(result.mantissaSize === [object Object] || result.mantissaSize === [object Object]))
    ...
    result.pSRSconfig = UlCelldecodepSRSconfig_t(offset + 184);
    result.actHighSpeedCell = l2l1_getU8(offset + 228);
    result.actUlMuMimo = l2l1_getU8(offset + 229);
    result.ulSubCellCaps = l2l1_getU32(offset + 232);
...
function UlCellencodeSetupReq_t(msg, buf, off) {
    ...
    UlCellencodepSRSconfig_t(msg.pSRSconfig, buf, off + 184);
    l2l1_putU8(msg.actHighSpeedCell, buf, off + 228);
    l2l1_putU8(msg.actUlMuMimo, buf, off + 229);
    l2l1_putU32(msg.ulSubCellCaps, buf, off + 232);
}
function UlCelldecodeulBeams_t(offset) {
    let result = {};
...
/*    if (!(result.mantissaSize === [object Object] || result.mantissaSize === [object Object]))
    ...
    result.localCellResId = l2l1_getU32(offset + 176);
    result.pSRSact = l2l1_getU8(offset + 180);
    result.pSRSconfig = decodepSRSconfig_t(offset + 184);
    result.actHighSpeedCell = l2l1_getU8(offset + 228);
    result.actUlMuMimo = l2l1_getU8(offset + 229);
    result.ulSubCellCaps = l2l1_getU32(offset + 232);
...
function encodeSetupReq_t(msg, buf, off) {
    ...
    l2l1_putU32(msg.localCellResId, buf, off + 176);
    l2l1_putU8(msg.pSRSact, buf, off + 180);
    encodepSRSconfig_t(msg.pSRSconfig, buf, off + 184);
    l2l1_putU8(msg.actHighSpeedCell, buf, off + 228);
    l2l1_putU8(msg.actUlMuMimo, buf, off + 229);
    l2l1_putU32(msg.ulSubCellCaps, buf, off + 232);
}
...
/*    if (!(result.puschTransformPrecoderFlag === [object Object] || result.puschTransformPrecoderFlag === [object Object]))
    ...
    result.ext = decodeStaticVariableSizedArray_uint32_2(offset + 184);
    result.pairedUe = l2l1_getU16(offset + 196);
...
function UlDataencodepuschReceiveReqGrant_t(msg, buf, off) {
    ...
    encodeStaticVariableSizedArray_uint32_2(msg.ext, buf, off + 184);
    l2l1_putU16(msg.pairedUe, buf, off + 196);
}
...
function l2l1_decode_msg(l2l1) {
    ...
    case 0xe3f1: // L1Config::L1Config_SwConfigurationResp_t
        ...
        break;
    case 0xe3f2: // L1Config::L1Config_AutohealingActivationReq_t
        result = L1ConfigdecodeL1Config_AutohealingActivationReq_t(0);
        break;
    case 0xe3f3: // L1Config::L1Config_AutohealingActivationResp_t
        result = L1ConfigdecodeL1Config_AutohealingActivationResp_t(0);
        break;
    ...
    case 0xe3b8: // L1Log::AntennaSnapshotConfigurationReq_t
        ...
        break;
    case 0xE3B9: // L1Status::L1Status_AutohealingSubscribeReq_t
        result = L1StatusdecodeL1Status_AutohealingSubscribeReq_t(0);
        break;
    case 0xE3BA: // L1Status::L1Status_AutohealingSubscribeResp_t
        result = L1StatusdecodeL1Status_AutohealingSubscribeResp_t(0);
        break;
    case 0xE3BB: // L1Status::L1Status_AutohealingStatusInd_t
        result = L1StatusdecodeL1Status_AutohealingStatusInd_t(0);
        break;
...
function l2l1_encode_msg(l2l1) {
    ...
    case 0xe3f2: // L1Config::L1Config_AutohealingActivationReq_t
        ...
        L1ConfigencodeL1Config_AutohealingActivationReq_t(l2l1, buf, 0);
        break;
    case 0xe3f3: // L1Config::L1Config_AutohealingActivationResp_t
        buf.static = new Uint8Array(8);
        L1ConfigencodeL1Config_AutohealingActivationResp_t(l2l1, buf, 0);
        break;
    case 0x0a00: // L1Cpri::AlarmInd_t
        buf.static = new Uint8Array(8);
    ...
    case 0xE3B9: // L1Status::L1Status_AutohealingSubscribeReq_t
        buf.static = new Uint8Array(8);
        L1StatusencodeL1Status_AutohealingSubscribeReq_t(l2l1, buf, 0);
        break;
    case 0xE3BA: // L1Status::L1Status_AutohealingSubscribeResp_t
        buf.static = new Uint8Array(8);
        L1StatusencodeL1Status_AutohealingSubscribeResp_t(l2l1, buf, 0);
        break;
    case 0xE3BB: // L1Status::L1Status_AutohealingStatusInd_t
        buf.static = new Uint8Array(36);
        L1StatusencodeL1Status_AutohealingStatusInd_t(l2l1, buf, 0);
        break;
    case 0xd220: // SyncM::startPtpReq_t
        buf.static = new Uint8Array(80);
...
packetPropToStrMap["l2l1.message"] = {
    ...
    0xe3f2: "L1Config::L1Config_AutohealingActivationReq",
    0xe3f3: "L1Config::L1Config_AutohealingActivationResp",
    ...
    0xE3B9: "L1Status::L1Status_AutohealingSubscribeReq",
    0xE3BA: "L1Status::L1Status_AutohealingSubscribeResp",
    0xE3BB: "L1Status::L1Status_AutohealingStatusInd",
