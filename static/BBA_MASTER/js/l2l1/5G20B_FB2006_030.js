...
/*    if (!(result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object]))
    ...
    result.isPdcchPuncturing = l2l1_getU8(offset + 35);
...
function DlDataencodeDciInfo(msg, buf, off) {
    ...
    l2l1_putU8(msg.isPdcchPuncturing, buf, off + 35);
...
/*    if (!(result.precodingVectorIndex === [object Object] || result.precodingVectorIndex === [object Object] || result.precodingVectorIndex === [object Object] || result.precodingVectorIndex === [object Object]))
    ...
    result.numCeAxcIndex = l2l1_getU8(offset + 12);
/*    if (!(result.numCeAxcIndex === [object Object] || result.numCeAxcIndex === [object Object]))
        throw new Error(`Value ${result.numCeAxcIndex} is out of range for enum 'numCeAxC_t'`); */
    Object.defineProperty(result, "__enum_numCeAxcIndex", {
        enumerable: false,
    ...
    result.patternId = decodeStaticFixedSizedArray_uint16_4(offset + 20);
...
function DlDataencodeSsBlockSendReq_t(msg, buf, off) {
    ...
    l2l1_putU8(msg.numCeAxcIndex, buf, off + 12);
    encodeStaticFixedSizedArray_uint8_4(msg.ceAxCIndex, buf, off + 16);
    encodeStaticFixedSizedArray_uint16_4(msg.patternId, buf, off + 20);
}
...
/*    if (!(result.puschTransCoherence === [object Object] || result.puschTransCoherence === [object Object] || result.puschTransCoherence === [object Object]))
    ...
    result.L2_Ctxt_AN_Mgt = decodeStaticFixedSizedArray_uint8_8(offset + 108);
...
function UlDataencodepuschReceiveReqGrant_t(msg, buf, off) {
    ...
    encodeStaticFixedSizedArray_uint8_8(msg.L2_Ctxt_AN_Mgt, buf, off + 108);
}
...
/*    if (!(result.ackCrcCheck === [object Object] || result.ackCrcCheck === [object Object]))
    ...
    result.L2_Ctxt_AN_Mgt = decodeStaticFixedSizedArray_uint8_8(offset + 24);
...
function UlDataencodepuschReceiveRespHarqDGrants_t(msg, buf, off) {
    ...
    encodeStaticFixedSizedArray_uint8_8(msg.L2_Ctxt_AN_Mgt, buf, off + 24);
}
...
/*    if (!(result.modulationType === [object Object] || result.modulationType === [object Object]))
    ...
    result.L2_Ctxt_AN_Mgt = decodeStaticFixedSizedArray_uint8_8(offset + 48);
...
function UlDataencodepucchReceiveReqPucchResource_t(msg, buf, off) {
    ...
    encodeStaticFixedSizedArray_uint8_8(msg.L2_Ctxt_AN_Mgt, buf, off + 48);
}
...
/*    if (!(result.srBit === [object Object] || result.srBit === [object Object] || result.srBit === [object Object]))
    ...
    result.shortTermCfoMetric = l1_commondecodeshortTermCfoMetric_t(offset + 52);
...
function UlDataencodepucchReceiveRespPsPucchResource_t(msg, buf, off) {
    ...
    l1_commonencodeshortTermCfoMetric_t(msg.shortTermCfoMetric, buf, off + 52);
}
...
/*    if (!(result.crc === [object Object] || result.crc === [object Object]))
    ...
    result.L2_Ctxt_AN_Mgt = decodeStaticFixedSizedArray_uint8_8(offset + 20);
...
function UlDataencodepucchReceiveRespHarqDPucchResource_t(msg, buf, off) {
    ...
    encodeStaticFixedSizedArray_uint8_8(msg.L2_Ctxt_AN_Mgt, buf, off + 20);
}
...
function l2l1_decode_msg(l2l1) {
    ...
    case 0xE103: // DlData::PdschSendReq_t
        ...
        break;
    case 0xE104: // DlData::PdcchSendReq_t
...
function decodeDynamicPackedArray_PdschGrant_16(offset) {
    ...
    for (let i = 0; i < length; i++)
        result.push(DlDatadecodePdschGrant(offset + 1 + arrOffset + i * 92));
    return result;
}
