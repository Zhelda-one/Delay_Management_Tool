...
/*    if (!(result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object] || result.ulCpriLinkMapConfig === [object Object]))
...
/*    if (!(result.dlSubcellPosition === [object Object] || result.dlSubcellPosition === [object Object] || result.dlSubcellPosition === [object Object] || result.dlSubcellPosition === [object Object] || result.dlSubcellPosition === [object Object] || result.dlSubcellPosition === [object Object] || result.dlSubcellPosition === [object Object] || result.dlSubcellPosition === [object Object]))
...
/*    if (!(result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object] || result.slotType === [object Object]))
...
function DlDatadecodePdschSendReq_t(offset) {
    ...
    result.sfn = l2l1_getU16(offset + 2);
    result.slot = l2l1_getU8(offset + 4);
    result.numPdsch_reservation = l2l1_getU8(offset + 5);
    result.padding_insteadOfRnti = l2l1_getU16(offset + 6);
    result.dmrsScramblingSequenceInt = l2l1_getU16(offset + 8);
...
/*    if (!(result.modulationOrder === [object Object] || result.modulationOrder === [object Object] || result.modulationOrder === [object Object] || result.modulationOrder === [object Object]))
    ...
    result.rnti = l2l1_getU16(offset + 54);
    ...
    result.polarizationSelection = l2l1_getU8(offset + 69);
/*    if (!(result.polarizationSelection === [object Object] || result.polarizationSelection === [object Object] || result.polarizationSelection === [object Object]))
        throw new Error(`Value ${result.polarizationSelection} is out of range for enum 'polarizationSelection_t'`); */
    Object.defineProperty(result, "__enum_polarizationSelection", {
        enumerable: false,
    ...
    result.rbgSize = l2l1_getU8(offset + 70);
    result.rbgSizeFirst = l2l1_getU8(offset + 71);
    ...
    result.pdschPrecodingOption4x4 = l2l1_getU8(offset + 81);
...
/*    if (!(result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object]))
    ...
    result.numLteCrsMappingRes = l2l1_getU16(offset + 92);
    result.lteCrsOption = l2l1_getU8(offset + 94);
...
function DlDataencodePdschSendReq_t(msg, buf, off) {
    ...
    l2l1_putU16(msg.sfn, buf, off + 2);
    l2l1_putU8(msg.slot, buf, off + 4);
    l2l1_putU8(msg.numPdsch_reservation, buf, off + 5);
    l2l1_putU16(msg.padding_insteadOfRnti, buf, off + 6);
    l2l1_putU16(msg.dmrsScramblingSequenceInt, buf, off + 8);
    ...
    l2l1_putU16(msg.rnti, buf, off + 54);
    ...
    l2l1_putU8(msg.polarizationSelection, buf, off + 69);
    l2l1_putU8(msg.rbgSize, buf, off + 70);
    l2l1_putU8(msg.rbgSizeFirst, buf, off + 71);
    ...
    l2l1_putU8(msg.pdschPrecodingOption4x4, buf, off + 81);
    ...
    l2l1_putU16(msg.numLteCrsMappingRes, buf, off + 92);
    l2l1_putU8(msg.lteCrsOption, buf, off + 94);
}
...
/*    if (!(result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object] || result.ulSubcellPosition === [object Object]))
...
/*    if (!(result.numCeAxCId === [object Object] || result.numCeAxCId === [object Object]))
    ...
    result.ceAxCId = decodeStaticFixedSizedArray_uint16_4(offset + 248);
    result.digitalOutputEnabled = l2l1_getU8(offset + 256);
    result.digitalOutputType = l2l1_getU8(offset + 257);
/*    if (!(result.digitalOutputType === [object Object] || result.digitalOutputType === [object Object]))
    ...
    result.digitalOutputRate = l2l1_getU8(offset + 258);
/*    if (!(result.digitalOutputRate === [object Object] || result.digitalOutputRate === [object Object] || result.digitalOutputRate === [object Object]))
    ...
    result.bbSelector = l2l1_getU8(offset + 259);
    result.frequencyShift7pt5khz = l2l1_getU8(offset + 260);
    result.pfaTargetPrachId = l2l1_getU8(offset + 261);
    result.actEcpriPhase2 = l2l1_getU8(offset + 262);
...
function UlCellencodeSetupReq_t(msg, buf, off) {
    ...
    encodeStaticFixedSizedArray_uint16_4(msg.ceAxCId, buf, off + 248);
    l2l1_putU8(msg.digitalOutputEnabled, buf, off + 256);
    l2l1_putU8(msg.digitalOutputType, buf, off + 257);
    l2l1_putU8(msg.digitalOutputRate, buf, off + 258);
    l2l1_putU8(msg.bbSelector, buf, off + 259);
    l2l1_putU8(msg.frequencyShift7pt5khz, buf, off + 260);
    l2l1_putU8(msg.pfaTargetPrachId, buf, off + 261);
    l2l1_putU8(msg.actEcpriPhase2, buf, off + 262);
}
...
/*    if (!(result.puschTransCoherence === [object Object] || result.puschTransCoherence === [object Object] || result.puschTransCoherence === [object Object]))
    ...
    result.eCpriConfigStruct = UlDatadecodeeCpriConfigStruct_t(offset + 72);
...
function UlDataencodepuschReceiveReqGrant_t(msg, buf, off) {
    ...
    UlDataencodeeCpriConfigStruct_t(msg.eCpriConfigStruct, buf, off + 72);
}
...
function UlDatadecodesrsReceiveReqBands_t(offset) {
    ...
    result.srsReceiveReqUes = decodeDynamicVariableSizedArray_srsReceiveReqUes_t_4(offset + 4);
...
function UlDataencodesrsReceiveReqBands_t(msg, buf, off) {
    ...
    encodeDynamicVariableSizedArray_srsReceiveReqUes_t_4(msg.srsReceiveReqUes, buf, off + 4);
}
function UlDatadecodesrsSuMimoStruct_t(offset) {
    let result = {};

    result.sequenceId = l2l1_getU16(offset + 0);
    result.numRbgPerSubband = l2l1_getU8(offset + 2);
...
/*    if (!(result.transmissionComb === [object Object] || result.transmissionComb === [object Object]))
    ...
    result.numCeAxCIndex = l2l1_getU8(offset + 4);
/*    if (!(result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object]))
        throw new Error(`Value ${result.numCeAxCIndex} is out of range for enum 'numCeAxC_t'`); */
    Object.defineProperty(result, "__enum_numCeAxCIndex", {
        enumerable: false,
    ...
    result.ceAxCIndex = decodeStaticFixedSizedArray_uint8_4(offset + 8);
    result.symbolPosition = l2l1_getU8(offset + 12);
    result.srsReceiveReqBands = decodeDynamicVariableSizedArray_srsReceiveReqBands_t_68(offset + 16);

    return result;
}
function UlDataencodesrsSuMimoStruct_t(msg, buf, off) {
    l2l1_putU16(msg.sequenceId, buf, off + 0);
    l2l1_putU8(msg.numRbgPerSubband, buf, off + 2);
    l2l1_putU8(msg.transmissionComb, buf, off + 3);
    l2l1_putU8(msg.numCeAxCIndex, buf, off + 4);
    encodeStaticFixedSizedArray_uint8_4(msg.ceAxCIndex, buf, off + 8);
    l2l1_putU8(msg.symbolPosition, buf, off + 12);
    encodeDynamicVariableSizedArray_srsReceiveReqBands_t_68(msg.srsReceiveReqBands, buf, off + 16);
}
...
function UlDatadecodesrsReceiveReqSubcell_t(offset) {
    ...
    result.srsBmStruct = UlDatadecodesrsBmStruct_t(offset + 28);
...
function UlDataencodesrsReceiveReqSubcell_t(msg, buf, off) {
    ...
    UlDataencodesrsBmStruct_t(msg.srsBmStruct, buf, off + 28);
}
...
function l2l1_decode_msg(l2l1) {
    ...
    case 0x0133: // DlData::PdcchSendReq_t
        ...
        break;
    case 0x0135: // DlData::PdschSendReq_t
    ...
    case 0x0240: // UlData::PrachReceiveReq_t
        ...
        break;
    case 0x0249: // UlData::PuschReceiveReq_t
    ...
    case 0x024B: // UlData::SrsReceiveRespBmPs_t
        ...
        break;
    case 0x0252: // UlData::SrsReceiveRespPs_t
        result = UlDatadecodeSrsReceiveRespPs_t(0);
        break;
    case 0x0253: // UlData::SrsReceiveReq_t
...
packetPropToStrMap["l2l1.message"] = {
    ...
    0x0252: "UlData::SrsReceiveRespPs",
    0x0253: "UlData::SrsReceiveReq",
};
