...
function LteLunum_DlData_decodedlUlSection_t(offset) {
    ...
    result.nonContPrbAllocSectionExtensions = _decodeArray(offset + 24, LteLunum_DlData_decodenonContiguousPrbAllocation_t, 8);
...
function LteLunum_DlData_encodedlUlSection_t(msg, buf, off) {
    ...
    _encodeArray(msg.nonContPrbAllocSectionExtensions, buf, off + 24, LteLunum_DlData_encodenonContiguousPrbAllocation_t, 8);
}
