...
function L1Configdecodel1PoolConfiguration_t(offset) {
    ...
    result.l1SubPoolConfiguration = decodeDynamicVariableSizedArray_l1SubPoolConfiguration_t_8(offset + 4);

    return result;
}
function L1Configencodel1PoolConfiguration_t(msg, buf, off) {
    l2l1_putU32(msg.poolId, buf, off + 0);
    encodeDynamicVariableSizedArray_l1SubPoolConfiguration_t_8(msg.l1SubPoolConfiguration, buf, off + 4);
}
