...
/*    if (!(result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object] || result.numCeAxCIndex === [object Object]))
...
/*    if (!(result.numStreamIndex === [object Object] || result.numStreamIndex === [object Object] || result.numStreamIndex === [object Object]))
...
function L1LogdecodeAntennaSnapshotResp_t(offset) {
    ...
    result.status = l2l1_getU8(offset + 0);
/*    if (!(result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object] || result.status === [object Object]))
...
function UlDatadecoderimReceiveReqSubcell_t(offset) {
    ...
    result.eCpriConfig = UlDatadecodeeCpriConfig_t(offset + 40);
    result.unscheduledRegionInfo = decodeDynamicVariableSizedArray_unscheduledRegionInfo_t_14(offset + 52);
...
function UlDataencoderimReceiveReqSubcell_t(msg, buf, off) {
    ...
    UlDataencodeeCpriConfig_t(msg.eCpriConfig, buf, off + 40);
    encodeDynamicVariableSizedArray_unscheduledRegionInfo_t_14(msg.unscheduledRegionInfo, buf, off + 52);
}
...
packetEnumMap = {
    ...
    L1SyncSlave_statusInd_t: {
        0: "statusInd::Synchronized",
        1: "statusInd::Synchronizing",
        2: "statusInd::Holdover",
        3: "statusInd::Failed",
    },
    _delayReqInterval_t: {
        0: "delayReqInterval::RANDOM",
